...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(205, 5, strtoupper(utf8_decode('CORRESPONDIENTE A LO ESTABLECIDO EN LA LEY DEL REGIMEN PRESTACIONAL DE EMPLEO')), 0, 1, 'L');
...
$sql = "SELECT 
			...
			(SELECT Monto
			 ...
			 WHERE
				...
				ptnec2.CodConcepto = '0040') AS MontoAporte
		FROM
			mastpersonas mp
