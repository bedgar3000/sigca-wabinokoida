...
<table width="100%" class="tblLista">
	...
	for ($i=0; $i<$rows; $i++) {
		...
		if ($accion == "MODIFICACION") {
			echo "
			<tr class='trListaBody' onclick='mClk(this, \"registro\"); selConceptoModificacion(\"".($field['Descripcion'])."\");' id='".$field['CodConcepto']."'>
			...
			echo "
			<tr class='trListaBody' onclick='mClk(this, \"registro\"); selConcepto(\"".($field['Descripcion'])."\");' id='".$field['CodConcepto']."'>
				<td align='center'>".$field['CodConcepto']."</td>
				<td>".($field['Descripcion'])."</td>
				<td align='center'>".$tipo."</td>
				<td align='center'>".$status."</td>
