...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(205, 5, strtoupper(utf8_decode('RESUMEN DE CONCEPTOS POR PROCESO - '.$field_proceso['Nomina'])), 0, 1, 'L');
		...
		$this->SetWidths(array(130,25,25,25));
