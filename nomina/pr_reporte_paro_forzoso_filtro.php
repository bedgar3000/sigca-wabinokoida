...
//	------------------------------------
$_titulo = "Ley del Regimen Prestacional de Empleo";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pr_reporte_paro_forzoso_pdf.php" method="post" autocomplete="off" target="pdf">
