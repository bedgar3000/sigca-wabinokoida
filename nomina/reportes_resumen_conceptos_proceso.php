...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte de Resumen de Conceptos por Proceso</td>
		<td align="right"><a class="cerrar"; href="../framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="pdf_resumen_conceptos_proceso.php" target="iReporte" onsubmit="return validarResumenConceptosProceso(this);">
...
<table width="1000" class="tblFiltro">
	...
	<tr><td align="center" colspan="4"><hr width="90%" size="1" /></td></tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
        <td align="right">Archivo:</td>
        <td>
			<input type="radio" name="tipo" id="pdf" checked="checked" onclick="document.getElementById('archivo').disabled=true; document.getElementById('archivo').value='';" /> PDF &nbsp; &nbsp;
			<input type="radio" name="tipo" id="excel" onclick="document.getElementById('archivo').disabled=false; document.getElementById('archivo').value='';" /> EXCEL &nbsp; &nbsp;
			<input type="text" name="archivo" id="archivo" size="25" disabled="disabled" />
		</td>
	</tr>
</table>
</div>
...
<br /><div class="divDivision">Reporte Resumen de Conceptos por Proceso</div><br />
