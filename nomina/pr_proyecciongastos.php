...
//	------------------------------------
$_titulo = "Distribuci&oacute;n Ppto. x Categoria Programaticas";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pr_proyecciongastos_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
                ...
                <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="fBuscar" id="fBuscar" style="width:225px;" disabled />
                        </td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
