...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte de Relaci&oacute;n de Ingresos</td>
		<td align="right"><a class="cerrar"; href="../framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="pdf_relacion_ingresos.php" target="iReporte">
...
<table width="1000" class="tblFiltro">
    <tr>
        ...
        <td>
			...
			<select name="ftiponom" id="ftiponom" class="selectBig">
    ...
    <tr>
        ...
        <td colspan="3">
			...
			<select name="fperiodo" id="fperiodo">
				<?=getPeriodosCancelados($fperiodo, 0)?>
			</select>
        </td>
    </tr>
...
<br /><div class="divDivision">Reporte de Relaci&oacute;n de Ingresos</div><br />
