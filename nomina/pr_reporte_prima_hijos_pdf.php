...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(205, 5, strtoupper(utf8_decode('REPORTE DE RETENCIONES EMBARGO PRIMA POR HIJOS')), 0, 1, 'L');
		...
		##
		$this->SetFont('Arial','B',8);
		$this->SetWidths(array(20,125,30,30));
		$this->SetAligns(array('R','L','R','R'));
