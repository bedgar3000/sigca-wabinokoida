...
//	------------------------------------
$_titulo = "Registro de Informaci&oacute;n Cargos";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pr_proyeccioncargos_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
            ...
            <div class="divBorder" style="width:100%; min-width:<?=$_width?>px;">
                <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
                    ...
                    <tr>
                        ...
                        <td align="right" rowspan="3" valign="top">N&oacute;mina: </td>
                        <td rowspan="3" valign="top">
                            <input type="checkbox" onclick="chkFiltro(this.checked, 'fCodTipoNom');" style="visibility:hidden;" />
                            <select name="fCodTipoNom[]" id="fCodTipoNom" style="width:225px; height:78px;" multiple>
                                <?=loadSelect2('tiponomina','CodTipoNom','Nomina','',10);?>
                            </select>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
