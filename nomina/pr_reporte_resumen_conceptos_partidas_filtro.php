...
//	------------------------------------
$_titulo = "Resumen de Conceptos x Partidas";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pr_reporte_resumen_conceptos_partidas_pdf.php" method="post" autocomplete="off" target="pdf">
        ...
        <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
            ...
            <tr>
                ...
                <td class="gallery clearfix">
                    <input type="checkbox" <?=$cCodPersona?> onclick="ckLista(this.checked, ['fCodPersona','fNomPersona','fCodEmpleado'], ['aCodPersona']);" />
                ...
                <td>
                    <input type="checkbox" <?=$cFechaGeneracion?> onclick="chkCampos2(this.checked, ['fFechaGeneracionD','fFechaGeneracionH']);" />
