...
//	------------------------------------
$_titulo = "Fondo Especial de Jubilaciones y Pensiones";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pr_reporte_jubilacion_pension_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
        ...
        <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
            ...
            <tr>
                ...
                <td>
                	<input type="radio" name="rArchivo" id="PDF" value="S" onChange="$('#Archivo').val('').prop('disabled', this.checked); $('#frmentrada').attr('action', 'pr_reporte_jubilacion_pension_pdf.php');" checked /> PDF
                    &nbsp; &nbsp; &nbsp; &nbsp; 
                	<input type="radio" name="rArchivo" id="TXT" value="S" onChange="$('#Archivo').val('').prop('disabled', !this.checked); $('#frmentrada').attr('action', 'pr_reporte_jubilacion_pension_txt.php');" /> TXT
...
function validar() {
	if ($('#TXT').prop('checked') && $('#Archivo').val() == '') cajaModal('Debe ingresar el nombre del Archivo','error');
