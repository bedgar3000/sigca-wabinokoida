...
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pr_reporte_retenciones_pdf.php" method="post" autocomplete="off" target="pdf">
        ...
        <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" checked onclick="this.checked=!this.checked" />
                    <select name="fCodConcepto" id="fCodConcepto" style="width:275px;">
                        <?=loadSelectConceptos('', 'D')?>
                    </select>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
