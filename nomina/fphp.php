...
function getPaises($pais, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$pais) echo "<option value='".$field[0]."' selected>".($field[1]); 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getEstados($estado, $pais, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$estado) echo "<option value='".$field[0]."' selected>".($field[1]); 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getMunicipios($municipio, $estado, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$municipio) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getCiudades($ciudad, $municipio, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$ciudad) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getTPago($tpago, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tpago) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getDivisiones($division, $dependencia, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$division) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getGrupos($grupo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$grupo) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getSeries($serie, $grupo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$serie) echo "<option value='".$field[0]."' selected>".($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getTCargo($tcargo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tcargo) echo "<option value='".$field[0]."' selected>".($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getNiveles($nivelcargo, $tipocargo, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$nivelcargo) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getCargos($cargo, $serie, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$cargo) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getTTrabajador($ttrabajador, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$ttrabajador) echo "<option value='".$field[0]."' selected>".($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getTNomina($tnomina, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tnomina) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getPNomina($pnomina, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$pnomina) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getTCese($tcese, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tcese) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getTSeguros($tseguro, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tseguro) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getTContratos($tcontrato, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$tcontrato) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getFContratos($fcontrato, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$fcontrato) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getBancos($banco, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$banco) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getGInstruccion($grado, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$grado) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getNInstruccion($nivel, $grado, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$nivel) echo "<option value='".$field[0]."' selected>".($field[1]); 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getCEstudios($centro, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$centro) echo "<option value='".$field[0]."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getIdiomas($idioma, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$idioma) echo "<option value='".$field[0]."' selected>".($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getOrdenarEmpleado($ordenar, $opt) {
	...
	$tordenar[5]="Cargo"; $vordenar[5]="rp.DescripCargo";
	switch ($opt) {
		case 0:
			for ($i=0; $i<$nitem; $i++) {
				if ($ordenar==$vordenar[$i]) echo "<option value='".$vordenar[$i]."' selected>".$tordenar[$i]."</option>";
...
function getProfesiones($profesion, $grado, $area, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field['CodProfesion']==$profesion) echo "<option value='".$field['CodProfesion']."' selected>".($field[1])."</option>"; 
				else echo "<option value='".$field['CodProfesion']."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getCursos($curso, $opt) {
	...
	switch ($opt) {
		case 0:
			...
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
				if ($field[0]==$curso) echo "<option value='".$field[0]."' selected>".($field[1])."</option>";
				else echo "<option value='".$field[0]."'>".($field[1])."</option>";
			}
			break;
		case 1:
...
function getTipoHabilidad($valor, $opt) {
	...
	$tvalor[2]="Conocimiento"; $vvalor[2]="C";
	$total=3;
	switch ($opt) {
		case 0:
			for ($i=0; $i<$total; $i++) {
...
function getPeriodos($valor, $tiponom, $codorganismo, $opt) {
	...
	switch ($opt) {
		case 0:
			$sql="SELECT Periodo FROM pr_procesoperiodo WHERE CodTipoNom='".$tiponom."' AND CodOrganismo='".$codorganismo."' AND Estado='A' AND FlagAprobado='S' GROUP BY Periodo ORDER BY Periodo DESC";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
		...
		case 3:
			$sql="SELECT Periodo FROM pr_procesoperiodo WHERE Periodo>='".$valor."' AND CodTipoNom='".$tiponom."' AND CodOrganismo='".$codorganismo."' AND Estado='A' AND FlagAprobado='S' GROUP BY Periodo ORDER BY Periodo DESC";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
		...
		case 5:
			$sql="SELECT Periodo FROM pr_procesoperiodoprenomina WHERE CodTipoNom='".$tiponom."' AND CodOrganismo='".$codorganismo."' AND Estado='A' AND FlagAprobado='S' GROUP BY Periodo ORDER BY Periodo DESC";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
...
function getTipoProcesoNomina($codigo, $periodo, $nomina, $codorganismo, $opt) {
	...
	switch ($opt) {
		...
		case 1:			
			$sql="SELECT tp.CodTipoProceso AS Codigo, tp.Descripcion FROM pr_tipoproceso tp INNER JOIN pr_procesoperiodo pp ON (tp.CodTipoProceso=pp.CodTipoProceso AND pp.CodTipoNom='".$nomina."' AND pp.Periodo='".$periodo."' AND pp.CodOrganismo='".$codorganismo."' AND pp.Estado='A' AND pp.FlagAprobado='S') ORDER BY tp.CodTipoProceso DESC";
			$query=mysql_query($sql) or die ($sql.mysql_error());
			$rows=mysql_num_rows($query);
			for ($i=0; $i<$rows; $i++) {
				$field=mysql_fetch_array($query);
...
//	
function loadTipoServicio($documento) {
	connect();
	...
	$sql = "SELECT
			...
			FROM
				masttiposervicio ts
				INNER JOIN ap_tipodocumento td ON (ts.CodRegimenFiscal = td.CodRegimenFiscal)
			WHERE td.CodTipoDocumento = '".$documento."'";
	$query = mysql_query($sql) or die ($sql.mysql_error());
	while ($field = mysql_fetch_array($query)) {
		echo "<option value='".$field[0]."'>".($field[1])."</option>";
	}
...
//	
function loadTipoServicioObligacion($tservicio, $rfiscal) {
	connect();
	
	$sql = "(SELECT CodTipoServicio, Descripcion
			 FROM masttiposervicio
			 WHERE CodTipoServicio = '".$tservicio."')
			UNION
			(SELECT CodTipoServicio, Descripcion
			 FROM masttiposervicio
			 WHERE CodRegimenfiscal = '".$rfiscal."' AND CodTipoServicio <> '".$tservicio."')";
	$query = mysql_query($sql) or die ($sql.mysql_error());
	while ($field = mysql_fetch_array($query)) {
		if ($field['CodTipoServicio'] == $tservicio) echo "<option value='".$field[0]."' selected='selected'>".($field[1])."</option>";
		else echo "<option value='".$field[0]."'>".($field[1])."</option>";
	}
}
