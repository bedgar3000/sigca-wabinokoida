...
//	------------------------------------
$_titulo = "Registro de Asignaci&oacute;n de Cargos";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pr_reporte_asignacion_cargo_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="fCodDependencia" id="fCodDependencia" style="width:275px;" disabled>
                        <option value="">&nbsp;</option>
                        <?=loadSelect2('mastdependencias','CodDependencia','Dependencia')?>
                    </select>
                </td>
                <td align="right">Responsable:</td>
                <td class="gallery clearfix">
                    <input type="checkbox" onclick="ckLista(this.checked, ['fCodPersona','fNomPersona'], ['aCodPersona']);" />
                    <input type="hidden" name="fCodPersona" id="fCodPersona" value="<?=$fCodPersona?>" />
                    <input type="text" name="fNomPersona" id="fNomPersona" value="<?=$fNomPersona?>" style="width:245px;" readonly />
                    <a href="../lib/listas/gehen.php?anz=lista_empleados&filtrar=default&campo1=fCodPersona&campo2=fNomPersona&ventana=selLista&iframe=true&width=950&height=430" rel="prettyPhoto[iframe1]" id="aCodPersona" style="visibility:hidden;">
...
<script type="text/javascript" language="javascript">
    ...
    function validar() {
        if ($('#fCodTipoNom').val() == '') {cajaModal('Debe seleccionar la N&oacute;mina','error'); return false;}
        else if ($('#fCodTipoProceso').val() == '') {cajaModal('Debe seleccionar el Proceso','error'); return false;}
        else if ($('#fPeriodoAnio').val() == '' || $('#fPeriodoMes').val() == '') {cajaModal('Debe seleccionar el Periodo','error'); return false;}
        else return true;
    }
</script>