...
//	------------------------------------
$_titulo = "Resumen por Categorias Programaticas";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pr_reporte_resumen_categorias_pdf.php" method="post" autocomplete="off" target="pdf">
