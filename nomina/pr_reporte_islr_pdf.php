...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(205, 5, strtoupper(utf8_decode('REPORTE DE RETENCIONES')), 0, 1, 'L');
		$this->Cell(205, 5, strtoupper(utf8_decode('CORRESPONDIENTE A LA LEY DE IMPUESTO SOBRE LA RENTA')), 0, 1, 'L');
		...
		##
		$this->SetFont('Arial','B',8);
		$this->SetWidths(array(20,20,90,30,15,30));
		$this->SetAligns(array('C','R','L','R','R','R'));
		$this->Row(array(utf8_decode('R.I.F.'),
						 utf8_decode('CEDULA'),
...
list($ConformadoNombre, $ConformadoCargo, $ConformadoNivel) = getFirma($field_proceso['AprobadoPor']);
$pdf->SetFont('Arial', '', 8);
