...
//	------------------------------------
$_titulo = "Ajustes por Grado Empleado";
$_width = 900;
?>
...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=pr_proyajusteempleado_lista" method="post" autocomplete="off">
...
<table class="tblBotones" style="width:100%; min-width:<?=$_width?>px;">
    <tr>
        ...
        <td align="right">
            <input type="button" value="Nuevo" style="width:75px; <?=$_btNuevo?>" class="insert" onclick="cargarPagina(this.form, 'gehen.php?anz=pr_proyajusteempleado_form&opcion=nuevo');" />
            <input type="button" value="Modificar" style="width:75px; <?=$_btModificar?>" class="update" onclick="cargarOpcion2(this.form, 'gehen.php?anz=pr_proyajusteempleado_form&opcion=modificar', 'SELF', '', $('#sel_registros').val());" />
            <input type="button" value="Ver" style="width:75px;" class="ver" onclick="cargarOpcion2(this.form, 'gehen.php?anz=pr_proyajusteempleado_form&opcion=ver', 'SELF', '', $('#sel_registros').val());" />
        </td>
    </tr>
</table>
