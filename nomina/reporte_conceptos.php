...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte por Conceptos</td>
		<td align="right"><a class="cerrar"; href="../framemain.php">[Cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" method="post" action="pdf_retenciones.php" target="iReporte">
...
<table width="1000" class="tblFiltro">
    ...
    <tr>
        ...
        <td>
        	<input type="checkbox" name="flagsueldo" id="flagsueldo" value="S" /> Mostrar Salario
        </td>
    </tr>
</table>
</div>
...
<br /><div class="divDivision">Reporte por Conceptos</div><br />
