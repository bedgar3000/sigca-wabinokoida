	...
	<tr>
		...
		<td>
			...
			<select name="fCodCentroCosto" id="fCodCentroCosto" style="width:300px;" <?=$dCodCentroCosto?>>
            	<option value="">&nbsp;</option>
				<?=loadSelect2("ac_mastcentrocosto", "CodCentroCosto", "Descripcion", $fCodCentroCosto, 0, ['CodDependencia'],[$fCodDependencia])?>
			</select>
		</td>
	...
	<tr>
    	<td class="optmenu8" width="200" valign="top">
			...
			if ($_APLICACION == "NOMINA") {
				?>
                <li>
                <a href="javascript:" onclick="cargarOpcion2(document.getElementById('frmentrada'), 'gehen.php?anz=empleados_conceptos_lista&filtrar=default', 'SELF', '', $('#registro').val());" onmouseover="setMsj(14);" onmouseout="setMsj(0);">
