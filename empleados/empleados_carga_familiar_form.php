...
<table width="800" class="tblForm">
	...
	<tr>
		...
		<td width="35%">
            <input type="text" id="ApellidosCarga" style="width:95%;" maxlength="50" value="<?=htmlentities($field['ApellidosCarga'])?>" <?=$disabled_ver?> />
		</td>
		<td class="tagForm">* Nombres:</td>
		<td width="35%">
            <input type="text" id="NombresCarga" style="width:95%;" maxlength="50" value="<?=htmlentities($field['NombresCarga'])?>" <?=$disabled_ver?> />
		</td>
    </tr>
    <tr>
    ...
    <tr>
		...
		<td colspan="3">
        	<textarea id="DireccionFam" style="width:98%; height:30px;" <?=$disabled_ver?>><?=htmlentities($field['DireccionFam'])?></textarea>
        </td>
	</tr>
    <tr>
