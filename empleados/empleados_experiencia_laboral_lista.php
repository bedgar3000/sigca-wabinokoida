...
<table width="900" class="tblBotones">
    <tr>
        ...
        <td align="right">
            ...
            <input type="button" id="btEliminar" value="Eliminar" style="width:75px; <?=$btEliminar?>" onclick="opcionRegistro2(this.form, this.form.registro.value, 'empleados_experiencia_laboral', 'eliminar');" />
