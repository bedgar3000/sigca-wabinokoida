...
//	------------------------------------
?>
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=empleados_referencias_personales_lista" method="POST" enctype="multipart/form-data" onsubmit="return empleados_referencias_personales(this, '<?=$accion?>');" autocomplete="off">
