...
//	------------------------------------
$_titulo = "&Iacute;ndice de C&aacute;tegorias Program&aacute;ticas (F.2103)";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2103_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
            ...
            <div class="divBorder" style="width:100%; min-width:<?=$_width?>px;">
                <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" checked onclick="chkCampos(this.checked, 'fCodOrganismo');" />
