...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=pv_programas_lista" method="POST" enctype="multipart/form-data" onsubmit="return formSubmit('pv_programas_ajax', 'modulo=formulario&accion=<?=$accion?>');" autocomplete="off">
...
<table width="<?=$_width?>" class="tblForm">
    ...
    <tr>
		...
		<td>
        	<input type="text" name="IdPrograma" id="IdPrograma" value="<?=$field['IdPrograma']?>" style="width:65px; font-weight:bold;" readonly="readonly" />
		</td>
	</tr>
    <tr>
		<td class="tagForm">* C&oacute;digo:</td>
		<td>
        	<input type="text" name="CodPrograma" id="CodPrograma" value="<?=$field['CodPrograma']?>" style="width:65px;" maxlength="2" <?=$disabled_modificar?> />
		</td>
	</tr>
    <tr>
		<td class="tagForm">* Sub-Sector:</td>
		<td>
			<select name="IdSubSector" id="IdSubSector" style="width:404px;" <?=$disabled_modificar?>>
				<option value="">&nbsp;</option>
