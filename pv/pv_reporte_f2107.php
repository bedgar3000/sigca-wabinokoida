...
//	------------------------------------
$_titulo = "Relación de los Recursos Humanos Clasificados por Tipo de Cargo y Género (F.2107)";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2107_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
