...
//  ------------------------------------
$_titulo = "Metas del Programa, Sub-Programa y Proyecto (F.2114)";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2114_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
