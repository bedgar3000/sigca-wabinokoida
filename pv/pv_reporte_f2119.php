...
//  ------------------------------------
$_titulo = "Cr&eacute;ditos Presupuestarios del Sector por Programa a Nivel de Partidas y Fuentes de Financiamiento (F.2119)";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2119_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
