...
//	------------------------------------
$_titulo = "Ajustes Presupuestarios Resumen Detallado";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_ajustes_detallado_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
                ...
                <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="fTipo" id="fTipo" style="width:225px;" disabled>
                                <option value="">&nbsp;</option>
                                <?=getMiscelaneos($fTipo,'TIPOAJUSTE')?>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" onclick="chkFiltro(this.checked, 'fCodFuente');" />
                            <select name="fCodFuente" id="fCodFuente" style="width:225px;" disabled>
                                <option value="">&nbsp;</option>
                                <?=loadSelect2('pv_fuentefinanciamiento','CodFuente','Denominacion',$fCodFuente)?>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="gallery clearfix">
                            ...
                            <input type="text" name="fCategoriaProg" id="fCategoriaProg" style="width:123px;" readonly="readonly" />
