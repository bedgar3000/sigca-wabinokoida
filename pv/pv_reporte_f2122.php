...
//  ------------------------------------
$_titulo = "Relaci&oacute;n de Obras (F.2122)";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2122_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
