...
$fFechaD = "01-01-" . $AnioActual;
$fFechaH = formatFechaDMA($FechaActual);
//	------------------------------------
$_titulo = "Ejecuci&oacute;n Presupuestaria por Periodo";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_presupuesto_ejecucion_periodo_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
            ...
            <div class="divBorder" style="width:100%; min-width:<?=$_width?>px;">
                <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" checked onclick="this.checked=!this.checked;" />
                            <input type="text" name="fFechaD" id="fFechaD" value="<?=$fFechaD?>" class="datepicker" style="width:60px;" maxlength="10" />
                            <input type="text" name="fFechaH" id="fFechaH" value="<?=$fFechaH?>" class="datepicker" style="width:60px;" maxlength="10" />
                        </td>
...
<script type="text/javascript" language="javascript">
    ...
    function validar() {
        ...
        else if ($('#fFechaD').val() == '') {cajaModal('Debe ingresar el Intervalo de Fechas','error'); return false;}
        else if ($('#fFechaH').val() == '') {cajaModal('Debe ingresar el Intervalo de Fechas','error'); return false;}
        else return true;
    }
</script>