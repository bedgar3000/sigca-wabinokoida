...
//  ------------------------------------
$_titulo = "Resumen Presupuestario por Sector, Programa y Fuente de Financiamiento (F.2104)";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2104_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
