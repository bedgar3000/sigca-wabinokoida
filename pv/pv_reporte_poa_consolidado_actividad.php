...
//	------------------------------------
$_titulo = "Consolidado por Sector, Programa Y Actividad";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_poa_consolidado_actividad_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
            ...
            <div class="divBorder" style="width:100%; min-width:<?=$_width?>px;">
                <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td align="right">Agrupar</td>
                        <td><input type="checkbox" name="FlagAgrupar" id="FlagAgrupar" value="S" checked></td>
