...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->SetFont('Arial','B',8);
        $this->SetWidths(array(129,65,65));
        $this->SetAligns(array('FJ','L','L'));
        $this->Row(array(utf8_decode('DESCRIPCIÓN'),
    ...
    function Footer() {
        ...
        $this->Rect(10, 55, 259, 50, "D");

        $this->Rect(139, 55, 0.1, 50, "FD");
        $this->Rect(204, 55, 0.1, 50, "FD");

        $this->Rect(10, 105, 46, 15, "D");
        $this->Rect(56, 105, 148, 15, "D");
        $this->Rect(204, 105, 65, 15, "D");
        ##  
        $this->SetFont('Arial','B',10);
        $this->SetY(107);
        $this->MultiCell(46, 5, utf8_decode('ASIGNACIÓN PRESUPUESTARIA'), 0, 'L');
        $this->SetFont('Arial','',8);
        ##  
        $this->SetY(107);
        $this->SetX(56);
        $this->Cell(18, 5, utf8_decode('Programa: '), 0, 0, 'L');
        $this->MultiCell(100, 5, utf8_decode($CodPrograma.' '.$Programa), 0, 'L');
        $this->Ln(1);
        $this->SetX(56);
        $this->Cell(18, 5, utf8_decode('Actividad: '), 0, 0, 'L');
        $this->MultiCell(130, 5, utf8_decode($CodActividad.' '.$Actividad), 0, 'L');
        ##  
        $this->SetY(107);
        $this->SetX(205);
        $this->SetFont('Arial','B',8);
        $this->Cell(100, 5, utf8_decode('Presupuesto Asignado: '), 0, 1, 'L');
        $this->Ln(1);
        $this->SetX(205);
        $this->Cell(35, 5, utf8_decode('Bs. '), 0, 0, 'L');
        $this->MultiCell(65, 5, number_format($MontoPresupuestado,2,',','.'), 0, 'L');
    }
}
//---------------------------------------------------
