...
//  ------------------------------------
$_titulo = "Resumen Presupuestario por Partidas y Fuente de Financiamiento (F.2105)";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2105_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
            ...
            <div class="divBorder" style="width:100%; min-width:<?=$_width?>px;">
                <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" onclick="chkCampos2(this.checked, ['fPar']);" />
