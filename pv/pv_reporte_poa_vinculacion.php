...
//  ------------------------------------
$_titulo = "Vinculaci&oacute;n Plan Presupuesto";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_poa_vinculacion_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
