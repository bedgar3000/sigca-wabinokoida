...
//  ------------------------------------
$_titulo = "Métas y Volúmenes de Trabajo";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_poa_metas_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
