...
//  ------------------------------------
$_titulo = "Transferencias y Donaciones Otorgadas a Organismos del Sector P&uacute;blico y Privado (F.2112)";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2112_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
            ...
            <div class="divBorder" style="width:100%; min-width:<?=$_width?>px;">
                <table class="tblFiltro" style="width:100%; min-width:<?=$_width?>px;">
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" onclick="chkCampos(this.checked, 'fIdSubSector');" />
                            <select name="fIdSubSector" id="fIdSubSector" style="width:225px;" disabled>
                                <option value="">&nbsp;</option>
