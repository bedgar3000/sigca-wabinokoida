...
//	------------------------------------
$_titulo = "Recursos Humanos por Escala de Sueldos (F.2108)";
$_width = 900;
?>
<div class="ui-layout-north">
	<div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2108_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
