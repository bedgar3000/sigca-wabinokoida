...
//  ------------------------------------
$_titulo = "Resumen Presupuestario por Partidas y Sectores (F.2106)";
$_width = 900;
?>
<div class="ui-layout-north">
    <div style="padding:5px;">
        ...
        <form name="frmentrada" id="frmentrada" action="pv_reporte_f2106_pdf.php" method="post" autocomplete="off" target="pdf" onsubmit="return validar();">
