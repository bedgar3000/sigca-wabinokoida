...
function Cabecera($pdf) {
	...
	$pdf->SetXY(20, 15); $pdf->Cell(190, 5, utf8_decode($_SESSION["NOMBRE_ORGANISMO_ACTUAL"]), 0, 1, 'L');	
	$pdf->SetFont('Arial', 'B', 10);
	$pdf->Cell(190, 10, 'Maestro de Catastro', 0, 1, 'C');	
...
Cabecera($pdf);
//	Cuerpo
$sql="SELECT CodCatastro, Descripcion, Estado FROM af_catastro ORDER BY CodCatastro";
