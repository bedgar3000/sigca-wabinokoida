...
<select name='forganismo' id='forganismo' class='selectBig' $dorganismo onchange='getFOptions_2(this.id, \"fanteproyecto\", \"chknanteproyecto\");'>";
  ...
  <td class='gallery clearfix'><input type='checkbox' id='chkActivo' name='chkActivo' value='1' $cActivo onclick='enabledRPActivo(this.form);'/>
	<input type='text' id='fActivo' name='fActivo' value='$fActivo' $dActivo size='10' style='text-align:center;' readonly/> 
...
<tr>
  ...
  <td>
	  ...
	  <input type='text' id='fFechaAprobacionDesde' name='fFechaAprobacionDesde' value='$fFechaAprobacionDesde' size='10' maxlength='10' style='text-align:center;' $dFechaAprobacion class='datepicker'/> al
	  <input type='text' id='fFechaAprobacionHasta' name='fFechaAprobacionHasta' value='$fFechaAprobacionHasta' size='10' maxlength='10' style='text-align:center;' $dFechaAprobacion class='datepicker'/></td>	 
</tr>
...
<tr>
  ...
  <td class='gallery clearfix'><input type='checkbox' name='chekcCosto' id='checkCosto' value='1' $cCosto onclick='enabledCosto(this.form);'/>
	  ...
	  <input type='text' id='centro_costos2' value='$centro_costos2' name='centro_costos2' $dCosto size='56' readonly/>";?><input type='hidden' id='btcosto' name='btcosto' value='...' onclick="cargarVentanaLista(this.form,'af_listacentroscostos.php?limit=0&campo=9','height=100%,width=80%,left=200,top=100,resizable=yes');"  <?=$dCosto?> /> <a href="af_listacentroscostos.php?filtrar=default&limit=0&campo=9&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe2]" id="c_costo" style="visibility:hidden;">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>
	 <?  echo"</td>
  ...
  <td>
	 ...
	 <input type='text' id='fFechaPreparacionDesde' name='fFechaPreparacionDesde' value='$fFechaPreparacionDesde' size='10' maxlength='10' $dFechaPreparacion class='datepicker' style='text-align:center;'/> al
	 <input type='text' id='fFechaPreparacionHasta' name='fFechaPreparacionHasta' value='$fFechaPreparacionHasta' size='10' maxlength='10' $dFechaPreparacion class='datepicker' style='text-align:center;'/></td>
</tr>
...
<tr>
 <td align='center' colspan='4' class='gallery clearfix'>Para la ubicaci&oacuten ==> Actual <input type='checkbox' id='chkubicacionActual' name='chkubicacionActual' onclick='enabledRPUbicacionActual(this.form);' value='1' $cubicacionActual/> <input type='hidden' id='fub_actual' name='fub_actual'/><input type='text' id='fub_actual_descp' name='fub_actual_descp' size='25' $dubicacionActual onclick='valor_asignado(this.id);'/>
                        ...
                        <a href="pagina.php?iframe=true&width=80%&height=100%"  rel="prettyPhoto[iframe3]" id="a_lista" style="display:none"></a>
...
<tr>
  <td>
	...
	<li><a onClick="af_rptabmovimiento_activos_movimientos('frmentrada','otroformato2');" href="#">Otro Formato2</a></li> 
	</ul>
	</div>
  </td>
</tr>
