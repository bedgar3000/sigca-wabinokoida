...
<tr>
   ...
   <tr>
       ...
       <td class='gallery clearfix'> 
	   		<input type='checkbox' id='chkUbicacion' name='chkUbicacion' value='1' $cUbicacion onclick='enabledUbicacionActivos(this.form);'/> 
			<input type='text' name='fUbicacion' id='fUbicacion' size='10' value='$fUbicacion' $dUbicacion/> 
			<input type='text' name='DescpUbicacion' id='DescpUbicacion' value='$DescpUbicacion' size='35' $dUbicacion/>";?><input type="hidden" id="btUbicacion" name="btUbicacion" value="..." onclick="cargarVentana(this.form,'af_listaubicacionesactivo.php?limit=0&campo=21','height=500,width=850,left=200,top=100,resizable=yes');" <?=$dUbicacion;?>/>
  ...
  <tr>
   ...
   <td class='gallery clearfix'>
   		<input type='checkbox' id='chkCentroCosto' name='chkCentroCosto' value='1' $cCentroCosto onclick='enabledCentroCostoActivos(this.form);'/> 
		<input type='text' id='fCentroCosto' name='fCentroCosto' value='$fCentroCosto' size='10' $dCentroCosto/> 
		<input type='text' id='fCentroCosto2' name='fCentroCosto2' value='$fCentroCosto2' size='35' $dCentroCosto/>";?>
...
<a id="c_costos" onclick="cargarVentana(this.form,'../lib/listas/listado_centro_costos.php?filtrar=default&limit=0&campo=2&cod=centro_costos&nom=centro_costos2&ventana=selListadoLista03','height=500,width=850,left=200,top=100,resizable=yes');"  style="visibility:hidden">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a><? echo" </td>	
  </tr>
   ...
   <tr>
	...
	echo"</select></td>
	 ...
	 <td class='gallery clearfix'> 
	 	<input type='checkbox' id='chkPersona' name='chkPersona' value='1' $cPersona onclick='enabledPersonaActivo(this.form);'/> 
		<input type='text' id='fPersona' name='fPersona' value='$fPersona' size='10' $dPersona/> 
		<input type='text' id='NombPersona' name='NombPersona' size='35' value='$NombPersona' $dPersona/>";?><input type="hidden" id="btPersona" name="btPersona" value="..." onclick="cargarVentana(this.form,'af_listaempleados.php?limit=0&campo=23','height=500,width=850,left=200,top=100,resizable=yes');" <?=$dPersona;?> />
