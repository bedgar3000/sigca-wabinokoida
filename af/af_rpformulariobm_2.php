...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Reporte | Formulario BM-2</td>
  <td align="right">
...
//if($fCodclasficacionPub20!=""){$filtro.=" AND (ClasificacionPublic20 = '".$fClasificacionPub20."')"; $cClasficacionPub20 = "checked";} else $dClasficacionPub20 = "disabled";
...
if($fPeriodo!=""){$filtro.=" AND (PeriodoTransaccion='".$fPeriodo."')"; $cPeriodo="checked";}else $dPeriodo="disabled";
if($fTipoMov!=""){$filtro.=" AND (CodTipoMovimiento='".$fTipoMov."')"; $cTipoMov="checked";}else $dTipoMov="disabled";

?>
<? echo"
<form name='frmentrada' action='af_rpformulariobm_2.php?limit=0' method='POST'>
...
<td>
    <input type='checkbox' id='chkTipoMov' name='chkTipoMov' value='1' $cTipoMov onclick='enabledTipoMov(this.form);'/>
	<select id='fTipoMov' name='fTipoMov' $dTipoMov class='selectMed'>
	     <option value=''></option>";
		   getTipoMovimientos($fTipoMov, 0);
		 echo"
    </select>
</td>
</td>
...
<tr>
  ...
  <td><input type='checkbox' id='checkSituacionActivo' name='checkSituacionActivo' value='1' $cSituacionActivo onclick='enabledSituacionActivo(this.form);'/> 
...
<tr>
  ...
  <td class='gallery clearfix'>
	  ...
	  <input type='text' id='centro_costos2' value='$centro_costos2' name='centro_costos2' $dCosto size='56'/>";?><input type='hidden' id='btcosto' name='btcosto' value='...' onclick="cargarVentanaLista(this.form,'af_listacentroscostos.php?limit=0&campo=9','height=500,width=800,left=200,top=100,resizable=yes');"  <?=$dCosto?> /> 
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarFormularioBM_2(this.form);'></center>
<br /><div style='width:900;' class='divDivision'>Formulario BM-2</div>
<form/><br />";
?>
...
<center>
<iframe name="af_rpformulariobm_2pdf" id="af_rpformulariobm_2pdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
