...
<table width="800" class="tblBotones">
 <tr>
	<td align="right"><input type="button" id="btCuentaPub20" name="btCuentaPub20" onclick="cargarVentanaLista02(this.form,'../comunes/gehen.php?anz=listado_cuentas_pub20&limit=0&maxlimit=30&filtrar=default&campo=2','height=500, width=1000, left=200, top=100, resizable=yes');" value="Seleccionar Cuenta Pub20"/> <input type="button" id="btCuenta" name="btCuenta" onclick="cargarVentanaLista02(this.form,'../comunes/gehen.php?anz=listado_cuentas_contables&limit=0&maxlimit=30&filtrar=default&campo=3','height=500, width=1000, left=200, top=100, resizable=yes');" value="Seleccionar Cuenta"/>
