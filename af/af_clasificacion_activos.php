...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Clasificaci&oacute;n de Activos</td>
...
<table width="825px" class="tblBotones">
	<tr>
		...
		<td align="right">
			<input name="btNuevo" type="button" class="btLista" id="btNuevo" value="Nuevo" onclick="cargarPagina(this.form, 'af_clasificacion_activos_nuevo.php');" />
			<input name="btEditar" type="button" class="btLista" id="btEditar" value="Editar" onclick="cargarOpcionClasfActivos(this.form, document.getElementById('seleccion').value, 'af_clasificacion_activos_editar.php', 'SELF');" />
			<input name="btVer" type="button" class="btLista" id="btVer" value="Ver" onclick="cargarOpcionClasfActivos(this.form, document.getElementById('seleccion').value, 'af_clasificacion_activos_ver.php', 'BLANK', 'height=300, width=725, left=200, top=200, resizable=no');" />
			...
			<input name="btPDF" type="button" class="btLista" id="btPDF" value="PDF" onclick="cargarVentana(this.form, 'af_clasificacion_activos_pdf.php', 'height=800, width=800, left=200, top=200, resizable=yes');" />
		</td>
	</tr>
</table>
...
<thead>
	...
	for ($i=0; $i<$rows; $i++) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'seleccion');" id="<?=$field['CodClasificacion']?>">
			...
			<td><span <?=$style;?>><?=utf8_encode($field['Descripcion']);?></span></td>
