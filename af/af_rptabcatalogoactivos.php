...
<select name='forganismo' id='forganismo' class='selectBig' $dorganismo onchange='getFOptions_2(this.id, \"fanteproyecto\", \"chknanteproyecto\");'>";
  ...
  <td align='right'>Ubicaci&oacute;n:</td>
       ...
       <input type='checkbox' name='checkUbicacion' id='checkUbicacion' value='1' $cUbicacion onclick='enabledUbicacionActivosMenores(this.form);'/> 
       <input type='hidden' name='fubicacion' id='fubicacion' value='$fubicacion'/>
       <input type='text' name='fubicacion2' id='fubicacion2' value='$fubicacion2' size='56' $dUbicacion readonly/>";?> 
       <input type="hidden" name="btUbicacion" id="btUbicacion" value="..." onclick="cargarVentanaLista(this.form, 'af_listaubicacionesactivo.php?limit=0&campo=26','height=500, width=600, left=200, top=100, resizable=yes');" <?=$dUbicacion?>/> 
       <a id="ubicacionactivo" href="af_listaubicacionesactivo.php?filtrar=default&limit=0&campo=26&iframe=true&width=70%&height=90%" rel="prettyPhoto[iframe0]" style="visibility:hidden">
...
<tr>
  ...
  <td><input type='checkbox' id='checkDependencia' name='checkDependencia' value='1' $cDependencia onclick='enabledDependencia(this.form);'/>
      <select id='fDependencia' name='fDependencia' $dDependencia class='selectBig'>
        ...
        getDependencias($fDependencia, $forganismo, 0);
		 echo"</td>
  <td align='right'>Clasificaci&oacute;n:</td>
       <td class='gallery clearfix'><input type='checkbox' id='chkClasificacion' name='chkClasificacion' value='1' $cClasf onclick='enabledClasf(this.form);'/>
         ...
         <input type='text' id='DescpClasificacion' name='DescpClasificacion' value='$DescpClasificacion' size='56' $dClasf readonly/>";?>
         <input type='hidden' id='btClasif' name='btClasif' value='...' onclick="cargarVentanaLista(this.form, 'af_listaclasificacionactivo.php?limit=0&campo=24&ventana=insertarClasificacionActivo','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dClasf?>/> 
         <a id="clasf" href="af_listaclasificacionactivo.php?filtrar=default&limit=0&campo=24&ventana=insertarClasificacionActivo&iframe=true&width=70%&height=90%" rel="prettyPhoto[iframe1]" style="visibility:hidden">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a><? echo"</td>	 
</tr>
...
<tr>
  ...
  <td class='gallery clearfix'><input type='checkbox' name='chekcCosto' id='checkCosto' value='1' $cCosto onclick='enabledCosto(this.form);'/>
	  ...
	  <input type='text' id='centro_costos2' value='$centro_costos2' name='centro_costos2' $dCosto size='56' readonly/>";?>
    ...
    <a href="af_listacentroscostos.php?filtrar=default&limit=0&campo=9&iframe=true&width=70%&height=90%" rel="prettyPhoto[iframe2]" id="c_costo" style="visibility:hidden;">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>
	 <?  echo"</td>
...
<tr>
 <td align='center' colspan='4' class='gallery clearfix'>Rango de Activos: <input type='checkbox' id='chkRango' name='chkRango' value='1' $cRango onclick='enabledRPTABRango(this.form);'/> <input type='text' id='frango_desde' name='frango_desde' $dRango/> hasta <input type='text' id='frango_hasta' name='frango_hasta' $dRango/>
                        ";?> 
...
<br /><div style='width:900;' class='divDivision'>Cat&aacute;logo de Activos</div>
<form/><br />";
?>
