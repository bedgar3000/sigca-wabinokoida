...
<form id="frmentrada" name="frmentrada" action="af_movimientoactivonuevo.php" method="POST" onsubmit="return guardarNuevoMovimiento(this)">
...
<tr>
   ...
   <tr>
	 ...
	 <td><input type="hidden" name="radioEstado" id="radioEstado" value="I"/><input type='radio' id='radio1' name='radio1' onclick="estadosPosee02(this.form);" checked/>Interno
	     <input type='radio' id='radio2' name='radio2' onclick="estadosPosee02(this.form);"/>Externo</td>
    <td></td>
   ...
   <tr>
	 ...
	 <td><input type='text' id='apro_por' name='apro_por' value="" size="40"/>
	     <input type='text' id='fecha_apro' name='fecha_apro' value='00-00-0000' size='8' readonly/></td>
	 <td width='5'></td>
	 <td align='right'>Comentario:</td>
	 <td align='left' colspan='2'><input type='text' id='comentario' name='comentario' size='50'/></td>
   </tr>	
