...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Lista Actas | Responsabilidad Uso</td>
...
echo"<form name='frmentrada' id='frmentrada' action='af_rpresponsabilidaduso.php?limit=0' method='POST'>
...
<table width="1000" class="tblLista">
 <tr> <input type="hidden" id="registro" name="registro"/>
  ...
  <td align="right"></td>
  <td align="right">
   <input type="button" name="btImprimir" id="btImprimir" class="btLista" value="Imprimir" onclick="imprimirActaResponsabilidadUso(this.form);"/>
       ...
       <thead>
        <tr class="trListaHead">
              ...
              <th width="40" align="center">Dependencia</th>
      		    ...
      		    <th width="250" align="center">Responsable Primario</th>
              <th width="250" align="center">Responsable Usuario</th>
        ...
        if($ra!=0){
         ...
         for($i=0;$i<$ra;$i++){
      	 ...
      	 /// -------------------------------------------
      	 $id = $fa['NroActa'].'-'.$fa['CodOrganismo'].'-'.$fa['Anio'].'-'.$fa['CodDependencia'];
          ...
          echo"<tr class='trListaBody' onclick='mClk(this, \"registro\");' id='$id'>
      		...
      		<td align='left'>".$fa['EmpleadoResponsable']."</td>
      		<td align='left'>".$fa['EmpleadoResponUso']."</td>
      		<td align='center'>".$fa['FechaActa']."</td>
      	</tr>";
          }
       }
        ?>
