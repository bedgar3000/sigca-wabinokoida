...
<tr>
  ...
  <td colspan="3"><textarea id="descripcion" name="descripcion" cols="155" rows="4"><?=utf8_encode($fa['Descripcion']); ?></textarea></td>
  <td></td>
</tr>
</table>
...
<tr>
   ...
   <td><input type="text" name="ubicacion" id="ubicacion" style="width:75px;" value="" disabled/>
   ...
   <td class="gallery clearfix"><input type="hidden" name="btUbicacion" id="btUbicacion" value="..." onclick="cargarVentanaLista(this.form, 'af_listaubicacionesactivo.php?limit=0&campo=2','height=500, width=800, left=200, top=100, resizable=yes');"/> <!--<a href="af_listaubicacionesactivo.php?filtrar=default&limit=0&campo=2&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe3]">
     ...
     <a id="ubicacion" href="../lib/listas/listado_ubicaciones.php?filtrar=default&limit=0&campo=1&cod=ubicacion&nom=ubicacion2&ventana=selListado3&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe3]" style="visibility:<?=$valor4;?>"> 
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>   
...
<tr>
   ...
   <td><input type="text" id="codigo_barras" name="codigo_barras" size="30" style="text-align:right" maxlength="15" value="<?=$fa['CodBarra'];?>"/></td>
   <td class="tagForm">Tipo Mejora:</td>
   <td><select id="tipo_mejora" style="width:75px;">
       <?
         //// CONSULTA PARA CARGAR EL SELECT  DE TIPO MEJORA
       ...
       <input type="text" name="activo_principal2" id="activo_principal2" style="width:197px;" value="" disabled/></td>
...
<tr>
   ...
   <td><input type="text" id="centro_costos" name="centro_costos" style="width:75px;" value="" disabled/>
   ...
   <td class="gallery clearfix"><input type="hidden" name="btCentroCostos" id="btCentroCostos" value="..." onclick="cargarVentanaLista(this.form,'af_listacentroscostos.php?limit=0&campo=9','height=500,width=800,left=200,top=100,resizable=yes');"/> <!--<a href="af_listacentroscostos.php?filtrar=default&limit=0&campo=9&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe7]">
            ...
            <a id="c_costo" href="../lib/listas/listado_centro_costos.php?filtrar=default&limit=0&campo=1&cod=centro_costos&nom=centro_costos2&ventana=selListadoLista03&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe1]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>
...
<tr>
   <td colspan="2"><input type="checkbox" name="disp_operaciones" id="disp_operaciones" value="N"/> Disponible Para Activos Tecnol&oacute;gicos</td>
</tr>
<tr>
...
<tr><td align="center" colspan="5">Ultima Modif.:<input type="text" name="ultimo_usuario" value="" size="25" readonly/> 
  <input type="text" name="ultima_fecha" value="" size="20" readonly/></td></tr>
</table>
</div>
<!-- ****************************************************** COMIENZO TAB2 ************************************************ -->
...
<tr>
  ...
  <td width="183">
    <select id="fabricante" name="fabricante" style="width:220px;">
      <option value=""></option>
       <?
        for($i=0;$i<$rcon2;$i++){
  ...
  <td width="91"><input type="text" id="fecha_ingreso" name="fecha_ingreso" size="8" style="text-align:center;" onchange="crearPeriodo(this.form, this.id);" value="00-00-0000" maxlength="10"/></td>
</tr>
...
<tr>
  ...
  <td colspan="2"><? if($_PARAMETRO['VOUINGP20']=='S'){?>
  					<input type="checkbox" name="gen_voucher" id="gen_voucher" value="S" checked="checked"/>
                  <? }else{?>
...
<tr>
  <td class="tagForm">Proveedor:</td><?
                                     ...
                                     ?>
  <td colspan="2" class="gallery clerafix">
    <input type="text" id="proveedor" name="proveedor" size="4" value="<?=$f_proveedor['codProveedor'];?>" style="text_align:center;" disabled/> 
    <input type="text" id="nomb_proveedor" name="nomb_proveedor" size="51" value="<?=$f_proveedor['NombProveedor'];?>" disabled/>
    <input type="hidden" id="btProveedor" name="btProveedor" value="..." onclick="cargarVentanaLista(this.form, 'af_listaproveedor.php?limit=0&campo=1','height=500, width=800, left=200,top=100,resizable=yes');"/> <a href="af_listaproveedor.php?filtrar=default&limit=0&campo=1&cierre=1&iframe=true&width=75%&height=100%" rel="prettyPhoto[iframe8]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a></td>
...
<tr>
   ...
   <? 
     if($fa['FechaFactura']!="" and $fa['FechaFactura']!="0000-00-00"){
...
<tr>
 ...
 <td><input type="text" name="voucher_ingreso" id="voucher_ingreso" value="" style="text-align:right" disabled/></td>
</tr>
...
<tr>
   ...
   <td><input type="text" id="nro_guiaremision" name="nro_guiaremision" size="25" value="<?=$fa['NumeroGuia'];?>" maxlength="15"/> 
       <input type="text" id="fecha_guiaremision" name="fecha_guiaremision" size="8" maxlength="10" value="<?=$fechaGuiaRemision;?>"/></td>
   <td></td>
...
<tr>
   ...
   <td><input type="text" id="nro_documalmacen" name="nro_documalmacen" size="25" value="<?=$fa['NroDocumento'];?>" maxlength="15"/> 
       <input type="text" id="fecha_documalmacen" name="fecha_documalmacen" size="8" maxlength="10" value=""/></td>
   <td></td>
...
<tr>
   ...
   <td><input type="text" name="fecha_inventario" id="fecha_inventario" size="9" maxlength="10" style="text-align:center;" value="<?=date("d-m-Y");?>"/></td>
...
<table id="principal" name="principal" width="952" align="center" class="tblForm">
<table id="tabla01" name="table01" width="952" class="tblForm">
<tr>
...
<table width="952" class="tblBotones">
 <tr>
...
<tr>
   <td valign="top" style="height:100px; width:150px;">
   <table align="center" width="952"><tr><td align="center">
     <div style="overflow:scroll; height:150px; width:950px;">
     <table width="952" class="tblLista">
     <thead>
     <tr class="trListaHead">
        <th scope="col" width="10">#</th>
  ...
  <div style="width:950px; height=15px;" class="divFormCaption">Voucher Ingreso</div>
    ...
    <table width="952" class="tblForm">
      ...
      <tr>
       ...
       <option value=""></option>
       <?
         $st = "select * from af_tipotransaccion where FlagAltaBaja='A'"; //echo $st;
