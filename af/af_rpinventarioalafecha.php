...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Reporte | Inventario a la Fecha</td>
  <td align="right">
...
?>
<? echo"
<form name='frmentrada' action='af_rpinventarioalafecha.php?limit=0' method='POST'>
...
<div class='divBorder' style='width:1140px;'>
<table width='1140' class='tblFiltro'>
<tr>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarInventarioAFecha(this.form);'></center>
<br /><div style='width:900;' class='divDivision'>Inventario a la Fecha</div>
<form/><br />";
?>
...
<center>
<iframe name="af_rpinventarioalafechapdf" id="af_rpinventarioalafechapdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
