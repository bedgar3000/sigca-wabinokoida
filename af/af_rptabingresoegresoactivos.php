...
<tr>
  ...
  <td class='gallery clearfix'><input type='checkbox' id='chkCuenta' name='chkCuenta' value='1' $cCuenta onclick='enabledCuenta(this.form);'/> 
	  ...
	  <input type='text' id='fcuenta_descp' name='fcuenta_descp' value='$fcuenta_descp' $dCuenta size='42'/> ";?><a href="listado_cuentas_contables.php?filtrar=default&limit=0&campo=6&iframe=true&width=75%&height=100%" rel="prettyPhoto[iframe2]" id="cuenta" style="visibility:hidden;">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>
	 <?  echo" </td>
</tr>
