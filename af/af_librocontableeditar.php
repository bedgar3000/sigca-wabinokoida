...
<table width="700" class="tblForm">
  <tr>
    ...
    <td><input type="text" name="cod_librocontable"  id="cod_librocontable" size="4" maxlength="2" value="<?=$field['CodLibroCont']?>" style="text-align:right" readonly/></td>
  </tr>
  <tr>
    <td class="tagForm">Descripci&oacute;n:</td>
    <td><input type="text" name="descp_libro"  id="descp_libro" size="60" maxlength="100" value="<?=$field['Descripcion']?>" />*</td>
  </tr>
   <tr>
	    <td class='tagForm'>Estado:</td>
	    <td> <input type="text" name="radioEstado" id="radioEstado" value="<?=$field['Estado'];?>"/>
        <?
         if($field['Estado']=='A'){ 
