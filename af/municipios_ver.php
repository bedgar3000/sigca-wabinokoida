...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Municipios | Ver Registro</td>
...
include("fphp.php");
connect();
$sql="SELECT mastmunicipios.*, mastestados.CodPais FROM mastmunicipios, mastestados WHERE mastmunicipios.CodMunicipio='".$_GET['registro']."' AND (mastmunicipios.CodEstado=mastestados.CodEstado)";
...
if ($rows!=0) {
	...
	<table width='700' class='tblForm'>
	  ...
	  <tr>
	    ...
	    <td><input name='descripcion' type='text' id='descripcion' size='50' maxlength='100' value='".htmlentities($field[2])."' readonly /></td>
	  </tr>
		<tr>
