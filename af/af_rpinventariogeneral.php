...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Reporte | Inventario General</td>
  <td align="right">
...
?>
<? echo"
<form name='frmentrada' action='af_rpinventariogeneral.php?limit=0' method='POST'>
...
<tr>
   ...
   <td><input type='checkbox' id='chkfecha' name='chkfecha' value='1' $cFecha onclick='enabledRpAFecha(this.form);'/>
       <input type='text' id='fecha_desde' name='fecha_desde' value='$fecha_desde' size='8' maxlength='10' $dFecha class='datepicker'/> al
	   <input type='text' id='fecha_hasta' name='fecha_hasta' value='$fecha_hasta' size='8' maxlength='10' $dFecha class='datepicker'></td>
</tr>
</table>
</div>
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarInventarioAFGeneral(this.form);'></center>
...
<center>
<iframe name="af_rpinventariogeneralpdf" id="af_rpinventariogeneralpdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
