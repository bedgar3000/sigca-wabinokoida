...
<body>
<?
list($organismo, $num_movimiento, $estado, $nroActa, $anio, $tipoActa)= split('[|]',$_GET['registro']);
//// CONSULTA PRINCIPAL
///echo $num_orden,$num_movimiento;
$sql = "select * from af_movimientos where Organismo='$organismo' and MovimientoNumero='$num_movimiento' and Anio='$anio'"; 
...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Movimientos de Activos | Aprobar</td>
		<td align="right"><a class="cerrar" href="" onclick="window.close();">[cerrar]</a></td>
	</tr>
</table>
<hr width="100%" color="#333333" />

<form id="frmentrada" name="frmentrada" action="af_movimientoactivonuevo.php" method="POST" onsubmit="return guardarAprobarMovimientoActivo(this)">
<input type="hidden" id="resp" name="resp"/>
<input type="hidden" id="anio" name="anio" value="<?=$field['Anio'];?>" />
...
<tr>
   ...
   <tr>
	...
	?>
	 <td><input type="hidden" id="preparado_por" name="preparado_por" value="<?=$f_con['CodPersona'];?>" /><input type='text' id='pre_por' name='pre_por' value="<?=$f_con['NomCompleto'];?>" size='51' disabled/>
	 <? 
...
<?
  $s_consulta = "select 
				  ...
				  where
				       ...
				       afm.Organismo= '".$field['Organismo']."'  and 
				       afm.Anio= '".$field['Anio']."' ";
...
<tr>
  ...
  <tr>
<td colspan="4"><input type="text" name="nro_movimientos" id="nro_movimientos" style="border-color:#666; text-align:right" size="18" value="<?=$cont;?>" disabled/><input type="text" id="activo" name="activo" style="border-color:#666; text-align:right" size="60" value='<?=$f_consulta['Activo'];?>' disabled/><input type="text" id="descripcion" name="descripcion" style="border-color:#666" size="88" value="<?=$f_consulta['Descripcion'];?>" disabled/> Cod.Bar. <input type="text" id="cod_bar" name="cod_bar" size="35" style="border-color:#666; text-align:right" disabled value="<?=$f_consulta['CodigoBarras'];?>"/></td>
</tr>
  <tr>
...
<center>
 <input type="submit" id="guardar" name="guardar" value="Aprobar" onclick="this.disabled=true;"/>
