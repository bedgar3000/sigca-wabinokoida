...
if(($_POST['fFechaAprobacionDesde']!="")and($_POST['fFechaAprobacionHasta']!="")){
   ...
   $filtro.=" and FechaAprobacion>='".$fFechaAprobacionDesde."' and FechaAprobacion<='".$fFechaAprobacionHasta."'";
} 
...
if(($_POST['fFechaPreparacionDesde']!="")and($_POST['fFechaPreparacionHasta']!="")){
   ...
   $filtro.=" and FechaPreparacion>='".$fFechaPreparacionDesde."' and FechaPreparacion<='".$fFechapreparacionHasta."'";
}
