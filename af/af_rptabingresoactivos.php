...
if(($fFechaFacturaDesde!="") and ($fFechaFacturaHasta!="")) $cFechaFactura="checked";else $dFechaFactura="disabled";
...
<select name='forganismo' id='forganismo' class='selectBig' $dorganismo onchange='getFOptions_2(this.id, \"fanteproyecto\", \"chknanteproyecto\");'>";
  ...
  <td>
	 ...
	 <input type='text' id='fFechaPreparacionDesde' name='fFechaPreparacionDesde' value='$fFechaPreparacionDesde' $dFechaPreparacion size='10' maxlength='10' $dFecha style='text-align:center' class='datepicker'/> al
	 <input type='text' id='fFechaPreparacionHasta' name='fFechaPreparacionHasta' value='$fFechaPreparacionHasta'  $dFechaPreparacion size='10' maxlength='10' $dFecha style='text-align:center' class='datepicker'/>
  </td>
</tr>
...
<tr>
  ...
  <td><input type='checkbox' id='checkDependencia' name='checkDependencia' value='1' $cDependencia onclick='enabledDependencia(this.form);'/>
   ...
   <td>
     <input type='checkbox' name='chkFactura' id='chkFactura' value='1' $cFechaFactura onclick='enabledRPFechaFacturacion(this.form);' />
	 <input type='text' id='fFechaFacturaDesde' name='fFechaFacturaDesde' value='$fFechaFacturaDesde' $dFechaFactura size='10' maxlength='10' style='text-align:center' class='datepicker'/> al
	 <input type='text' id='fFechaFacturaHasta' name='fFechaFacturaHasta' value='$fFechaFacturaHasta' $dFechaFactura size='10' maxlength='10' style='text-align:center' class='datepicker'/>
   </td> 
</tr>
