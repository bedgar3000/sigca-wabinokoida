...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Reporte | Formulario BM-1</td>
  <td align="right">
...
?>
<? echo"
<form name='frmentrada' action='af_rpformulariobm_1.php?limit=0' method='POST'>
...
<tr>
  ...
  <td class='gallery clearfix'>
	  ...
	  <input type='text' id='fClasificacionPub20' name='fClasificacionPub20' value='$fClasificacionPub20' size='35' $dClasficacionPub20><input type='hidden' id='fCodclasficacionPub20' name='fCodclasficacionPub20' value='$fCodclasficacionPub20'/>";?><input type='hidden' id='btClasifPub20' name='btClasifPub20' value='...' onclick="cargarVentanaLista(this.form,'af_listaclasificacionPub20.php?limit=0&campo=2&ventana=insertarClasificacionPub20','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dClasficacionPub20?> /> 
...
<tr>
  <td align='right'>Centro Costo:</td>
	   <td class='gallery clearfix'><input type='checkbox' name='chekcCosto' id='checkCosto' value='1' $cCosto onclick='enabledCosto(this.form);'/>
		   ...
		   <input type='text' id='centro_costos2' value='$centro_costos2' name='centro_costos2' $dCosto size='52'/>";?><input type='hidden' id='btcosto' name='btcosto' value='...' onclick="cargarVentanaLista(this.form,'af_listacentroscostos.php?limit=0&campo=9','height=500,width=800,left=200,top=100,resizable=yes');"  <?=$dCosto?> /> 
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarFormularioBM_1(this.form);'></center>
<br /><div style='width:900;' class='divDivision'>Formulario BM-1</div>
<form/><br />";
?>
...
<center>
<iframe name="af_rpformulariobm_1pdf" id="af_rpformulariobm_1pdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
