...
if(!$_POST){ $fDependencia = $_SESSION["DEPENDENCIA_ACTUAL"];  $cDependencia = "checked";}
if(!$_POST){ $fEstado = 'AP'; $cEstado = "checked";} 
if(!$_POST){ $fSituacionActivo = 'IF'; $cSituacionActivo = "checked";} 

if(($_POST)and($fCodCatClasf!="")and($fClasificacion!="")){ $valor1="visible";}else $valor1="hidden";
if(($_POST)and($fCodclasficacionPub20!="")){ $valor2="visible";}else $valor2="hidden";
if(($_POST)and($centro_costos!="")){ $valor3="visible";}else $valor3="hidden";
if(($_POST)and($fubicacion!="")){ $valor4="visible";}else $valor4="hidden";
...
if($fEstadoConservacion!=""){ $filtro.=" AND (EstadoConserv='".$fEstadoConservacion."')"; $cEstConserv="checked";}
else $dEstConserv="disabled";

echo"<form name='frmentrada' id='frmentrada' action='af_listactivos.php?limit=0' method='POST'>
<input type='hidden' name='limit' value='".$limit."'>
<table class='tblForm' width='1250' height='50'>
   ...
   <tr>
	   ...
	   <td class='gallery clearf'>
	        <input type='checkbox' name='chekcCosto' id='checkCosto' value='1' $cCosto onclick='enabledCosto(this.form);'/>
		    <input type='hidden' id='centro_costos' value='$centro_costos' name='centro_costos'/>
		    <input type='text' id='centro_costos2' value='$centro_costos2' name='centro_costos2' $dCosto/>";?><input type='hidden' id='btcosto' name='btcosto' value='...' onclick="cargarVentanaLista(this.form,'af_listacentroscostos.php?limit=0&campo=9','height=500,width=800,left=200,top=100,resizable=yes');"  <?=$dCosto?> /> <a id="c_costo" href="../lib/listas/listado_centro_costos.php?filtrar=default&limit=0&campo=1&cod=centro_costos&nom=centro_costos2&ventana=selListadoLista03&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe1]" style="visibility:<?=$valor3;?>">
   ...
   <tr>
       ...
       <td class='gallery clearfix'>
	       <input type='checkbox' id='chkCatClasf' name='chkCatClasf' value='1' $cCatClasf onclick='enabledCatClasf(this.form);'/>
       ...
       <a id="clasificacion" href="af_listaclasificacionactivo.php?filtrar=default&limit=0&campo=17&ventana=insertarClasificacionActivo&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe2]" style="visibility:<?=$valor1;?>">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>
	 <? echo"</td>	
	   ...
	   <td class='gallery clearfix'>
	     <input type='checkbox' name='checkUbicacion' id='checkUbicacion' value='1' $cUbicacion onclick='enabledUbicacionListaActivos(this.form);'/> 
		 <input type='hidden' name='fubicacion' id='fubicacion' value='$fubicacion'/>
		 <input type='text' name='fubicacion2' id='fubicacion2' value='$fubicacion2' $dUbicacion/>";?><input type="hidden" name="btUbicacion" id="btUbicacion" value="..." onclick="cargarVentanaLista(this.form, 'af_listaubicacionesactivo.php?limit=0&campo=27','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dUbicacion?>/> <a id="ubicacion" href="../lib/listas/listado_ubicaciones.php?filtrar=default&limit=0&campo=1&cod=fubicacion&nom=fubicacion2&ventana=selListado3&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe3]" style="visibility:<?=$valor4;?>"> 
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>
	   <? echo"</td>
   </tr>
   ...
   <tr>
	   ...
	   <td colspan='2' class='gallery clearfix'><input type='checkbox' name='chkclasificacionpub20' id='chkclasificacionpub20' value='1' $cClasficacionPub20 onclick='enabledClasificacionPub20(this.form);'/> <input type='text' id='fClasificacionPub20' name='fClasificacionPub20' value='$fClasificacionPub20' size='35' $dClasficacionPub20><input type='hidden' id='fCodclasficacionPub20' name='fCodclasficacionPub20' value='$fCodclasficacionPub20'/>";?><input type='hidden' id='btClasifPub20' name='btClasifPub20' value='...' onclick="cargarVentanaLista(this.form,'af_listadoclasificacion20.php?limit=0&campo=2&ventana=insertarClasificacionPub20','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dClasficacionPub20?>/> <a id="clasificacion20" href="af_listadoclasificacion20.php?filtrar=default&limit=0&campo=2&ventana=insertarClasificacionPub20&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe4]" style="visibility:<?=$valor2;?>">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a><? echo" </td>
	   <td></td>	 
   </tr>
  ...
  <td align='right'>Estado:</td>
	 ...
	 <td align='right'>Estado Conserv.:</td>
	 <td><input type='checkbox' id='checkEstadoConserv' name='checkEstadoConserv' value='1' $cEstConserv onclick='enabledEstadoConservacion(this.form);'/>
	 <select id='fEstadoConservacion' name='fEstadoConservacion' class='selectMed' $dEstConserv>
     <option value=''></option>";
       getEstadoConservacion($fEstadoConservacion,0);	
	 echo"</select></td>
  </tr>
...
<table width="1250" class="tblLista">
 <tr> 
  ...
  <td align="right">
    ...
    <input type="button" name="btVer" id="btVer" class="btLista" value="Ver" onclick="cargarOpcion(this.form, 'af_listactivosver.php?', 'BLANK', 'height=600, width=950, left=250, top=25, resizable=no');"/>
...
<center>
	<div style="overflow:scroll; width:1250px; height:300px;">
		<table width="200%" class="tblLista">
			<thead>
			  <tr class="trListaHead">
			    ...
			    <th width="50">Clasificaci&oacute;n</th>
