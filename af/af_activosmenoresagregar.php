...
<script type="text/javascript" language="javascript" src="af_scripts.js"></script> <? // nuevo ####?>
...
<tr>
  ...
  <td colspan="3"><textarea id="descripcionLocal" name="descripcionLocal" cols="145" rows="4"><?=$fa['Descripcion']; ?></textarea><!--<input type="button" id="btCargar" name="btCargar" value="..." onclick="cargarVentanaLista(this.form, 'af_listactivoslogistica.php?limit=0&campo=2','height=500, width=820, left=200, top=100, resizable=yes');"/>--></td>
  <td></td>
</tr>
<tr>
...
<table class="tblForm" width="900">
<tr>
   <td width="166" class="tagForm">Situaci&oacute;n Activo:</td>
   <td>
   ...
   <td class="tagForm" width="153">Organismo:</td>
...
<tr>
 ...
 <td>
  ...
  ?>
     ...
     <input type="text" id="categoria" name="categoria" size="51" value="" disabled/></td>
</tr>
<tr>
   <td class="tagForm"></td>
   <td></td>
   ...
   <a href="af_listadoclasificacion20.php?filtrar=default&limit=0&campo=1&ventana=insertarClasificacionPub20&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe4]">
...
<tr>
   ...
   <td><input type="text" id="clasificacion" name="clasificacion" style="width:75px;" value="<?=$f_clactivo['CodClasificacion'];?>" disabled="true"/>
       <input type="text" id="clasificacion2" name="clasificacion2" size="50" value="<?=$f_clactivo['Descripcion'];?>" disabled="true"/></td>
...
<tr>
   ...
   <td><input type="text" name="ubicacion" id="ubicacion" style="width:75px;" value="" disabled/>
       <input type="text" name="ubicacion2" id="ubicacion2" size="50" value="" disabled/></td>
   ...
   <a href="../lib/listas/listado_ubicaciones.php?filtrar=default&limit=0&campo=1&cod=ubicacion&nom=ubicacion2&ventana=selListado3&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe3]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a></td>
</tr>
<tr>
...
<tr>
   <td class="tagForm"></td>
   <td>&nbsp;</td>
   <td class="tagForm" width="153"><u>Responsables del Activo</u></td>
   <td></td>
   <td></td>
</tr>
<tr>
   <td class="tagForm">Estado:</td><input type="hidden" name="radio" id="radio" />
   <td width="208"><input type="radio" name="radio1" id="radio1" value="A" checked="checked" onclick="chekeador(this.form, this.id);"/>Pendiente <input type="radio" name="radio2" id="radio2" value="I" onclick="chekeador(this.form, this.id);" disabled/>Activado</td>
   <td class="tagForm" width="153">Centro Costos:</td>
   <td><input type="text" id="centro_costos" name="centro_costos" style="width:75px;" value="" disabled="true"/>
       <input type="text" id="centro_costos2" name="centro_costos2" size="50" value="" disabled="true"/></td>
   ...
   <a href="../lib/listas/listado_centro_costos.php?filtrar=default&limit=0&campo=1&cod=centro_costos&nom=centro_costos2&ventana=selListadoLista03&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe5]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a></td>
</tr>
<tr>
   ...
   <td><input type="hidden" name="cod_empresponsable" id="cod_empresponsable"/> 
       <input type="text" id="empleado_responsable" name="empleado_responsable" size="67" disabled/></td>
...
<tr>
 <td class="tagForm"></td>
 <td></td>
 <td class="tagForm" width="153">Empleado Usuario:</td>
...
<tr><td align="center" colspan="5">Ultima Modif.:<input type="text" name="ultimo_usuario" value="" size="25" disabled/>
                                                 <input type="text" name="ultima_fecha" value="" size="20" disabled style="text-align:center;"/></td></tr>
</table>
</div>
<!-- ****************************************************** COMIENZO TAB2 ************************************************ -->
...
<tr>
  ...
  <td width="162" class="tagForm">Proveedor:</td>
     <?
       $s_proveedor= "select p.CodProveedor as codProveedor,
...
<tr>
  ...
  <td><input type="text" name="modelo" id="modelo" size="40" maxlength="20" value="<?=$fa['Modelo'];?>"/></td>
  <td></td>
...
<tr>
  ...
  <td><input type="text" name="nro_serie" id="nro_serie" size="40" maxlength="20" value="<?=$fa['NroSerie'];?>"/></td>
  <td></td>
  ...
  <td class="tagForm">Nro. Factura:</td>
   ...
   <td><input type="text" id="nrofactura" name="nrofactura" size="25" value="<?=$fa['NroFactura'];?>" style="text-align:right" />
       <input type="text" id="factura_fecha" name="factura_fecha" size="8" value="00-00-0000" /></td>
</tr>
...
<tr>
  ...
  <td><input type="text" id="orden_compra" name="orden_compra" size="25" value="<?=$fa['NroOrden']?>" maxlength="15"/> 
       <input type="text" id="fecha_ordencompra" name="fecha_ordencompra" size="8" maxlength="10" value="00-00-0000" onchange="validFecha(this.id,'Orden Compra',<?=$AnioActual;?>, <?=$MesActual;?>, <?=$DiaActual;?>);"/></td>
</tr>

<tr>
  <td class="tagForm">C&oacute;digo de Barras:</td>
  <td><input type="text" name="codigo_barras" id="codigo_barras" size="40" max="15" value=""/></td>
  <td></td>
  ...
  <td><input type="text" id="nro_guiaremision" name="nro_guiaremision" size="25" value="<?=$fa['NumeroGuia'];?>" maxlength="15"/> 
      <input type="text" id="fecha_guiaremision" name="fecha_guiaremision" size="8" maxlength="10" value="00-00-0000" onchange="validFecha(this.id,'Gu&iacute;a Remisi&oacute;n', <?=$AnioActual;?>, <?=$MesActual;?>, <?=$DiaActual;?>);"/></td>
</tr>
...
<tr>
 ...
 <td><input type="text" name="fecha_ingreso" id="fecha_ingreso" size="8" onchange="crearPeriodo2(this.form, this.id)|validFecha(this.id,'Fecha de Ingreso',<?=$AnioActual;?>, <?=$MesActual;?>, <?=$DiaActual;?>);" value="<?=date("d-m-Y");?>" /></td>
</tr>
<tr>
 <td class="tagForm">Periodo Registro:</td>
 <td><input type="text" name="periodo_registro" id="periodo_registro" size="8" value="<?=date("Y-m");?>" style="text-align:center;" disabled/></td>
</tr>
</table>
</div>
<!-- ****************************************************** COMIENZO TAB3 ************************************************ -->
...
<center><input type="submit" name="btGuardar" id="btGuardar" value="Guardar Registro" onclick="this.disabled=true;"/> 
