...
<input type="hidden" id="estado_activo" name="estado_activo"/>
...
<table width="1000" class="tblLista">
 <tr> <input type="hidden" id="registro" name="registro"/>
  ...
  <td align="right">
    ...
    <input type="button" name="btVer" id="btVer" class="btLista" value="Ver" onclick="cargarOpcion(this.form,'af_bajactivos.php?accion=ver','BLANK', 'height=600, width=1000, left=250, top=50, resizable=no');"/>
    <input type="button" name="btModificar" id="btModificar" class="btLista" value="Modificar" onclick="cargarOpcionListaBajaActivo(this.form, 'af_bajactivos.php?accion=modificar&regresar=af_bajactivoslistar','SELF')"/>
    <input type="button" name="btEliminar" id="btEliminar" class="btLista" value="Eliminar" onclick="EliminarRegistros(this.form,'af_bajactivoslistar.php','eliminarBajaActivo','APLICACIONES');"/>
    <input type="button" name="btAnular" id="btAnular" class="btLista" value="Anular" onclick="anularReg(this.form,'af_mensajeanulado.php?','Anular');"/>
  </tr>
</table>
...
<center>
     ...
     <table width="200%" class="tblLista">
		 <thead>
		  <tr class="trListaHead">
		        ...
		        <!--<th width="70" >CodTransaccionBaja</th>-->
				<th width="40" >Nro. Transacci&oacute;n</th>
		        <th width="35" >Activo</th>
				<th width="150" >Descripci&oacute;n Activo</th>
		        <th width="35" >CodigoInterno</th>
				<th width="200" >Descripci&oacute;n</th>
				<th width="100" >Tipo Transacci&oacute;n</th>
  ...
  if($ra!=0){
	 ...
	 echo "<input type='hidden' id='estado' name='estado' value='".$fa['Estado']."' />";
     ...
     echo"<tr class='trListaBody' onclick='mClk(this, \"registro\")|capturarEstadoActivo(this, \"$estadoActivo\");' id='$id'>
