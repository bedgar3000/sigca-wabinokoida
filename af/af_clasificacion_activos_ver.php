...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Clasificaci&oacute;n de Activos | Ver Registro</td>
...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td><input name="descripcion" type="text" id="descripcion" maxlength="255" value="<?=htmlentities($field['Descripcion'])?>" style="width:99%;" disabled="disabled" />*</td>
	</tr>
	<tr>
