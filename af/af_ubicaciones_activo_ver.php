...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Ubicaciones de Activo | Ver Registro</td>
...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td><input name="descripcion" type="text" id="descripcion" maxlength="100" value="<?=utf8_encode($field['Descripcion'])?>" style="width:80%;" disabled="disabled" />*</td>
	</tr>
	<tr>
