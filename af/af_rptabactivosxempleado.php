...
<tr>
 <td class='tagForm'>Responsable:</td>
  <td class='gallery clearfix'><input type='checkbox' name='chkResponsable' id='chkResponsable' value='1' $cResponsable onclick='enabledResponsable(this.form);'/>
	  ...
	  <input type='text' id='empleado_responsable' value='$empleado_responsable' name='empleado_responsable' $dResponsable size='56' readonly/>";?> <a id="responsable" href="af_listaempleados.php?filtrar=default&limit=0&campo=8&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe6]" style="visibility:hidden">
