...
<?
list($num_orden, $secuencia, $nrosecuencia, $codorganismo, $anio, $nrointerno)=SPLIT('[|]',$_GET['registro']);
//// CONSULTA PRINCIPAL
$sa = "select 
             * 
		 from 
...
<input type="hidden" id="anio" name="anio" value="<?=$fa['Anio'];?>"/>
...
<?
  echo"
	  ...
	  <input type='hidden' id='nrointerno' name='nrointerno' value='$nrointerno'/>
...
<tr>
   ...
   <td><?
	   ...
	   ?><input type="text" id="clasificacion" name="clasificacion" style="width:70px;" value="<?=$f_clactivo['CodClasificacion'];?>" style="text-align:right" disabled/>
...
<tr>
   ...
   ?><input type="text" name="ubicacion" id="ubicacion" style="width:70px;" value="<?=$f_con['CodUbicacion'];?>" style="text-align:right" disabled/>
...
<tr>
   ...
   <td>
      <select id="tipo_mejora" style="width: 72px;">
       ...
       Act. Principal:<input type="hidden" name="activo_principal" id="activo_principal" value=""/><input type="text" name="activo_principal2" id="activo_principal2" style="width:199px;" value="" disabled/></td>
...
<tr>
   ...
   ?>
   <td><input type="text" id="centro_costos" name="centro_costos" style="width:70px;" value="<?=$f_centcosto['CodCentroCosto'];?>" disabled="true" style="text-align:right"/>
...
<tr><td align="center" colspan="5">Ultima Modif.:<input type="text" name="ultimo_usuario" value="" size="25"/> 
                                                 <input type="text" name="ultima_fecha" value="" size="20"/></td></tr>
</table>
</div>
<!-- ****************************************************** COMIENZO TAB2 ************************************************ -->
...
<tr>
  ...
  <td><select id="fabricante" name="fabricante" class="selectMed" />
      <? if($fa['CodMarca']==""){?><option></option><? }?>
		   <?
            $scon2 = "select * from lg_marcas";
            $qcon2 = mysql_query($scon2) or die ($scon2.mysql_error()); $rcon2 = mysql_num_rows($qcon2); 
            for($i=0;$i<$rcon2;$i++){
               $fcon2= mysql_fetch_array($qcon2);
               if($fcon2['CodMarca']==$fa['CodMarca']) echo"<option value='".$fcon2['CodMarca']."' selected>".htmlentities($fcon2['Descripcion'])."</option>";
...
<tr>
 ...
 ?>
  <td colspan="2" class="gallery clearfix">
     ...
     <input type="text" id="nomb_proveedor" name="nomb_proveedor" value="<?=$f_proveedor['NombProveedor'];?>" size="51" disabled="true"/>
...
<?
  $s_obligaciones = "select 
					  ...
					  from 
					        ap_obligaciones 
					  where 
					        NroDocumento='".$fa['ObligacionNroDocumento']."' and 
...
?>
<td><input type="hidden" name="voucher_periodo" id="voucher_periodo" value="<?=$f_obligaciones['VoucherPeriodo'];?>"/><input type="text" name="voucher_ingreso" id="voucher_ingreso" value="<?=$f_obligaciones['Voucher'];?>" readonly="readonly"/></td>
<td></td>
</tr>
...
<tr>
 ...
 <td><input type="text" name="voucherPub20" id="voucherPub20" value="" style="text-align:right" disabled/></td>
</tr>
...
<tr>
   ...
   ?>
   <td><input type="hidden" id="orden_compra" name="orden_compra" value="<?=$fa['NroOrden'];?>"/><input type="text" id="nrointerorden" name="nrointerorden" size="25" value="<?=$fa['NroInterno'];?>" style="text-align:right" />
