...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Lista Actas | Entrega de Bienes</td>
...
if(!$_POST) $fTipoActa= "AA"; else $cTipoActa = "checked"; 
...
if($fTipoActa != ""){ $filtro.=" AND (TipoActa = '".$fTipoActa."')"; $cTipoActa="checked";}else $dTipoActa="disabled";

echo"<form name='frmentrada' id='frmentrada' action='af_rpentregabienes.php?limit=0' method='POST'>
...
<tr>
   ...
   <tr>
       <td align='right'></td>
       <td align='left'></td>
       <td align='right' width='120'>Tipo Acta:</td>
	   <td><input type='checkbox' id='chkTipoActa' name='chkTipoActa' value='1' $cTipoActa onclick='this.checked=true;'/>
	       <select name='fTipoActa' id='fTipoActa' class='selectMed' $dTipoActa>";
			  getTipoActa($fTipoActa, 0);
           echo"
           </select>
	   </td>
   </tr>
...
<table width="1000" class="tblLista">
 <tr> <input type="hidden" id="registro" name="registro"/>
  <td align="right" colspan="3">
   <input type="button" name="btImprimir" id="btImprimir" class="btLista" value="Imprimir" onclick="imprimirActaResponsabilidadUso(this.form, 'entrega_bienes');"/>
      ...
      <thead>
        ...
        if($ra!=0){
         ...
         for($i=0;$i<$ra;$i++){
      	 ...
      	 /// -------------------------------------------
      	 $id = $fa['NroActa'].'-'.$fa['CodOrganismo'].'-'.$fa['Anio'].'-'.$fa['TipoActa'];
