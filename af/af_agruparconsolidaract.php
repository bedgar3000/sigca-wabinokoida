...
if(!$_POST) $fDependencia = $_SESSION["FILTRO_DEPENDENCIA_ACTUAL"]; else $cDependencia = "checked";
...
<tr>
   ...
   <tr>
       ...
       <td><input type='text' id='fClasificacion' name='fClasificacion' value='$fClasificacion' size='5' readonly/>
           <input type='text' id='DescpClasificacion' name='DescpClasificacion' value='$DescpClasificacion' size='40' readonly/></td>	
	   <td align='right'></td>
	   <td></td>
   </tr>
   ...
   <tr>
       ...
       <td><input type='text' id='centro_costos' name='centro_costos' style='text-align:center;' value='$centro_costos' size='5' readonly/>
           <input type='text' id='centro_costos2' name='centro_costos2' size='40' value='$centro_costos2' readonly/>";?>
  ...
  <tr>
   ...
   <input type="button" id="btNroActivo" name="btNroActivo" value="..." onclick="cargarVentanaLista(this.form,'af_listaactivosfijos.php?limit=0&campo=20','height=500,width=950,left=200,top=100,resizable=yes');" <?=$dNroActivo;?> /><? echo" Cod. Int:<input type='text' id='codInterno' name='codInterno' value='$codInterno' size='15' style='text-align:right;' readonly/></td>
   <td align='right'>Ubicaci&oacute;n:</td>
   <td><input type='text' name='fUbicacion' id='fUbicacion' size='5' style='text-align:center;' value='$fUbicacion' readonly/>
       <input type='text' name='DescpUbicacion' id='DescpUbicacion' value='$DescpUbicacion' size='40' readonly/></td>
  </tr>
   
  <tr>
   <td align='right'>Descripci&oacute;n:</td>
   <td align='left'><input type='text' id='descripcion' name='descripcion' value='$descripcion' size='65' readonly/></td>
