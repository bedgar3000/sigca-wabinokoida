...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Lista Actas | Desincorporaci&oacute;n de Bienes</td>
...
echo"<form name='frmentrada' id='frmentrada' action='af_rpdesincorporacion.php?limit=0' method='POST'>
...
<table width="1000" class="tblLista">
 <tr> <input type="hidden" id="registro" name="registro"/>
  ...
  <td align="right"></td>
  <td align="right">
   <input type="button" name="btImprimir" id="btImprimir" class="btLista" value="Imprimir" onclick="imprimirActaResponsabilidadUso(this.form, 'desincorporacion_bienes');"/>
