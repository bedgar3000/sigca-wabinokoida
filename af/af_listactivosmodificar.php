...
}else list($CodOrganismo, $Activo) = split('[|]', $registro);
//list($organismo, $activo)=SPLIT('[-]',$_GET['registro']);
//// CONSULTA PRINCIPAL
$sa = "select * from af_activo where CodOrganismo = '".$CodOrganismo."' and Activo= '".$Activo."'"; //echo $sa;
...
<div id="tab1" style="display: block;">
  ...
  <table class="tblForm" width="950">
    ...
    <tr>
      ...
      <td colspan="3"><textarea id="descripcion" name="descripcion" cols="150" rows="4"><?=htmlentities($fa['Descripcion']); ?></textarea></td>
      <td></td>
    </tr>
  </table>
  ...
  <table class="tblForm" width="950">
   ...
   <tr>
     <td class="tagForm">Concepto de Movimiento:</td>
     <td>
   ...
   <tr>
     ...
     <td width="300">
                     ...
                     <input type="text" id="categoria" name="categoria" size="52" value="<?=$f_catdescp['DescripcionLocal'];?>" disabled/></td>
   </tr>
   <tr>
     ...
     <td class="tagForm">Clasificaci&oacute;n20:</td>
  	     ...
  	     ?>
     <td><input type="hidden" id="clasificacion20" name="clasificacion20" disabled="true" value="<?=$f_c20['CodClasificacion'];?>"/> 
         <input type="text" id="clasificacion20Descp" name="clasificacion20Descp" size="68" value="<?=$f_c20['Descripcion'];?>" disabled="true"/>
     </td>
   ...
   <tr>
     ...
     <td class="gallery clearfix"><input type="hidden" name="btUbicacion" id="btUbicacion" value="..." onclick="cargarVentanaLista(this.form, 'af_listaubicacionesactivo.php?limit=0&campo=2','height=500, width=800, left=200, top=100, resizable=yes');"/> <a href="af_listaubicacionesactivo.php?filtrar=default&limit=0&campo=2&iframe=true&width=100%&height=100%" rel="prettyPhoto[iframe3]">
              	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
              </a></td>
   </tr>
   <tr>
     ...
     <td class="gallery clearfix"><input type="hidden" name="btActivop" id="btActivop" value="..." onclick="cargarVentanaLista(this.form, 'af_listaactivosfijos.php?limit=0&campo=16','height=500, width=800, left=200,top=100,resizable=yes');"/> <a href="af_listaactivosfijos.php?filtrar=default&limit=0&campo=16&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe4]">
              	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
              </a></td>
   </tr>
   <tr>
     <td class="tagForm">C&oacute;digo Interno:</td>
     <td><input type="text" id="codigo_interno" name="codigo_interno" size="30" style="text-align:right" value="<?=$fa['CodigoInterno'];?>"/></td>
     ...
     ?>
     <td><input type="hidden" name="cod_usuario" id="cod_usuario" value="<?=$f_empusuario['CodPersona'];?>" /> 
     	   <input type="text" id="nomb_usuario" name="nomb_usuario" size="68" value="<?=$f_empusuario['NomCompleto'];?>" disabled/></td>
   ...
   <tr>
     ...
     ?>
     <input type="text" id="t_seguro" name="t_seguro" size="8" value="<?=$f_tseguro['CodTipoSeguro'];?>" disabled/>
   ...
   <tr>
     ...
     ?>
     <td><input type="text" id="t_vehiculo" name="t_vehiculo" size="8" value="<?=$f_tvehiculo['CodTipoVehiculo'];?>" disabled/> <select id="select_TVehiculo" class="selectSma" onchange="valorTVehiculo(this.id);" ><option></option>
         <?
   ...
   <tr><? if($fa['FlagParaMantenimiento']=='S')$checked01 ='checked'; ?>
     ...
     ?>
     <td><input type="text" id="centro_costos" name="centro_costos" style="width:75px;" value="<?=$f_cancosto['CodCentroCosto'];?>" disabled/>
   ...
   <tr>
     <td colspan="2"><? if($fa['FlagParaOperaciones']=='S'){?>
  				   ...
  				   <? }?> Disponible Para Activos Tecnol&oacute;gicos</td>
   </tr>
   <tr>
     ...
     <? 
  	  ...
  	  $s_usuario = "select * from mastpersonas  where CodPersona = '".$fa['PreparadoPor']."'"; 
  	  $q_usuario = mysql_query($s_usuario) or die ($s_usuario.mysql_error());
  	  $f_usuario = mysql_fetch_array($q_usuario);
  	?>
    <input type="hidden" id="cod_prepor" name="cod_prepor" value="<?=$fa['PreparadoPor'];?>"/><input type="text" id="preparadoPor" name="preparadoPor" size="50" disabled value="<?=$f_usuario['NomCompleto'];?>"/> <input type="text" name="fecha_preparado" id="fecha_preparado" size="8" disabled value="<?=$fechaPreparacion;?>"/></td>
   </tr>
    <tr>
     <td class="tagForm">Aprobado por:</td>
     <td colspan="3"><input type="text" id="aprobadoPor" name="aprobadoPor" size="50" disabled="true"/>
                     <input type="text" name="fecha_aprobado" id="fecha_aprobado" size="8" disabled="true"/></td>
    </tr>
    <tr><td align="center" colspan="5">Ultima Modif.:<input type="text" name="ultimo_usuario" value="<?=$fa['UltimoUsuario'];?>" size="25" readonly/> 
                                                     <input type="text" name="ultima_fecha" value="<?=$fa['UltimaFechaModif'];?>" size="20" readonly/></td></tr>
 </table>
...
<tr>
  ...
  <td width="141" class="tagForm">Fecha Ingreso:</td>
			...
			?>
  <td width="91"><input type="text" id="fecha_ingreso" name="fecha_ingreso" size="8" style="text-align:center;" maxlength="10" value="<?=$fecha_ingreso;?>" onchange="crearPeriodo(this.form, this.id);"/></td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="2"  class="gallery clearfix">
    ...
    <input type="text" id="nomb_proveedor" name="nomb_proveedor" size="51" value="<?=$f_proveedor['NombProveedor'];?>" readonly/>
    <input type="hidden" id="btProveedor" name="btProveedor" value="..." onclick="cargarVentanaLista(this.form, 'af_listaproveedor.php?limit=0&campo=7&ventana=insertProveedor','height=500, width=820, left=200,top=100,resizable=yes');" />
  ...
  <td colspan="2"><select id="obligacionTipoDocumento" name="obligacionTipoDocumento" style="width:130px;">
				  ...
				  <? 
				     if($fa['FechaObligacion']!="" and $fa['FechaObligacion']!="0000-00-00"){
						 list($a, $m, $d) = split('[-]', $fa['FechaObligacion']); 
					 	$fechaObligacion = $d.'-'.$m.'-'.$a; 
					 }
				  ?>
                  <input type="text" id="numObligacion" name="numObligacion" size="20" value="<?=$fa['FacturaNumeroDocumento'];?>" style="text-align:right;"/>
                  <input type="text" id="fechaObligacion" name="fechaObligacion" size="9" value="<?=$fechaObligacion;?>" /></td>
...
<tr>
   ...
   <td><input type="text" id="nrofactura" name="nrofactura" size="25" value="<?=$fa['NroFactura'];?>" style="text-align:right" />
       <input type="text" id="factura_fecha" name="factura_fecha" size="9" maxlength="10" value="<?=$factura_fecha;?>" /></td>
 <td></td>
 <td class="tagForm">Voucher Ingreso Pub20:</td>
 <td><input type="text" name="vouvherPu20" id="vouvherPu20" value="<?=$fa['VoucherIngPub20'];?>" style="text-align:right" disabled/></td>
</tr>
...
<tr>
   ...
   ?>
   <td><input type="text" id="orden_compra" name="orden_compra" size="25" value="<?=$fa['NumeroOrden']?>" style="text-align:right;"/> 
...
<tr>
   ...
   <? 
     if($fa['NumeroGuiaFecha']!="" and $fa['NumeroGuiaFecha']!="0000-00-00"){
		 ...
		 $fechaGuiaRemision = $d.'-'.$m.'-'.$a; 
	 }
   ?>
   <td><input type="text" id="nro_guiaremision" name="nro_guiaremision" size="25" value="<?=$fa['NumeroGuia'];?>" /> 
       <input type="text" id="fecha_guiaremision" name="fecha_guiaremision" size="9" maxlength="10" value="<?=$fechaGuiaRemision;?>"/></td>
   <td></td>
...
<tr>
   ...
   <? 
    if($fa['DocAlmacenFecha']!="" and $fa['DocAlmacenFecha']!="0000-00-00"){
		list($a,$m,$d)=split('[-]',$fa['DocAlmacenFecha']);
		$fechaAlmacen = $d.'-'.$m.'-'.$a;
	}
	?>
   <td><input type="text" id="nro_documalmacen" name="nro_documalmacen" size="25" value="<?=$fa['NumeroDocAlmacen'];?>" /> 
       <input type="text" id="fecha_documalmacen" name="fecha_documalmacen" size="9" value="<?=$fechaAlmacen;?>" maxlength="10" /></td>
   <td></td>
   <td class="tagForm"></td>
   <td></td>
</tr>
...
<div id="tab5" style="display: none;">
    <div style="width:950px; height=15px;" class="divFormCaption">Voucher Ingreso</div>
    ...
    <tr>
      ...
      <td colspan="3"><select id="tipobaja" name="tipobaja" class="selectSma" onchange="CargarInformacion(this.form, this.id, 'insertarDatos_1')">
          ...
          <?
		   ...
		   if($rt!=0) 
		      for($i=0; $i<$rt; $i++){
				...
				if($ft['TipoTransaccion']==$field_a['TipoTransaccion']){
			        echo" <option value='".$ft['TipoTransaccion']."' selected>".$ft['Descripcion']."</option>";	
				}else{
        ...
        /*for($i=0; $i<$r_actdistcontable; $i++){
          ...
          $s_01 = "select * from af_tipotransaccion where FlagAltaBaja='A'";
  ...
  <center>
      <div style="overflow:scroll; width:950px; height:200px;">
        <table width="950"  class="tblLista">
          <thead>  
            <tr class="trListaHead">
            <th width="50">#</td>
            <th width="200">Cuenta</td>
            <th width="300">Descripci&oacute;n</td>
            <th width="60">Monto</td>
            <th width="30">Signo</td>
          </tr>
          </thead>
          <tr><td colspan="5">
            <center>
            <div id="resultados" name="resultados" style="width:950px;">
           
                <? 
                echo"<table width='940' border='0' align='center'>";
...
<!-- ********************************************************************************************************************* -->
<center><input type="submit" name="btGuardar" id="btGuardar" value="Guardar Registro"/> 
        <input type="button" name="btCancelar" id="btCancelar" value="Cancelar" onclick="cargarPagina(this.form,'<?=$regresar?>.php');"/></center>
</form>