...
$clasificacion=$_GET["clasificacion"];
	 ...
	 $sql = "SELECT * FROM bienes WHERE clasificacion='$clasificacion';";
...
$clasificacion= remplace ($clasificacion);
...
<table  border='0' width='99%'>
		...
		<td width='67%'><div align='center'><b><br /><br />REPORTE GENERAL SEG&Uacute;N SU CLASIFICACI&Oacute;N </b></div></td>
...
<table width='99%' border='0' align='center' cellpadding='2' cellspacing='2'>
  		...
  		<tr>
  		<td width='140' align='left'><b>TIPO DE BIEN:</b></td>
  		<td width='600' align='left' colspan='6'>$tipo_de_bien</td>
		</tr>
  		<tr>
  		<td width='140' align='left'><b>CODIGO:</b></td>
    	<td width='600' colspan='6' align='left'>$clasificacion</td>
  		</tr>
</table>
<br>
<br>
...
<table width='90%' border='1' align='center'>
		...
		<td rowspan='2' width='85' align='center'><b> N&ordm; <br />Identificaci&oacute;n</b></td>
...
if($clasificacion!=""){
	  ...
	  $sql = "SELECT * FROM bienes WHERE clasificacion='$clasificacion' ORDER BY codigo_bien ASC;";
...
$estatus2= remplace ($estatus2);
	...
	$inventario.="<tr>
		...
		<td width='85' align='center'>$codigo_bien</td>
