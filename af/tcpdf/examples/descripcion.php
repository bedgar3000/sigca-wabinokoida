...
<table  border='0' width='99%'>
		...
		<td width='67%'><div align='center'><b><br /><br />REPORTE POR DESCRIPCI&Oacute;N DE BIENES </b></div></td>
...
<table width='90%' border='1' align='center'>
		...
		<td rowspan='2' width='55%' align='center'><b><br /> Nombre y Descripci&oacute;n de los Elementos</b></td>
   	    <td rowspan='2' width='70' align='center'><br /><br /> <b>Precio</b></td>
		<td rowspan='2' width='170' align='center'><br /><br />Estatus</td>
		</tr>
		<tr>
...
if($denominacion!="" && $codigo_seccion!="" && $ubicacion!=""){


	 $buscar.=" denominacion LIKE  '%".$_GET['denominacion']."%' ";

	$sql = "SELECT * FROM bienes WHERE $buscar $seccion AND ubicacion='$ubicacion' ORDER BY clasificacion ASC;";
...
$estatus2= remplace ($estatus2);
	...
	$inventario.="<tr>
		...
		<td width='170' align='center'>$estatus&nbsp;/&nbsp;$estatus1$estatus2</td>
