...
{$fecha2 = "hist_desin_incorp.fecha_desinc >='$fecha_ini' AND hist_desin_incorp.fecha_desinc<='$fecha_fin'AND ";}


$estatus=$_GET["estatus"];
if($estatus=="FALTANTE")
{ $estatus = " ";} 
$ubicacion_desinc=$_GET["ubicacion"];
$seccion_desinc=$_GET["codigo_seccion"];
if($seccion_desinc==$ubicacion_desinc)
{ $seccion = " ";} 
else
 { $seccion = "  seccion_desinc='$seccion_desinc' AND";}
if($seccion_desinc!="" && $ubicacion_desinc!=""){
}

		  $sql2 = "SELECT bienes.clasificacion,bienes.codigo_i,bienes.codigo_d,bienes.codigo_bien,bienes.denominacion,bienes.descripcion_adicional,bienes.precio,bienes.estatus,hist_desin_incorp.ubicacion_desinc,hist_desin_incorp.seccion_desinc FROM bienes,hist_desin_incorp WHERE $fecha2 $seccion ubicacion_desinc='$ubicacion_desinc' AND estatus!='FALTANTE' AND bienes.codigo_bien=hist_desin_incorp.codigo_bien ORDER BY clasificacion ASC;";
