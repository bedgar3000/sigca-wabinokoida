...
if($codigo_seccion!="" && $ubicacion!=""){
		...
		$sql2 = "SELECT clasificacion,codigo_bien,denominacion,descripcion_adicional,precio FROM bienes WHERE $fecha2 $seccion  ubicacion='$ubicacion' AND estatus!='FALTANTE' AND estatus!='INCORPORADO' ORDER BY clasificacion ASC;";
	 
	 
	  $sql = "SELECT clasificacion,codigo_bien,denominacion,descripcion_adicional,precio FROM bienes WHERE $fecha $seccion  ubicacion='$ubicacion' AND estatus!='FALTANTE' AND estatus!='DESINCORPORADO' ORDER BY clasificacion ASC;";
...
$inventario.="	</table>
  ...
  <br />SELLO</td>
	  ...
	  <tr>
		...
		<td width='195' colspan='2' align='center'><br /><b>Karina Rodr&iacute;guez</b></td>
		...
		<td width='195' colspan='2' align='center'><b>JEFE D.S.G</b></td>
		<td width='223' colspan='2' align='center'>&nbsp;</td>
