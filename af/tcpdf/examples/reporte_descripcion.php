...
$denominacion=$_GET["denominacion"];
	  ...
	  $sql = "SELECT * FROM bienes WHERE denominacion='$denominacion';";
...
$denominacion= remplace ($denominacion);
...
<table  border='0' width='99%'>
		...
		<td width='67%'><div align='center'><b><br /><br />REPORTE GENERAL SEG&Uacute;N SU DESCRIPCI&Oacute;N </b></div></td>
...
<table width='99%' border='0' align='center' cellpadding='2' cellspacing='2'>
  		...
  		<td width='600' align='left' colspan='6'>$denominacion</td>
		</tr>
  	</table>
<br />
...
//if (isset($_POST['denominacion'])&&($_POST['ubicacion'])&&($_POST['codigo_seccion'])) 


 $buscar.=" denominacion LIKE  '%".$_GET['denominacion']."%'";

	$sql = "SELECT * FROM bienes WHERE $buscar;";
