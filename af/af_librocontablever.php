...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  ...
  <td align="right">
   <a class="cerrar" href="javascript:window.close();">[cerrar]</a>
  </td>
 </tr>
</table>
...
<table width="700" class="tblForm">
  ...
  <tr>
    ...
    <td><input type="text" name="descp_libro"  id="descp_libro" size="60" maxlength="100" value="<?=$field['Descripcion']?>" readonly/></td>
  </tr>
   <tr>
        ...
        <?
         if($field['Estado']=='A'){ 
		    echo "<input name='status_libro' type='radio' value='A' checked='checked'> Activo
		         <input name='status_libro' type='radio' value='I' disabled /> Inactivo";
		 }else{
