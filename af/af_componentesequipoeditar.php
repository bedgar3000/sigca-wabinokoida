...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Maestro Componentes de un Equipo | Editar Registro</td>
...
<? 
 ...
 $sql = "select * from af_tipocomponente where CodTipoComp = '".$_POST['registro']."' ";
...
<tr>
 ...
 <td><input type="text" name="descp_local"  id="descp_local" size="40" maxlength="30" value="<?=$field['DescripcionLocal'];?>"/>*</td>
</tr>
<tr>
 <td></td>
</tr>
<tr>
 ...
 <td><input type="hidden" id="radioEstado" name="radioEstado" value="A"/> 
     <? if($field['Estado']=='A'){ ?> 
     <input type="radio" name="radio1" checked="checked"/>Activo
     ...
     <input type="radio" name="radio2" checked="checked"/>Inactivo
     <? }?></td>
</tr>
