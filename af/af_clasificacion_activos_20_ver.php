...
connect();
//	-----------------------------------
$sql = "SELECT * FROM af_clasificacionactivo20 WHERE CodClasificacion = '".$registro."'";
$query = mysql_query($sql)  or die ($sql.mysql_error());
if (mysql_num_rows($query) != 0) $field = mysql_fetch_array($query);
?>
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Clasificaci&oacute;n de Activos - Publicaci&oacute;n 20 | Ver Registro</td>
...
<table width="700" class="tblForm">
	<tr>
       ...
       <td><select id="nivel" name="nivel">
             <option value=""><?=$field['Nivel'];?></option>
           </select></td>
    </tr>
    <tr>
	...
	<tr>
		...
		<td><input name="descripcion" type="text" id="descripcion" maxlength="255" value="<?=utf8_encode($field['Descripcion'])?>" style="width:95%;" disabled="disabled" />*</td>
	</tr>
	<tr>
