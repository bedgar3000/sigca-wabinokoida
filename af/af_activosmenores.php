...
if(($_POST)and($fubicacion!="")){ $valor1="visible";}else $valor1="hidden";
if(($_POST)and($fClasificacion!="")){ $valor2="visible";}else $valor2="hidden";
if(($_POST)and($fClasf20!="")){ $valor3="visible";}else $valor3="hidden";
...
<tr>
   ...
   <tr>
	   ...
	   <td class='gallery clearfix'>
		  ...
		  <input type='text' name='fubicacion2' id='fubicacion2' value='$fubicacion2' size='30' $dUbicacion readonly/>";?><input type="hidden" name="btUbicacion" id="btUbicacion" value="..." onclick="cargarVentanaLista(this.form, 'af_listaubicacionesactivo.php?limit=0&campo=26','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dUbicacion?>/> <a id="ubicacionactivo" href="../lib/listas/listado_ubicaciones.php?filtrar=default&limit=0&campo=1&cod=fubicacion&nom=fubicacion2&ventana=selListado3&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe1]" style="visibility:<?=$valor1;?>">
   ...
   <tr>
       ...
       <td class='gallery clearfix'><input type='checkbox' id='chkClasificacion' name='chkClasificacion' value='1' $cClasf onclick='enabledClasf(this.form);'/>
	       <input type='hidden' id='fClasificacion' name='fClasificacion' value='$fClasificacion'/><input type='text' id='DescpClasificacion' name='DescpClasificacion' value='$DescpClasificacion' size='30' $dClasf readonly/>";?><input type='hidden' id='btClasif' name='btClasif' value='...' onclick="cargarVentanaLista(this.form, 'af_listaclasificacionactivo.php?limit=0&campo=24&ventana=insertarClasificacionActivo','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dClasf?>/> <a id="clasf" href="af_listaclasificacionactivo.php?filtrar=default&limit=0&campo=24&ventana=insertarClasificacionActivo&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe2]" style="visibility:<?=$valor2;?>">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>
	 <? echo"</td>	
   </tr>
   ...
   <tr>
	   ...
	   <td class='gallery clearfix'><input type='hidden' name='fClasf20' id='fClasf20' value='$fClasf20'/><input type='checkbox' id='chkClasf20' name='chkClasf20' value='1' $cClasf20 onclick='enabledClasf20(this.form);'/><input type='text' name='DescpClasf20' id='DescpClasf20' value='$DescpClasf20' size='30' $dClasf20 readonly/>";?><input type='hidden' id='btclasf20' name='btclasf20' value='...' onclick="cargarVentanaLista(this.form,'af_listadoclasificacion20.php?limit=0&campo=18','height=500, width=800, left=200, top=100, resizable=yes')" <?=$dClasf20; ?> /> <a id="clasificacion20" href="af_listadoclasificacion20.php?filtrar=default&limit=0&campo=18&iframe=true&width=80%&height=100%" rel="prettyPhoto[iframe3]" style="visibility:<?=$valor3;?>">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a><? echo"</td>
   </tr>
         ...
         for($i=0;$i<$ra;$i++){
           $fa= mysql_fetch_array($qa);
            ...
            echo"<tr class='trListaBody' onclick='mClk(this, \"registro\");' id='".$fa['Activo']."'>
        		...
        		<td align='center'>".htmlentities($f_ubicaciones['Descripcion'])."</td>
