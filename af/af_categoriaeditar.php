...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Maestro de Categor&iacute;a | Editar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="af_categoriadepreciacion.php" method="POST" onsubmit="return editarCategoria(this);">
...
<tr>
 <td width="139" class="tagForm"><b>C&oacute;digo Categor&iacute;a:</b></td>
 <td width="169"><input type="text" name="codcategoria"  id="codcategoria" size="7" maxlength="10" value="<?=$field['CodCategoria']?>" readonly/>*</td>
 <td width="191" class="tagForm"><b><u>Cuentas Contables Activo</u></b></td>
 <td width="71"></td>
 <td width="140" class="tagForm"><b><u>Cuentas de Gastos</u></b></td>
</tr>
<tr>
 <td class="tagForm">Descripci&oacute;n Local:</td>
 <td><input type="text" name="descp_local"  id="descp_local" size="33" maxlength="250" value="<?=$field['DescripcionLocal']?>"/>*</td>
 <td class="tagForm">Valor Hist&oacute;rico:</td>
 <td><input type="text" name="v_historico"  id="v_historico" size="8" maxlength="20" onclick="valorDestino(this.form,this.id)" value="<?=$field['CuentaHistorica']?>"/>*</td>
 <td class="tagForm">Depreciaci&oacute;n:</td>
 <td width="72"><input type="text" name="cg_depreciacion"  id="cg_depreciacion" size="8" maxlength="20" value="<?=$field['CuentaGastos']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
</tr>
<tr>
 ...
 <td><select name="t_depreciacion" id="t_depreciacion">
  ...
  <td><input type="text" name="cc_adiciones"  id="cc_adiciones" size="8" maxlength="20" value="<?=$field['CuentaHistoricaVariacion']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
 <td class="tagForm">Ajuste x Inflaci&oacute;n:</td>
 <td><input type="text" name="cg_ajinflacion"  id="cg_ajinflacion" size="8" maxlength="20" value="<?=$field['CuentaGastosRevaluacion']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
<tr>
 ...
 <td><select name="g_categoria" id="g_categoria">
  ...
  <td><input type="text" name="cc_ajinflacion"  id="cc_ajinflacion" size="8" maxlength="20" value="<?=$field['CuentaHistoricaRevaluacion']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
 ...
 <td><? 
      if($field['InventariableFlag']=='S'){?>
	     <input type="checkbox" id="cat_invent" name="cat_invent" checked onclick="asignarValorCatInvent(this.form)"/>
      <? }else{?>
         <input type="checkbox" id="cat_invent" name="cat_invent" onclick="asignarValorCatInvent(this.form)"/> 
       <? }?> 
 </td>
 <td class="tagForm"><b><u>Cuentas Contables Depreciaci&oacute;n</u></b></td>
 <td></td>
 <td class="tagForm">R.E.I.:</td>
 <td><input type="text" name="occ_rei"  id="occ_rei" size="8" maxlength="20" value="<?=$field['CuentaREI']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
<tr>
 <td></td>
</tr>
<tr>
 ...
 <td><input type="text" name="cd_pdepreciacion"  id="cd_pdepreciacion" size="8" maxlength="20" value="<?=$field['CuentaDepreciacion']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
 <td class="tagForm">Valor Neto:</td>
 <td><input type="text" name="occ_valorneto"  id="occ_valorneto" size="8" maxlength="20" value="<?=$field['CuentaNeto']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
</tr>
<tr>
 <td></td>
 <td></td>
 <td class="tagForm">Adiciones:</td>
 <td><input type="text" name="cd_adiciones"  id="cd_adiciones" size="8" maxlength="20" value="<?=$field['CuentaDepreciacionVariacion']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
 <td class="tagForm">Cta. Resultado:</td>
 <td><input type="text" name="occ_ctaresultado"  id="occ_ctaresultado" size="8" maxlength="20" value="<?=$field['CuentaResultado']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
</tr>
<tr>
 <td class="tagForm">Estado:</td>
 <td><input type="hidden" name="radioEstado" id="radioEstado" value="<?=$field['Estado'];?>"/>
     <? if($field['Estado']=='A'){?> 
     <input type="radio" name="radio1"  id="radio1" checked="checked" onclick="estadosPosee(this.form);"/>Activo
     <input type="radio" name="radio2" id="radio2" onclick="estadosPosee(this.form);"/>Inactivo
     <? }else{?>
     <input type="radio" name="radio1" id="radio1" onclick="estadosPosee(this.form);"/>Activo
     <input type="radio" name="radio2" id="radio2" checked="checked" onclick="estadosPosee(this.form);"/>Inactivo
    <? }?>
 </td>
 <td class="tagForm">Ajustes x Inflaci&oacute;n:</td>
 <td><input type="text" name="cd_ajinflacion"  id="cd_ajinflacion" size="8" maxlength="20" value="<?=$field['CuentaDepreciacionRevaluacion']?>" onclick="valorDestino(this.form,this.id)"/>*</td>
</tr>
</table></td>
</tr>
...
<tr>
 ...
 <td class="tagForm"></td>
 <td></td>
   <td width="10"><input type="button" id="btCuenta" name="btCuenta" onclick="cargarVentanaLista02(this.form,'listado_cuentas_contables.php?limit=0&campo=3','height=500, width=800, left=200, top=100, resizable=yes');" value="Seleccionar Cuenta"/></td>
  </tr>
  <tr>
	 <td width="100"></td>
	<td class='tagForm'>&Uacute;ltima Modif.:</td>
	<td>
	  <input type="text" name="ult_usuario"  id="ult_usuario" size="30" value="<?=$field['UltimoUsuario'];?>"  disabled />
	  <input type="text" name="ult_fecha"  id="ult_fecha" size="20" value="<?=$field['UltimaFechaModif'];?>" disabled />
	</td>
	<td width="100"></td>
  </tr>
</table> 
...
<table width="400px" class="tblLista">
    ...
    <tr class="trListaBody" onclick="mClk(this, 'seldetalle');" id="<?=$f_con['CodContabilidad'].'_'.$f_con['CodContabilidad'].'_'.$cont;?>">
     <td>
         <select name="select1" id="select1_<?=$_POST['candetalle']?>" style="width:100%;">
		<? 
     ...
     <td>
      <input type="text" name="descripcion" id="descripcion_a<?=$cont?>" value="<?=$f_con['DepreciacionPorcentaje'];?>"  style="width:100%;" readonly="readonly"/>
     </td>
    </tr>
    <? }} ?>
    </tbody>
