...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Clasificaci&oacute;n de Activos | Nuevo Registro</td>
...
<table width="700" class="tblForm">
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="15" maxlength="8" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Descripci&oacute;n:</td>
		<td><input name="descripcion" type="text" id="descripcion" maxlength="255" style="width:99%;" />*</td>
	</tr>
	<tr>
