...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Reporte | Inventario x Dependencia/Usuario Responsable </td>
  <td align="right">
...
?>
<? echo"
<form name='frmentrada' action='af_rpinventxdepusuarioresp.php?limit=0' method='POST'>
...
<div class='divBorder' style='width:95%;'>
...
<select name='forganismo' id='forganismo' style='width:260px;' $dorganismo onchange='getFOptions_2(this.id, \"fanteproyecto\", \"chknanteproyecto\");'>";
...
<td class='gallery clearfix'><input type='checkbox' id='chkCatClasf' name='chkCatClasf' value='1' $cCatClasf onclick='enabledCatClasf(this.form);'/>
	...
	<input type='text' id='DescpClasificacion' name='DescpClasificacion' value='$DescpClasificacion' $dCatClasf size='28' readonly/>";?><input type='hidden' id='btClasif' name='btClasif' value='...' onclick="cargarVentanaLista(this.form, 'af_listaclasificacionactivo.php?limit=0&campo=17&ventana=insertarClasificacionActivo','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dCatClasf?>/> <a id="clasificacion" href="af_listaclasificacionactivo.php?filtrar=default&limit=0&campo=17&ventana=insertarClasificacionActivo&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe2]" style="visibility:hidden">
...
<td class='gallery clearfix'>
  ...
  <input type='text' name='fubicacion2' id='fubicacion2' value='$fubicacion2' $dUbicacion size='47'/>";?>
  <input type="hidden" name="btUbicacion" id="btUbicacion" value="..." onclick="cargarVentanaLista(this.form, 'af_listaubicacionesactivo.php?limit=0&campo=2','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dUbicacion?>/> 
...
<tr>
  ...
  <td><input type='checkbox' id='checkDependencia' name='checkDependencia' value='1' $cDependencia onclick='enabledDependencia(this.form);'/>
      <select id='fDependencia' name='fDependencia' $dDependencia style='width:260px;'>
	     <option value=''></option>";
  ...
  <td class='gallery clearfix'>
	  ...
	  <input type='text' id='fClasificacionPub20' name='fClasificacionPub20' value='$fClasificacionPub20' size='47' $dClasficacionPub20><input type='hidden' id='fCodclasficacionPub20' name='fCodclasficacionPub20' value='$fCodclasficacionPub20'/>";?><input type='hidden' id='btClasifPub20' name='btClasifPub20' value='...' onclick="cargarVentanaLista(this.form,'af_listaclasificacionPub20.php?limit=0&campo=2&ventana=insertarClasificacionPub20','height=500, width=800, left=200, top=100, resizable=yes');" <?=$dClasficacionPub20?> /> 
...
<tr>
  ...
  <td class='gallery clearfix'>
	...
	<input type='text' id='centro_costos2' value='$centro_costos2' name='centro_costos2' $dCosto size='47'/>";?> 
    <input type='hidden' id='btcosto' name='btcosto' value='...' onclick="cargarVentanaLista(this.form,'af_listacentroscostos.php?limit=0&campo=9','height=500,width=800,left=200,top=100,resizable=yes');"  <?=$dCosto?> /> 
    <a id="c_costo" style="visibility:hidden" href="af_listacentroscostos.php?filtrar=default&limit=0&campo=9&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe5]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
    </a>
	 <?  echo"</td>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarInventxDepUsuarioResp(this.form);'></center>
<br /><div style='width:900;' class='divDivision'>Inventario por Dependencias</div>
<form/><br />";
?>
...
<center>
<iframe name="af_rpinventxdepusuarioresppdf" id="af_rpinventxdepusuarioresppdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
