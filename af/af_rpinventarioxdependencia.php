...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Reporte | Inventario X Dependencia</td>
  <td align="right">
...
?>
<? echo"
<form name='frmentrada' action='af_rpinventarioxdependencia.php?limit=0' method='POST'>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarInventarioxDependencia(this.form);'></center>
...
<center>
<iframe name="af_rpinventarioxdependenciapdf" id="af_rpinventarioxdependenciapdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
