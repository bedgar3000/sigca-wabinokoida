...
function Header(){
	...
	$this->SetFont('Arial', 'B', 9);
	$this->Cell(240, 3, utf8_decode('Adiciones x Voucher'), 0, 1, 'C');$this->Ln(4);
	...
	$this->SetWidths(array(20,20,75,20,20,45,20,45));
	$this->SetAligns(array('C','C','C','C','C','C','C','C'));
	$this->Row(array('Cuenta', 'Activo',utf8_decode('Descripcion'), utf8_decode('Cód. Barras'), utf8_decode('Fecha Adquisición'), utf8_decode('Inicio Depreciación'), 'Monto Local'));
	//$this->SetFillColor(255, 255, 255);
...
if($r_con_01!=0)
   for($i=0; $i<$r_con_01; $i++){
	...
	$pdf->SetFont('Arial','B','8'); $pdf->Cell(20,4,$f_con_01['PeriodoIngreso'],0,1,'C');
