...
function Header(){
	...
	global $Periodo, $filtro, $recib_conf_cargo, $recib_conf_nombre, $firmas, $forganismo, $nivel_cabecera, $nomb_cabecera, $cargo_cabecera;
	...
	//$this->SetXY(180, 10);$this->Cell(11,5,'Fecha: ',0,0,'L');$this->Cell(10,5,"04/09/2017",0,1,'');
    ...
    if($firmas=='1'){
      ...
      $fa= mysql_fetch_array($qa);
			...
			list($nomb_cabecera, $cargo_cabecera, $nivel_cabecera) = getFirmaxDependencia2($field['CodDependencia']);
	...
	/*list($nombreCompleto02, $cargo02, $nivel02) = getFirmaxDependencia($field['CodDependencia']);

	$this->SetFont('Arial', '', 8);
	$this->SetXY(10,22);$this->Cell(19, 3, 'Dependencia:', 0, 0, 'L');$this->Cell(3, 3, $fcon01['Dependencia'], 0,1, 'L');
	$this->SetXY(10,25);$this->Cell(19, 3, 'Responsable:', 0, 0, 'L');$this->Cell(3, 3, $nombreCompleto02, 0, 1, 'L');
	$this->SetXY(10,28);$this->Cell(19, 3, 'Cargo:', 0, 0, 'L');$this->Cell(3, 3, $cargo02, 0, 1, 'L'); $this->Ln(2);*/
...
if($ractivo!=0)
   for($i=0; $i<$ractivo; $i++){
	  ...
	  $pdf->SetWidths(array(16,100,50,35));
...
list($nombreCompleto, $cargo, $nivel) = getFirmaxDependencia2($_PARAMETRO['FIRMAINVENTARIODEP']);

list($nombreCompleto02, $cargo02, $nivel02) = getFirmaxDependencia2($CodDependencia);
