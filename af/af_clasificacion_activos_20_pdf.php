...
function Header(){
	...
	$this->Cell(200, 10, utf8_decode('CLASIFICACION PUBLICACION 20'), 0, 1, 'C');
	
	$this->SetDrawColor(0, 0, 0); $this->SetFillColor(200, 200, 200); $this->SetTextColor(0, 0, 0);
	$this->SetFont('Arial', 'B', 6);
	$this->Cell(20, 3, 'CODIGO', 1, 0, 'C', 1);
	$this->Cell(90, 3, 'DESCRIPCION', 1, 0, 'C', 1);
...
$sql = "select * from af_clasificacionactivo20 where CodClasificacion<>''";
...
if($row!=0)
   for($i=0; $i<$row; $i++){
	  ...
	  $pdf->SetWidths(array(20,90,20,30));
