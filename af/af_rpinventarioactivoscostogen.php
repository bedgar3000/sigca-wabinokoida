...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Reporte | Inventario Activos Costo General</td>
  <td align="right">
...
?>
<? echo"
<form name='frmentrada' action='af_rpinventarioactivoscostogen.php?limit=0' method='POST'>
...
<tr>
  <td align='right'>Centro Costo:</td>
	   <td class='gallery clearfix'><input type='checkbox' name='chekcCosto' id='checkCosto' value='1' $cCosto onclick='enabledCosto(this.form);'/>
		   ...
		   <input type='text' id='centro_costos2' value='$centro_costos2' name='centro_costos2' $dCosto size='56'/>";?><input type='hidden' id='btcosto' name='btcosto' value='...' onclick="cargarVentanaLista(this.form,'af_listacentroscostos.php?limit=0&campo=9','height=500,width=800,left=200,top=100,resizable=yes');"  <?=$dCosto?> /> <a id="c_costo" style="visibility:hidden" href="af_listacentroscostos.php?filtrar=default&limit=0&campo=9&iframe=true&width=70%&height=100%" rel="prettyPhoto[iframe5]">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;"/>
            </a>
	 <?  echo" </select></td>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='cargarInventarioActivosListaGen(this.form);'></center>
...
<center>
<iframe name="af_rpinventarioactivoscostogenpdf" id="af_rpinventarioactivoscostogenpdf" style="border:solid 1px #CDCDCD; width:900px; height:400px; visibility:false; display:false;" ></iframe>
</center>
<form/>
</body>
</html>
