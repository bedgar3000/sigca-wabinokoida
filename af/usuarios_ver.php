...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Usuarios | Ver Registro</td>
...
<table width="650" class="tblForm">
    ...
    <tr>
        ...
        <td><input name="clave" type="password" id="clave" size="35" maxlength="20" value="<?=$field['Clave']?>" readonly="readonly" /></td>
    </tr>
    <tr>
        <td class="tagForm">Confirmar Contrase&ntilde;a:</td>
        <td><input name="confirmar" type="password" id="confirmar" size="35" maxlength="20" value="<?=$field['Clave']?>" readonly="readonly" /></td>
    </tr>
    <tr>
    	<td class="tagForm"><input type="checkbox" name="flag" id="flag" value="S" <?=$checked?> disabled="disabled" /></td>
        <td>Forzar Expiración de la Contrase&ntilde;a</td>
	</tr>
    <tr>
        <td class="tagForm">Fecha Expiraci&oacute;n:</td>
        <td><input name="fexpira" type="text" id="fexpira" size="15" maxlength="10" readonly value="<?=$fexpira?>" /></td>
    </tr>
    <tr>
