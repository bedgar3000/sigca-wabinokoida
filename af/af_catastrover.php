...
<table width="100%" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">Maestro Catastro | Ver Registro</td>
  <td align="right">
...
<?
  $scon = "select * from af_catastro where CodCatastro = '".$_GET['registro']."'";
...
<table width="700" class="tblForm">
  ...
  <tr>
   ...
   <tr>
	    ...
	    <td>
          <?
		   echo"<input type='hidden' id='radioEstado' name='radioEstado' value='".$fcon['Estado']."'/> "; 
           if($fcon['Estado']=='A'){
		     echo"<input name='status_catastro1' type='radio' checked='checked' disabled/> Activo";
			 echo"<input name='status_catastro2' type='radio' disabled/> Inactivo";
		   }else{
			 echo"<input name='status_catastro1' type='radio' disabled/> Activo";
			 echo"<input name='status_catastro2' type='radio' checked='checked' disabled/> Inactivo";
		   }
		  ?>
  ...
  <center>
    ...
    <input name="cancelar" type="button" id="cancelar" value="Cancelar" onClick="cargarPagina(this.form, 'af_catastro.php');" disabled/>
  </center><br />
  <!--////////////////////@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@///////////////////////////-->
</form>
...
<table width="700" class="tblBotones">
 <tr>
	<td align="right">
    	<input type="button" class="btLista" id="btInsertar" value="Insertar" onclick="insertarLinea();" disabled="disabled"/>
        <input name="btEliminar" type="button" class="btLista" id="btEliminar" value="Eliminar" onclick="quitarLinea(document.getElementById('seldetalle').value);"  disabled="disabled"/>
	</td>
 </tr>
</table>
...
<table width="100%" class="tblLista">
    ...
    <td>
		<input type="text" name="ano" id="ano" style="width:100%; text-align:center" value="<?=$f_catanual['Ano'];?>" readonly>
	</td>
    <td>
		<input type="text" name="precio_Oficial" id="precio_Oficial" style="width:100%; text-align:right" value="<?=$f_catanual['PrecioOficial'];?>" readonly>
	</td>
    <td>
		<input type="text" name="precio_Mercado" id="precio_Mercado" style="width:100%; text-align:right" value="<?=$f_catanual['PrecioMercado'];?>" readonly>
	</td>
    <td>
		<input type="text" name="fecha_Referencial" id="fecha_Referencial" style="width:100%; text-align:center" value="<?=$f_referencial?>" readonly>
	</td>
    </tr>
    <? }?>
    </tbody>
