...
list($_REVISADO['Nombre'], $_REVISADO['Cargo']) = getFirma($field['RevisadoPor']);
...
class PDF extends FPDF {
	...
	function Footer() {
		...
		$this->SetXY(10, 243); $this->MultiCell(48.75, 3, utf8_decode($_GENERADO['Nombre']), 0, 'L');
		$this->SetXY(58.75, 243); $this->MultiCell(48.75, 3, utf8_decode($_CONFORMADO['Nombre']), 0, 'L');
		$this->SetXY(107.5, 243); $this->MultiCell(48.75, 3, utf8_decode($_REVISADO['Nombre']), 0, 'L');
		$this->SetXY(156.25, 243); $this->MultiCell(48.75, 3, utf8_decode($_APROBADO['Nombre']), 0, 'L');
		##
		$this->SetXY(10, 250); $this->MultiCell(48.75, 3, utf8_decode($_GENERADO['Cargo']), 0, 'C');
		$this->SetXY(58.75, 250); $this->MultiCell(48.75, 3, utf8_decode($_CONFORMADO['Cargo']), 0, 'C');
		$this->SetXY(107.5, 250); $this->MultiCell(48.75, 3, utf8_decode($_REVISADO['Cargo']), 0, 'C');
		$this->SetXY(156.25, 250); $this->MultiCell(48.75, 3, utf8_decode($_APROBADO['Cargo']), 0, 'C');
	}
}
//---------------------------------------------------
