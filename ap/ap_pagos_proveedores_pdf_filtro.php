...
<form name="frmentrada" id="frmentrada" action="ap_pagos_proveedores_proceso2_pdf.php" method="post" target="iReporte">
    ...
    <tr>
        <td>
            ...
            <li id="li1" onclick="currentTab('tab', this);" class="current">
            	<a href="#" onclick="cargarPagina(document.getElementById('frmentrada'), 'ap_pagos_proveedores_proceso2_pdf.php'); mostrarTab('tab', 1, 2);">
