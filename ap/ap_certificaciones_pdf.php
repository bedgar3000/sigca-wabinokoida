...
include("lib/fphp.php");
//---------------------------------------------------
$CodUnidadEjecMax = getVar3("SELECT CodUnidadEjec FROM pv_categoriaprog WHERE CategoriaProg = '$_PARAMETRO[CATMAX]'");
$sql = "SELECT
			c.*,
			ppto.CategoriaProg,
...
class PDF extends FPDF {
	...
	function Header() {
		...
		if ($field['CodTipoCertif'] == '09') {
			...
			$this->SetY(25); $this->Cell(190, 5, utf8_decode('COMPROMISO PRESUPUESTARIO'), 0, 1, 'C');
			##	
			$this->SetY(35);
			$this->SetFont('Arial','B',10);
			$this->Cell(190, 5, utf8_decode('NRO. COMPROMISO'), 0, 1, 'C');
		}
	...
	function Footer() {
		...
		if ($field['CodTipoCertif'] == '09') {
			...
			$this->RoundedRect(13, 230, 190, 35, 2.5, 'D');
			$this->Line(13, 235, 203, 235);
			$this->Line(60.5, 230, 60.5, 265);
			$this->Line(108, 230, 108, 265);
			$this->Line(155.5, 230, 155.5, 265);
			##	
			$this->SetY(230);
			$this->SetFont('Arial','',7);
			$this->Cell(47.5, 5, utf8_decode('PREPARADO POR'), 0, 0, 'C');
			$this->Cell(47.5, 5, utf8_decode('AUTORIZADO POR'), 0, 0, 'C');
			$this->Cell(47.5, 5, utf8_decode('REVISADO POR'), 0, 0, 'C');
			$this->Cell(47.5, 5, utf8_decode('CONFORMADO POR'), 0, 0, 'C');
			##	
			$this->SetFont('Arial','B',7);
			$this->SetY(237);
			$this->SetX(13); $this->MultiCell(47.5, 3, utf8_decode($_PREPARADO['Nombre']), 0, 'C');
			$this->Ln(2);
			$this->SetX(13); $this->MultiCell(47.5, 3, utf8_decode($_PREPARADO['Cargo']), 0, 'C');
			$this->SetY(237);
			$this->SetX(60.5); $this->MultiCell(47.5, 3, utf8_decode($_AUTORIZADO['Nombre']), 0, 'C');
			$this->Ln(2);
			$this->SetX(60.5); $this->MultiCell(47.5, 3, utf8_decode($_AUTORIZADO['Cargo']), 0, 'C');
			$this->SetY(237);
			$this->SetX(108); $this->MultiCell(47.5, 3, utf8_decode($RevisadoPor), 0, 'C');
			$this->SetY(237);
			$this->SetX(155.5); $this->MultiCell(47.5, 3, utf8_decode($ConformadoPor), 0, 'C');
			##	
			$this->SetFont('Arial','',6);
			$this->SetXY(13,253); $this->Cell(47.5, 3, utf8_decode('Firma:'), 0, 0, 'L');
			$this->SetXY(13,260); $this->Cell(47.5, 3, utf8_decode('Fecha:'), 0, 0, 'L');
			$this->SetXY(60.5,253); $this->Cell(47.5, 3, utf8_decode('Firma:'), 0, 0, 'L');
			$this->SetXY(60.5,260); $this->Cell(47.5, 3, utf8_decode('Fecha:'), 0, 0, 'L');
			$this->SetXY(108,253); $this->Cell(47.5, 3, utf8_decode('Firma:'), 0, 0, 'L');
			$this->SetXY(108,260); $this->Cell(47.5, 3, utf8_decode('Fecha:'), 0, 0, 'L');
			$this->SetXY(155.5,253); $this->Cell(47.5, 3, utf8_decode('Firma:'), 0, 0, 'L');
			$this->SetXY(155.5,260); $this->Cell(47.5, 3, utf8_decode('Fecha:'), 0, 0, 'L');
		}
	}
}
//---------------------------------------------------
