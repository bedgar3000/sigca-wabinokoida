...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=ap_voucher_pagos_lista" method="post" autocomplete="off">
...
<table width="1050" class="tblBotones">
	<tr>
		...
		<td align="right" class="gallery clearfix">
			...
			<input type="button" id="btGenerar" value="Generar" style="width:75px;" onclick="cargarOpcion2(this.form, '', 'FUNCTION', '', $('#sel_registros').val(), 'vouchers_abrir($(\'#sel_registros\').val(), \'ap_generar_vouchers_pagos_voucher\');');" />
