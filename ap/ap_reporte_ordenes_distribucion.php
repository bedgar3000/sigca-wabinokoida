...
<form name="frmentrada" id="frmentrada" action="ap_reporte_ordenes_distribucion_proveedor_pdf.php" method="post" autocomplete="off" target="iReporte">
	...
	<tr>
		...
		<td>
            ...
            <select name="fEstado" id="fEstado" style="width:123px;" disabled>
                <option value="">&nbsp;</option>
                <?=loadSelectValores("ESTADO-PAGADO", "", 0)?>
            </select>
        </td>
	</tr>
	<tr>
    ...
    <tr>
        <td>
            ...
            <li id="li1" onclick="currentTab('tab', this);" class="current">
            	<a href="#" onclick="cargarPagina(document.getElementById('frmentrada'), 'ap_reporte_ordenes_distribucion_proveedor_pdf.php'); mostrarTab('tab', 1, 2);">
                	Distribuci&oacute;n x Proveedores
                </a>
            </li>
            <li id="li2" onclick="currentTab('tab', this);">
            	<a href="#" onclick="cargarPagina(document.getElementById('frmentrada'), 'ap_reporte_ordenes_distribucion_pagadas_pdf.php'); mostrarTab('tab', 2, 2);">
