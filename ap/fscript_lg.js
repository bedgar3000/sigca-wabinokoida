...
function selPersonaCajaChica(id1, id2, id3, codpersona, nomcompleto, ndocumento) {
	opener.document.getElementById(id1).value = codpersona;	
	opener.document.getElementById(id2).value = nomcompleto;	
	opener.document.getElementById(id3).value = ndocumento;
	window.close();
}
...
function selListadoCajaChica(codorganismo, codpersona) {
	...
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			...
			opener.document.getElementById("codpagara").value = codpersona;
			opener.document.getElementById("nompagara").value = datos[0];
