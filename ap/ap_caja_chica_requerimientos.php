...
<table width="1050" class="tblBotones">
	<tr>
		...
		<td align="right">            
			<input type="button" id="btVer" value="Ver" style="width:75px; <?=$btVer?>" onclick="cargarOpcion2(this.form, 'gehen.php?anz=lg_requerimiento_form&opcion=ver&origen=ap_caja_chica_requerimientos', 'SELF', '', 'registro');" />
		</td>
	</tr>
</table>
	...
	$sql = "SELECT
			...
			FROM
				...
				INNER JOIN seguridad_alterna sa ON (r.CodDependencia = sa.CodDependencia AND
													...
													sa.FlagMostrar = 'S')
			WHERE r.FlagCajaChica = 'S' $filtro
