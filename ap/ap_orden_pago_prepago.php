...
<table width="100%" class="tblFiltro">
    <tr>
        ...
        <td>
        	<input type="text" id="FechaPago" value="<?=formatFechaDMA($field_orden['FechaOrdenPago'])?>" style="width:60px;" class="datepicker codigo" />
		</td>
        <td align="right">
...
<table width="2200" class="tblLista">
	...
	<tr class="trListaBody">
        <td width="200"><?=htmlentities($field_orden['TipoPago'])?></td>
