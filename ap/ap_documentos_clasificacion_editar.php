...
<table width="700" class="tblForm">
	...
	<tr>
		<td>&nbsp;</td>
		<td>
        	<?php if ($field['FlagItem'] == "S") $flagitem = "checked"; ?>
	...
	<tr>
		<td>&nbsp;</td>
		<td>
        	<?php if ($field['FlagCliente'] == "S") $flagcliente = "checked"; ?>
	...
	<tr>
		<td>&nbsp;</td>
		<td>
        	<?php if ($field['FlagCompromiso'] == "S") $flagcompromiso = "checked"; ?>
	...
	<tr>
		<td>&nbsp;</td>
		<td>
        	<?php if ($field['FlagTransaccion'] == "S") { $flagtransaccion = "checked"; $dtransaccion = "disabled"; } ?>
