...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=ap_voucher_provisionpub20_lista" method="post" autocomplete="off">
...
<table width="1050" class="tblFiltro">
	...
	<tr>
		...
		<td class="gallery clearfix">
			...
			<input type="text" name="fNomProveedor" id="fNomProveedor" style="width:270px;" class="disabled" value="<?=$fNomProveedor?>" readonly="readonly" />
...
<table width="1050" class="tblBotones">
	<tr>
		...
		<td align="right" class="gallery clearfix">
			...
			<input type="button" id="btGenerar" value="Generar" style="width:75px;" onclick="cargarOpcion2(this.form, '', 'FUNCTION', '', $('#sel_registros').val(), 'vouchers_abrir($(\'#sel_registros\').val(), \'ap_generar_vouchers_provision_voucher_pub20\');');" />
...
<table width="1100" class="tblLista">
	...
	$sql = "SELECT
			...
			WHERE
				(o.Estado = 'RV' OR o.Estado = 'AP' OR o.Estado = 'PA') AND
				o.FlagContPendientePub20 = 'S' AND
				td.FlagProvision = 'S'
				$filtro";
