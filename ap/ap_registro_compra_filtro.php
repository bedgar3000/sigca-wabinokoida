...
<table width="1000" class="tblFiltro">
    ...
    <tr>
        ...
        <td class="gallery clearfix">
            ...
            <input type="text" name="fNomProveedor" id="fNomProveedor" style="width:247px;" readonly />
    ...
    <tr>
        ...
        <td>
            ...
            <select name="fCodBanco" id="fCodBanco" style="width:150px;" disabled onChange="getOptionsSelect(this.value, 'cuentas_bancarias', 'fNroCuenta', true)">
                <option value="">&nbsp;</option>
        ...
        <td>
            <input type="checkbox" checked onclick="this.checked=!this.checked" />
            <select name="fEstado" id="fEstado" style="width:145px;">
                <?=loadSelectValores("estado-retencion-filtro", $fEstado, 0)?>
            </select>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <select name="fNroCuenta" id="fNroCuenta" style="width:150px;" disabled>
                <option value="">&nbsp;</option>
