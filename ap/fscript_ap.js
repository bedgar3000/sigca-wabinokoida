...
function agregarDistribucionCajaChica() {
	...
	if (sel == "") alert("¡ERROR: Debe seleccionar una linea!");
		...
		else window.open('_ap_caja_chica_distribucion.php?concepto='+concepto+'&codigo='+codigo+'&periodo='+periodo+'&flagcajachica='+flagcajachica+'&nro='+nro+'&distribucion='+distribucion+'&codccosto='+codccosto+'&afecto='+afecto+'&noafecto='+noafecto, 'wCajaChica', 'height=400, width=900, left=200, top=100, resizable=no');
	}
}
//	
