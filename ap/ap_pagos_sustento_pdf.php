...
connect();
$_CONFORMESE = $_PARAMETRO["FIRMAOP1"];
$_PAGUESE = $_PARAMETRO["FIRMAOP2"];
$_REVISADO = $_PARAMETRO["FIRMAOP3"];
...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->SetFont('Arial', '', 8);
		$this->Cell(175, 5, $field['NomProveedorPagar'], 0, 0, 'L');
		$this->Ln(5);
		$this->SetFont('Arial', 'B', 8);
		...
		$this->SetFont('Arial', '', 8);
		$this->Cell(105, 5, $field['Banco'], 0, 0, 'L');
		$this->SetFont('Arial', 'B', 8);
		...
		$this->SetFont('Arial', '', 8);
		$this->MultiCell(175, 5, $field['Comentarios'], 0, 'L');
		$this->Ln(3);
	}
	//	Pie de página.
	function Footer() {
		...
		$y = 250;
		$this->Rect(75, $y, 50, 0.1, "FD");
		$this->Rect(150, $y, 50, 0.1, "FD");
		##
		$this->SetXY(75, $y); $this->Cell(50, 5, utf8_decode('Emitido Por'), 0, 0, 'C');
		$this->SetXY(150, $y); $this->Cell(50, 5, utf8_decode('Aprobado Por'), 0, 0, 'C');
		*/
	}
}
//---------------------------------------------------
