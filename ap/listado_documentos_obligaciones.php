...
<table width="1500" class="tblLista">
	...
	while ($field_ap = mysql_fetch_array($query_ap)) {
		...
		<tr class="trListaBody" id="<?=$idoc?>">
			...
			<td ondblclick="insertarDocumento('<?=$iddoc?>');"><?=htmlentities($field_ap['Comentarios'])?></td>
			<td align="center">
			...
			<td ondblclick="insertarDocumento('<?=$iddoc?>');"><?=htmlentities($field_ap['NomAlmacen'])?></td>
			<td ondblclick="insertarDocumento('<?=$iddoc?>');"><?=htmlentities($field_ap['NomAlmacenIngreso'])?></td>
			<td align="center" ondblclick="insertarDocumento('<?=$iddoc?>');"><?=htmlentities($field_ap['NomFormaPago'])?></td>
			<td align="center" ondblclick="insertarDocumento('<?=$iddoc?>');"><?=htmlentities($estado_ap)?></td>
		</tr>
		<?php
	}
	?>
	...
	while ($field_ap = mysql_fetch_array($query_ap)) {
		...
		if ($pendiente_real > 0) {
			...
			<tr class="trListaBody" id="<?=$idoc?>">
				...
				<td ondblclick="insertarDocumento('<?=$iddoc?>');"><?=htmlentities($field_ap['Observaciones'])?></td>
				<td align="center">
...
<table width="1500" class="tblLista">
	...
	while ($field_ap = mysql_fetch_array($query_ap)) {
		...
		<tr class="trListaBody" id="<?=$idoc?>">
			<td align="center" ondblclick="insertarDocumento('<?=$iddoc?>');"><?=$field_ap['NroOrden']?></td>
			<td align="center" ondblclick="insertarDocumento('<?=$iddoc?>');"><?=formatFechaDMA($field_ap['FechaPreparacion'])?></td>
			<td ondblclick="insertarDocumento('<?=$iddoc?>');"><?=htmlentities($field_ap['Descripcion'])?></td>
			<td align="center">
