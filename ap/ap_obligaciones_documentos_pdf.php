...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Cell(75, 5, $field['NroCuenta'].' '.$field['Descripcion'], 0, 1, 'L');
...
if ($ffechad != "" || $ffechah != "") {
	if ($ffechad != "") $filtro .= " AND p.FechaPago >= '".formatFechaAMD($ffechad)."'";
	if ($ffechah != "") $filtro .= " AND p.FechaPago <= '".formatFechaAMD($ffechah)."'";
}
