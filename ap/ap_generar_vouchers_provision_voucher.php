...
?>
<form name="frmentrada" id="frmentrada" method="POST" onsubmit="return vouchers(this, 'provision', 'li1');">
    	...
    	<td colspan="2">
            <table width="960" class="tblForm">
                ...
                <tr>
                    ...
                    <td><input type="text" id="FechaVoucher" value="<?=formatFechaDMA($field_mast['FechaRevision'])?>" style="width:75px;" class="datepicker" onchange="setPeriodo(this.value);" /></td>
                ...
                <tr>
                    ...
                    <td>
						<input type="text" id="Periodo" value="<?=substr($field_mast['FechaRevision'], 0, 7)?>" style="width:50px;" disabled />
            ...
            <table width="960" class="tblBotones">
                <tr>
                    <td align="right">
                        ...
                        <input type="button" class="btLista" value="Rechazar" onclick="cerrarVoucher('li1');" />
                    </td>
                </tr>
            </table>
