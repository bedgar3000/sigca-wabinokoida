...
<form name="frmentrada" id="frmentrada" action="listado_clasificacion_activospub20.php?" method="post">
...
<table width="100%" class="tblLista">
	<thead>
    <tr>
        <th scope="col" width="75" onclick="order('CodClasificacion')">C&oacute;digo</th>
