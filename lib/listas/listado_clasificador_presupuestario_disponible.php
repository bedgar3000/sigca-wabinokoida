...
<table width="1500" class="tblLista">
	...
	$sql = "SELECT p.cod_partida
			FROM
				...
				INNER JOIN pv_presupuesto pv ON (pv.CodOrganismo = pvd.CodOrganismo AND
												 pv.CodPresupuesto = pvd.CodPresupuesto)
			...
			WHERE
				pvd.CodOrganismo = '".$CodOrganismo."' AND
				pvd.CodPresupuesto = '".$CodPresupuesto."' AND
				pvd.CodFuente = '".$CodFuente."'
				$filtro";
