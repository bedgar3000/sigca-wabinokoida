...
//	------------------------------------
include("../fphp.php");
if (!isset($_SESSION['USUARIO_ACTUAL']) || !isset($_SESSION['ORGANISMO_ACTUAL'])) header("Location: ".$_PARAMETRO["PATHSIA"]);
//	------------------------------------
?>
...
<script type="text/javascript" language="javascript">
	...
	$(document).ready(function() {
		...
		if ($('.tblBotones').length) var height = heightWindow - heightFiltro - 95;
		else var height = heightWindow - heightFiltro - 80;
