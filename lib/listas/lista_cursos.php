...
//	------------------------------------
?>
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=lista_cursos" method="post">
...
<table class="tblLista" style="width:100%; min-width:800px;">
	...
	foreach($field as $f) {
		?>
        <tr class="trListaBody" onClick="<?=$ventana?>(['<?=$f['CodCurso']?>','<?=$f['Descripcion']?>'], ['<?=$campo1?>','<?=$campo2?>']);">
