...
//	------------------------------------
?>
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=lista_at_linea" method="post">
...
<center>
<div style="overflow:scroll; height:225px; width:100%; min-width:<?=$_width?>px;">
<table class="tblLista" style="width:100%; min-width:800px;">
	<thead>
    <tr>
        <th scope="col" width="75" onclick="order('CodLinea')">C&oacute;digo</th>
	...
	foreach($field as $f) {
		?>
        <tr class="trListaBody" onClick="<?=$ventana?>(['<?=$f['CodLinea']?>','<?=$f['Descripcion']?>'], ['<?=$campo1?>','<?=$campo2?>']);">
