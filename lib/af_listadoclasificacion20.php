...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Listado Plan Cuentas Publicaci&oacute;n 20</td>
		<td align="right"></td>
        <!--<td align="right"><a class="cerrar"; href="javascript:parent.$.prettyPhoto.close();">[Cerrar]</a></td>-->
	</tr>
</table><hr width="750" color="#333333" />
...
if ($_POST['filtro']!="") $sql="SELECT * FROM ac_mastplancuenta20 WHERE (CodCuenta LIKE '%".$_POST['filtro']."%' OR Descripcion LIKE '%".$_POST['filtro']."%')";
else $sql="SELECT * FROM ac_mastplancuenta20 where CodCuenta like '$fBienes%'";
...
<table width="750" class="tblBotones" align="center">
	<tr>
...
<?php echo"<input type='hidden' name='campo' id='campo' value='".$campo."'/>
...
<thead>
	...
	if ($registros!=0) {
		...
		else $sql="SELECT * FROM ac_mastplancuenta20 where CodCuenta like '$fBienes%' ORDER BY CodCuenta LIMIT ".$_GET['limit'].", $MAXLIMIT";
		$query=mysql_query($sql) or die ($sql.mysql_error());
