...
case "PLAN-CUENTAS":
	...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "UPDATE ac_mastplancuenta SET Descripcion = '".utf8_decode($descripcion)."',
												FlagTipo = '".$tipo."',
...
case "GRUPOS-CENTROS-COSTOS":
	...
	if ($accion == "GUARDAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ac_grupocentrocosto WHERE CodGrupoCentroCosto = '".$codigo."' OR Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($accion == "ACTUALIZAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ac_grupocentrocosto WHERE CodGrupoCentroCosto <> '".$codigo."' AND Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡REGISTRO YA INGRESADO!");
		else {
			$sql = "UPDATE ac_grupocentrocosto SET Descripcion = '".utf8_decode($descripcion)."',
													Estado = '".$status."',
													UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
													UltimaFecha = '$ahora'
												WHERE
...
case "SUBGRUPOS-CENTROS-COSTOS":
	...
	if ($accion == "INSERTAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ac_subgrupocentrocosto WHERE CodGrupoCentroCosto = '".$codgrupo."' AND (CodSubGrupoCentroCosto = '".$codsubgrupo."' OR Descripcion = '".utf8_decode($nomsubgrupo)."')";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡REGISTRO YA INGRESADO!");
		else {
	...
	elseif ($accion == "ACTUALIZAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ac_subgrupocentrocosto WHERE CodGrupoCentroCosto = '".$codgrupo."' AND CodSubGrupoCentroCosto <> '".$codsubgrupo."' AND Descripcion = '".utf8_decode($nomsubgrupo)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡REGISTRO YA INGRESADO!");
		else {
			$sql = "UPDATE ac_subgrupocentrocosto SET Descripcion = '".utf8_decode($nomsubgrupo)."',
														Estado = '".$edosubgrupo."',
														UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
														UltimaFecha = '$ahora'
													WHERE
...
case "CENTROS-COSTOS":
	...
	if ($accion == "GUARDAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ac_mastcentrocosto WHERE CodCentroCosto = '".$codigo."' OR Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($accion == "ACTUALIZAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ac_mastcentrocosto WHERE CodCentroCosto <> '".$codigo."' AND Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡CENTRO DE COSTO YA INGRESADO!");
		else {
...
case "TIPOS-VOUCHER":
	...
	if ($accion == "GUARDAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ac_voucher WHERE Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($accion == "ACTUALIZAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ac_voucher WHERE CodVoucher <> '".$codigo."' AND Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡TIPO DE VOUCHER YA INGRESADO!");
		else {
			$sql = "UPDATE ac_voucher SET Descripcion = '".utf8_decode($descripcion)."',
...
case "REGIMEN-FISCAL":
	...
	if ($accion == "GUARDAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ap_regimenfiscal WHERE CodRegimenFiscal = '".$codigo."' OR Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($accion == "ACTUALIZAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ap_regimenfiscal WHERE CodRegimenFiscal <> '".$codigo."' AND Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡REGIMEN FISCAL YA INGRESADO!");
		else {
			$sql = "UPDATE ap_regimenfiscal SET Descripcion = '".utf8_decode($descripcion)."',
												  Estado = '".$status."',
												  UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												  UltimaFecha = '$ahora'
											WHERE
...
case "IMPUESTOS":
	...
	if ($accion == "GUARDAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM mastimpuestos WHERE CodImpuesto = '".$codigo."' OR Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($accion == "ACTUALIZAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM mastimpuestos WHERE CodImpuesto <> '".$codigo."' AND Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡IMPUESTO YA INGRESADO!");
		else {
			$sql = "UPDATE mastimpuestos  SET Descripcion = '".utf8_decode($descripcion)."',
...
case "TIPOS-DOCUMENTOS-CXP":
	...
	if ($accion == "GUARDAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ap_tipodocumento WHERE CodTipoDocumento = '".$codigo."' OR Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($accion == "ACTUALIZAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM ap_tipodocumento WHERE CodTipoDocumento <> '".$codigo."' AND Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡TIPO DE DOCUMENTO YA INGRESADO!");
		else {
			$sql = "UPDATE ap_tipodocumento SET Descripcion = '".utf8_decode($descripcion)."',
...
case "TIPOS-SERVICIO":
	...
	if ($accion == "GUARDAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM masttiposervicio WHERE CodTipoServicio = '".$codigo."' OR Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($accion == "ACTUALIZAR") {
		//	Verifico que no exista el codigo de la cuenta...
		$sql = "SELECT * FROM masttiposervicio WHERE CodTipoServicio <> '".$codigo."' AND Descripcion = '".utf8_decode($descripcion)."'";
		$query_codigo = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query_codigo) != 0) die("¡TIPO DE SERVICIO YA INGRESADO!");
		else {
			$sql = "UPDATE masttiposervicio SET Descripcion = '".utf8_decode($descripcion)."',
												CodRegimenFiscal = '".$regimen."',
												Estado = '".$status."',
												UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												UltimaFecha = '$ahora'
