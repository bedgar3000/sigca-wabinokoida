...
elseif ($modulo == "EVALUACIONDESEMPENIO") {
		...
		$sql = "INSERT INTO rh_evaluacionempleado 
				...
				VALUES
					('$forganismo', 
					 ...
					 '$secuencia', 
					 '$persona', 
					 '".utf8_decode($comempleado)."', 
					 '$codevaluador', 
					 '".utf8_decode($comevaluador)."', 
					 '$codsupervisor', 
					 '".utf8_decode($comsupervisor)."', 
					 '$fecha_evaluacion', 
					 '$desempenio', 
					 '$funcion', 
					 '$metas', 
				...
				$sql = "INSERT INTO rh_empleado_necesidad 
						...
						VALUES 
							('$forganismo',
							 ...
							 '$codevaluador',
							 '$secuencia_det',
							 '".utf8_decode($necesidad_det)."',
							 '".$prioridad_det."',
							 '".$codcurso_det."',
							 '".utf8_decode($objetivo_det)."', 
							 '".$_SESSION['USUARIO_ACTUAL']."', 
							 '$ahora')";
				$query_det = mysql_query($sql) or die ($sql.mysql_error());
			}
	...
	elseif ($accion == "ACTUALIZAR") {
		...
		$sql = "UPDATE rh_evaluacionempleado 
				SET 
					ComentarioPersona = '".utf8_decode($comempleado)."', 
					Evaluador = '$codevaluador', 
					ComentarioEvaluador = '".utf8_decode($comevaluador)."', 
					Supervisor = '$codsupervisor', 
					ComentarioSupervisor = '".utf8_decode($comsupervisor)."', 
