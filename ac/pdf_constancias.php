...
function Cabecera($pdf) {
	$pdf->AddPage();
	$pdf->Image('../imagenes/logos/logo.jpg', 40, 11, 20, 18);	
	$pdf->SetFont('Times', 'B', 12);
	$pdf->SetTextColor(50, 50, 50);
	$pdf->SetXY(20, 12); $pdf->Cell(180, 5, utf8_decode('República Bolivariana de Venezuela'), 0, 1, 'C');
	$pdf->SetXY(20, 17); $pdf->Cell(180, 5, utf8_decode($_SESSION["NOMBRE_ORGANISMO_ACTUAL"]), 0, 1, 'C');
