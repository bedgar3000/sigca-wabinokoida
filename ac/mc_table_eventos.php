...
function Header()
{
	...
	$this->SetXY(20, 10); $this->Cell(90, 5, utf8_decode($_SESSION["NOMBRE_ORGANISMO_ACTUAL"]), 0, 1, 'L');
	$this->SetXY(20, 15); $this->Cell(90, 5, utf8_decode('División de Recursos Humanos'), 0, 1, 'L');
