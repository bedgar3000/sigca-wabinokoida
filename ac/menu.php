...
["Procesos", , , , , , "0", , , , , ],
  ["|En Construcci&oacute;n", "xxx.php?concepto=02-0001&limit=0&filtrar=DEFAULT", , , , , , , , , , ],
...
["|Balances",,,,,,,,,,,],
 ["||Balance Detallado x Periodo","<?=$_PARAMETRO['PATHSIA']?>ac/rp_balances.php?concepto=04-0007&limit=0&filtrar=DEFAULT",,,,d['04-0007'],,,,,,],
 
 //["||Balance de Comprobación","<?=$_PARAMETRO['PATHSIA']?>ac/rp_balancecomprobacion_.php?concepto=04-0001&limit=0&filtrar=DEFAULT", , , ,d['04-0001'] , , , , , , ],
 //["||Movimiento Mensual","<?=$_PARAMETRO['PATHSIA']?>ac/rp_balancecomprobacionmovmensual.php?concepto=04-0006&limit=0&filtrar=DEFAULT", , , ,d['04-0006'] , , , , , , ],
 //["||Mensual - Saldo Actual","<?=$_PARAMETRO['PATHSIA']?>ac/rp_balancecomprobacionmensual.php?concepto=04-0005&limit=0&filtrar=DEFAULT", , , ,d['04-0005'] , , , , , , ],
 //["||Balance de Comprobación Sumas y Saldos","<?=$_PARAMETRO['PATHSIA']?>ac/rp_balancesumassaldos.php?concepto=04-0002&limit=0&filtrar=DEFAULT", , , ,d['04-0002'], , , , , , ],
  ["|Balance General","<?=$_PARAMETRO['PATHSIA']?>ac/rp_balancegeneral.php?concepto=04-0002&limit=0&filtrar=DEFAULT",,,,d['04-0002'],,,,,,],
  ["|Estado de Resultado","<?=$_PARAMETRO['PATHSIA']?>ac/rp_estadoresultado.php?concepto=04-0007&limit=0&filtrar=DEFAULT",,,,d['04-0007'],,,,,,],
  ...
  ["|Libro Mayor Anal&iacute;tico", "<?=$_PARAMETRO['PATHSIA']?>ac/rp_libromayoranalitico.php?concepto=04-0005&limit=0&filtrar=DEFAULT", , , , d['04-0005'], , , , , , ],
  ["|Libro Mayor General", "<?=$_PARAMETRO['PATHSIA']?>ac/rp_libromayorgeneral.php?concepto=04-0006&limit=0&filtrar=DEFAULT", , , , d['04-0006'], , , , , , ],
...
["Maestros", , , , , , "0", , , , , ],
 ["|Del Sistema SIA", , , , , , , , , , , ],
  ["||Propios del Sistema", , , , , , , , , , , ],
    ["|||Aplicaciones", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=aplicaciones_lista&filtrar=default&concepto=06-0002", , , , d['06-0002'], , , , , , ],
    ["|||Par&aacute;metros", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=parametros_lista&filtrar=default&concepto=06-0003", , , , d['06-0003'], , , , , , ],
  ["||Relacionados a Personas", , , , , , , , , , , ],
    ["|||Personas", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=personas_lista&filtrar=default&concepto=06-0001", , , , d['06-0001'], , , , , , ],
    ["|||Organismos", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=organismos_lista&filtrar=default&concepto=06-0026", , , , d['06-0026'], , , , , , ],
    ["|||Dependencias", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=dependencias_lista&filtrar=default&concepto=06-0027", , , , d['06-0027'], , , , , , ],
  ["||Relacionados a Contabilidad", , , , , , , , , , , ],
    ["|||Centros de Costos","<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=centro_costos_lista&filtrar=default&concepto=06-0012", , , , d['06-0012'], , , , , , ],
    ["|||Grupos de Centros de Costos","<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=grupo_centro_costos_lista&filtrar=default&concepto=06-0011", , , , d['06-0011'], , , , , , ],
    ["|||Plan de Cuentas", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=plan_cuentas_lista&filtrar=default&concepto=06-0010", , , , d['06-0010'], , , , , , ],
    ["|||Plan de Cuentas Pub. 20", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=plan_cuentas_pub20&filtrar=default&concepto=06-0028", , , , d['06-0028'], , , , , , ],
  ["||Relacionados a Presupuesto", , , , , , , , , , , ],
		["|||Tipos de Cuenta","<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=tipo_cuenta_lista&filtrar=default&concepto=06-0022", , , , d['06-0022'], , , , , , ],
		["|||Clasificador Presupuestario","<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=clasificador_presupuestario_lista&filtrar=default&concepto=06-0023", , , , d['06-0023'], , , , , , ],
  ["||Otros Maestros", , , , , , , , , , , ],
		["|||Paises", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=paises_lista&filtrar=default&concepto=06-0004", , , , d['06-0004'], , , , , , ],
		["|||Estados", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=estados_lista&filtrar=default&concepto=06-0005", , , , d['06-0005'], , , , , , ],
		["|||Municipios", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=municipios_lista&filtrar=default&concepto=06-0006", , , , d['06-0006'], , , , , , ],
		["|||Ciudades", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=ciudades_lista&filtrar=default&concepto=06-0007", , , , d['06-0007'], , , , , , ],
		["|||Tipos de Pago", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=tipos_pago_lista&filtrar=default&concepto=06-0008", , , , d['06-0008'], , , , , , ],
		["|||Bancos", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=bancos_lista&filtrar=default&concepto=06-0009", , , , d['06-0009'], , , , , , ],
		["|||Unidad Tributaria", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=unidad_tributaria_lista&filtrar=default&concepto=06-0029", , , , d['06-0029'], , , , , , ],
  ...
  ["|De Contabilidades", , , , , , , , , , , ],
     ...
     ["||Tipos de Voucher", "<?=$_PARAMETRO['PATHSIA']?>ap/tipos_voucher.php?concepto=06-0013", , , , d['06-0013'], , , , , , ],
  ["|Otros", , , , , , , , , , , ],
	 ...
	 ["||-",, , , , , , , , , , ],
	 ["||-",, , , , , , , , , , ],
	 ["||Miscel&aacute;neos", "<?=$_PARAMETRO["PATHSIA"]?>comunes/gehen.php?anz=miscelaneos_lista&filtrar=default&concepto=06-0014", , , , d['06-0014'], , , , , , ],
...
["Admin.", , , , , , "0", , , , , ],
  ...
  ["|Actualización de Balance", , , , , , , , , , , ],
   ["||Mayorizar","<?=$_PARAMETRO["PATHSIA"]?>ac/ac_voucher_mayorizar.php?limit=0&concepto=07-0006&filtrar=default&opcion=mayorizar", , , , d['07-0006'], , , , , , ],
   ["||Desmayorizar","<?=$_PARAMETRO["PATHSIA"]?>ac/ac_voucher_mayorizar.php?limit=0&concepto=07-0007&filtrar=default&opcion=desmayorizar", , , ,d['07-0007'] , , , , , , ],
  ["|Confirmación de Cierre Mensual","<?=$_PARAMETRO["PATHSIA"]?>ac/ac_confirmacion_cierre_mensual.php?concepto=07-0004&limit=0&filtrar=DEFAULT", , , ,d['07-0004'] , , , , , , ],
  ["|Cierre Anual", "<?=$_PARAMETRO["PATHSIA"]?>ac/gehen.php?anz=ac_cierre_anual_lista&filtrar=default&concepto=07-0005", , , , d['07-0005'], , , , , , ],
