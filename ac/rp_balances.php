...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Balance Detallado X Per&iacute;odo</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' action='rp_balancexperiodopdf.php' method='POST' target='iReporte'>
...
<tr>
  ...
  <li><a onClick="rp_balances('frmentrada','balancexperiodo');" href="#">Balance</a></li>
