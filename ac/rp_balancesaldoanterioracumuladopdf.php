...
function Header(){
	...
	if(($fd!='')and($fh!='')and($fd!='0000-00')and($fh!='9999-99')){					   
		...
		$this->SetFont('Arial', '', 10);
		$this->Cell(115, 5, utf8_decode('Saldo Anterior Acumulado'), 0, 1, 'R'); ///$this->Cell(25, 5, 'AL   '.date("Y-m"), 0, 1, 'C'); 
		$this->Ln(2);
	}
	//echo $fmes;					   
	/*$this->SetFont('Arial', 'B', 10);
...
if($fmes =='12') 
  ...
  //$saldoDebeAnterior = $saldoDebeAnterior + $saldo_anterior_debe;
  //$saldoHaberAnterior = $saldoHaberAnterior + $saldo_anterior_haber;
...
////------------------------------------------------------------------------ */
  ...
  //echo "saldo_anterior_debe= ".$saldoDebeAnterior;
//echo "saldo_anterior_haber= ".$saldoHaberAnterior;
