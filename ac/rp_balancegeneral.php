...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_balancegeneralpub20pdf.php'  target='iReporte'>
...
<tr>
  <td>
    ...
    <li><a onClick="rp_balanceGeneral('frmentrada','publicacion20');" href="#">Publicaci&oacute;n 20</a></li>
	  <li><a onClick="rp_balanceGeneral('frmentrada','publicacionOnco');" href="#">Publicaci&oacute;n Onco</a></li>
