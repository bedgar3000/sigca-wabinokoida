...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Libro Mayor Anal&iacute;tico</td>
...
if(!$_POST){ $fPeriodoDesde = date("Y-m"); $fPeriodoHasta = $fPeriodoDesde;}
$MAXLIMIT=30;
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_libromayoranaliticopdf.php'  target='reporte'>
...
<tr>
 ...
 <td align='right'>Per&iacute;odo:</td>
  <td align='left'>
    <input type='checkbox' name='chkPeriodo' id='chkPeriodo' value='1' $cPeriodo onclick='this.checked=true'/>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroReporteLibroMayorAnalitico(this.form, 0);'></center>
