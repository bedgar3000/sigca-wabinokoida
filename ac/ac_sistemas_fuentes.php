...
<table width="950" class="tblBotones">
	<tr>
		...
		<td align="right">
			...
			<input type="button" class="btLista" id="btVer" value="Ver" onclick="cargarOpcion(this.form, 'ac_sistemas_fuentes_ver.php', 'BLANK', 'height=200, width=520, left=300, top=200, resizable=no');" />
