...
<table width="500" class="tblForm">
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="5" maxlength="1" value="<?=$field['cod_tipocuenta']?>" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Descripci&oacute;n:</td>
		<td><input name="descripcion" type="text" id="descripcion" size="25" maxlength="8" value="<?=htmlentities($field['descp_tipocuenta'])?>" />*</td>
	</tr>
	<tr>
