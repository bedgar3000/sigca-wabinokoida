...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Libro Diario</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_librodiariopdf.php'  target='reporte'>
...
<tr>
  ...
  <td><input type='checkbox' id='chkVoucher' name='chkVoucher' value='1' $cVoucher onclick='enabledRPVoucher(this.form);'/>
      <input type='text' id='fVoucher' name='fVoucher' size='6' maxlength='4' value='$fVoucher' $dVoucher/></td>
</tr>

<tr><td height='2'></td></tr>
</table>
</div>
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroReporteLibroDiario(this.form, 0);'></center>
