...
class PDF extends FPDF {
	//	Cabecera de página
	function Header() {
		$this->Image('../imagenes/logos/logo.jpg', 60, 10, 10, 10);
		$this->Image('../imagenes/logos/logo.jpg', 145, 10, 10, 10);
		$this->SetFont('Arial', 'B', 8);
		$this->Cell(190, 5,utf8_decode( $_SESSION["NOMBRE_ORGANISMO_ACTUAL"]), 0, 1, 'C');
		$this->Cell(190, 5, utf8_decode('División de Recursos Humanos'), 0, 1, 'C'); $this->Ln();
