...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Autorizaciones | Ver</td>
...
<table width="800" align="center">
	<tr>
    	<td><input type="checkbox" name="admin" id="admin" value="S" <?=$chkadmin?> disabled /> Administrador</td>
    </tr>
</table>
<table width="800" class="tblLista">
	...
	while($field=mysql_fetch_array($query)) {
		...
		<tr class='trListaBody'>
			<td align='center'><input type='checkbox' name='".$field['Concepto']."' id='".$field['Concepto']."' value='".$field['Concepto']."' onclick='checkPermisos(this.id, this.checked);' disabled $concepto /></td>
