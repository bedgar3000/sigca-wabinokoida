...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Balance Comprobaci&oacute;n Mensual - Saldo Actual</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_balancecomprobacionmensualpdf.php'  target='reporte'>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroReporteLibroDeComprobacionMensual(this.form, 0);'></center>
