...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Paises | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="paises.php" method="POST" onsubmit="return verificarPais(this, 'GUARDAR');">
...
<table width="700" class="tblForm">
  ...
  <tr>
    ...
    <td><input name="obs" type="text" id="obs" size="50" maxlength="100" /></td>
  </tr>
  <tr>
