...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Libro Mayor</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_libromayorpdf.php'  target='reporte'>
...
<tr>
  ...
  <td><input type='checkbox' id='chkCuenta' name='chkCuenta' value='1' $cCuenta onclick='enabledRPCuenta(this.form);'/>
      Desde <input type='text' id='fCuentaDesde' name='fCuentaDesde' size='15' maxlength='10' value='$fCuentaDesde' $dCuenta/>
	  Hasta <input type='text' id='fCuentaHasta' name='fCuentaHasta' size='15' maxlength='10' value='$fCuentaHasta' $dCuenta/></td>
</tr>

<tr><td height='1'></td></tr>
</table>
</div>
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroReporteLibroMayor(this.form, 0);'></center>
