...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Reporte | Balance Comprobaci&oacute;n Movimiento Mensual Cuentas del Mayor</td>
...
//// ------------------------------------------------------------------------------
echo "
<form name='frmentrada' id='frmentrada' method='POST' action='rp_balancecomprobacionmovmensualpdf.php'  target='reporte'>
...
<center><input type='submit' name='btBuscar' value='Buscar' onclick='filtroReporteLibroDeComprobacionMovMensual(this.form, 0);'></center>
