...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Centros de Costos | Modificar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="centros_costos.php" method="POST" onsubmit="return verificarCentrosCostos(this, 'ACTUALIZAR');">
...
<table width="700" class="tblForm">
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="8" maxlength="4" value="<?=$field['CodCentroCosto']?>" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Descripci&oacute;n:</td>
		<td><input name="descripcion" type="text" id="descripcion" style="width:80%;" maxlength="50" value="<?=htmlentities($field['Descripcion'])?>" />*</td>
	</tr>
	<tr>
...
<table width="700" class="tblForm">
	<tr>
		...
		<td>
			...
			?>
			<input type="checkbox" name="tipo_costo" id="flagadministrativo" <?=$flagadministrativo?> /> Administrativo <br />
			<input type="checkbox" name="tipo_costo" id="flagventas" <?=$flagventas?> /> Ventas <br />
			<input type="checkbox" name="tipo_costo" id="flagfinanciero" <?=$flagfinanciero?> /> Financiero <br />
			<input type="checkbox" name="tipo_costo" id="flagproduccion" <?=$flagproduccion?> /> Producci&oacute;n <br />
			<input type="checkbox" name="tipo_costo" id="flagcentroingreso" <?=$flagcentroingreso?> /> Centro de Ingresos
