...
function Header(){
	...
	$this->SetXY(19, 20); $this->Cell(150,5, '', 0, 0, 'L');
	                      $this->Cell(7,5,utf8_decode('Año:'),0,0,'L');
	...
	$this->Cell(32, 5,'SALDO ANTERIOR', 1, 0, 'C');
	$this->Cell(32, 5,'MOVIMIENTO DEL MES', 1, 0, 'C');
	$this->Cell(32, 5,'SUMAS ACUMULADAS', 1, 0, 'C');
	$this->Cell(32, 5,'SALDO ACTUAL', 1, 1, 'C');
...
if($cont_cuenta==1){
	...
	$pdf->Cell(50,4,utf8_decode(substr($f_cuenta['Descripcion'],0,40)),0,0,'L'); 
	$pdf->Cell(16,4,number_format($saldo_anterior_debe_ag,2,',','.'),'','','R');
	$pdf->Cell(16,4,number_format(-1*$saldo_anterior_haber_ag,2,',','.'),'','','R');
	$pdf->Cell(16,4,number_format($mov_mes_debe_ag,2,',','.'),'','','R');
	$pdf->Cell(16,4,number_format(-1*$mov_mes_haber_ag,2,',','.'),'','','R');
	$pdf->Cell(16,4,number_format($mov_mes_debe_ag,2,',','.'),'','','R');
	$pdf->Cell(16,4,number_format(-1*$mov_mes_haber_ag,2,',','.'),'','','R');
	$pdf->Cell(16,4,number_format($saldo_actual_debe_ag,2,',','.'),0,0,'R');
	$pdf->Cell(16,4,number_format(-1*$saldo_actual_haber_ag,2,',','.'),0,1,'R');
...
////------------------------------------------------------------------------ */
   ...
   $pdf->Cell(50,4,utf8_decode(substr($field_a['Descripcion'],0,35)),0,0,'L'); 
   $pdf->Cell(16,4,number_format($saldo_anterior_debe,2,',','.'),'','','R');
   $pdf->Cell(16,4,number_format(-1*$saldo_anterior_haber,2,',','.'),'','','R');
   $pdf->Cell(16,4,number_format($mov_mes_debe,2,',','.'),'','','R');
   $pdf->Cell(16,4,number_format(-1*$mov_mes_haber,2,',','.'),'','','R');
   $pdf->Cell(16,4,number_format($sumas_acumuladas_detalle_debe,2,',','.'),'','','R');
   $pdf->Cell(16,4,number_format(-1*$sumas_acumuladas_detalle_haber,2,',','.'),'','','R');
   $pdf->Cell(16,4,number_format($saldo_actual_debe,2,',','.'),'',0,'R');
   $pdf->Cell(16,4,number_format(-1*$saldo_actual_haber,2,',','.'),'',1,'R'); 
...
$pdf->Cell(16, 4, number_format($total_saldo_anterior_debe, 2, ',', '.'), 1, 0, 'R');	
$pdf->Cell(16, 4, number_format((-1*$total_saldo_anterior_haber), 2, ',', '.'), 1, 0, 'R');
$pdf->Cell(16, 4, number_format($total_mov_mes_debe, 2, ',', '.'), 1, 0, 'R');
$pdf->Cell(16, 4, number_format((-1*$total_mov_mes_haber), 2, ',', '.'), 1, 0, 'R');  
$pdf->Cell(16, 4, number_format($total_sumas_acumuladas_debe, 2, ',', '.'), 1, 0, 'R');
$pdf->Cell(16, 4, number_format((-1*$total_sumas_acumuladas_haber), 2, ',', '.'), 1, 0, 'R');  
$pdf->Cell(16, 4, number_format($total_sueldo_actual_debe, 2, ',', '.'), 1, 0, 'R');
$pdf->Cell(16, 4, number_format((-1*$total_sueldo_actual_haber), 2, ',', '.'), 1, 0, 'R');
////------------------------------------------------------------------------ */
////------------------------------------------------------------------------ */
