...
<table width="800" class="tblForm">
	<tr>
		...
		<td><input name="apellido1" type="text" id="apellido1" size="25" maxlength="25" value="<?=$field[7] ?>" <?=$dbclase ?>  onkeyup="setBusquedaPersona(this.form);" />*</td>
		<td class="tagForm">Materno:</td>
		<td><input name="apellido2" type="text" id="apellido2" size="25" maxlength="25" value="<?=$field[8] ?>" <?=$dbclase ?>  onkeyup="setBusquedaPersona(this.form);" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Nombres:</td>
		<td><input name="nombres" type="text" id="nombres" size="40" maxlength="50" value="<?=$field[9] ?>" onkeyup="setBusquedaPersona(this.form);" <?=$dbclase ?> />*</td>
		...
		<td><input name="fnac" type="text" id="fnac" size="15" maxlength="10" value="<?=$fnac ?>" />*<em>(dd-mm-yyyy)</em></td>
	...
	<tr>
		...
		<td colspan="3"><input name="dir" type="text" id="dir" size="100" maxlength="70" value="<?=$field[13] ?>" />*</td>
	</tr>
	<tr>
		...
		<td>
			<select name="estado2" id="estado2" class="selectMed">
				<option value=""></option>
				<?php getEstados($field[15], $field[14], 0); ?>
			</select>*
		</td>
	</tr>
	<tr>
		...
		<td>
			<select name="municipio2" id="municipio2" class="selectMed">
				<option value=""></option>
				<?php getMunicipios($field[16], $field[15], 0); ?>
			</select>*
		</td>
		...
		<td>
			<select name="ciudad2" id="ciudad2" class="selectMed">
				<option value=""></option>
				<?php getCiudades($field[17], $field[16], 0); ?>
			</select>*
		</td>
	</tr>
	<tr>
		<td class="tagForm">e-mail:</td>
		<td colspan="3"><input name="email" type="text" id="email" size="45" maxlength="30" value="<?=$field[18] ?>" /></td>
	</tr>
	<tr>
		<td class="tagForm">Nombre Emerg:</td>
		<td><input name="nomcon1" type="text" id="nomcon1" size="30" maxlength="30" value="<?=$field[19] ?>" <?=$dbclase ?> /></td>
		<td class="tagForm">Direcci&oacute;n Emerg.:</td>
		<td><input name="dircon1" type="text" id="dircon1" size="50" maxlength="50" value="<?=$field[20] ?>" <?=$dbclase ?> /></td>
	</tr>	
</table>
<table width="800" class="tblForm">
	<tr>
		<td class="tagForm">Tel&eacute;fono:</td>
		<td><input name="tel1" type="text" id="tel1" size="25" maxlength="20" value="<?=$field[21] ?>" /></td>
		<td class="tagForm">Celular:</td>
		<td><input name="tel2" type="text" id="tel2" size="25" maxlength="20" value="<?=$field[22] ?>" /></td>
		<td class="tagForm">Fax:</td>
		<td><input name="tel3" type="text" id="tel3" size="25" maxlength="20" value="<?=$field[23] ?>" /></td>
	</tr>
</table>
	...
	<tr>
		...
		<td>
			<select name="tdoc" id="tdoc" class="selectMed">
				<option value=""></option>
				<?php getMiscelaneos($field[24], "DOCUMENTOS", 0); ?>
			</select>*
		</td>
	</tr>
	<tr>
		<td class="tagForm">Nro. Documento:</td>
		<td><input name="ndoc" type="text" id="ndoc" size="20" maxlength="20" value="<?=$field[25] ?>" />*</td>
	</tr>
	<tr>
		<td class="tagForm">Doc. Fiscal:</td>
		<td><input name="rif" type="text" id="rif" size="20" maxlength="20" value="<?=$field[26] ?>" />*</td>
	</tr>
</table>
...
<table width="800" class="tblForm">
	...
	<tr>
		...
		<td><input name="ncta" type="text" id="ncta" size="50" maxlength="30" value="<?=$field1[1] ?>" />*</td>
	</tr>
	<tr>
