...
/////////////////////////***************************************///////////////////////////
/////////////////////////***************************************///////////////////////////
function totalAnteproyectos(rows, insert, update, del) {
	var numreg = document.getElementById("rows");
	numreg.innerHTML="Registros: "+rows;
	//
	var btNuevo=document.getElementById("btNuevo");
...
//	FUNCION PARA CARGAR UNA NUEVA PAGINA 
function cargarAnteproyecto(form, pagina) {
	form.method="GET";
	form.action=pagina;
	form.submit();
}
//	FUNCION PARA CARGAR UNA NUEVA PAGINA 
function actualizarAnteproyecto(form, pagina, target, param) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else{
		if (target=="SELF") cargarPagina(form, pagina);
		else { pagina=pagina+"?limit=0&accion=EDITAR&registro="+codigo; cargarVentana(form, pagina, param); }
	}
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////
////// ************** FUNCION PARA CARGAR UNA NUEVA PAGINA REVISAR ANTEPROYECTO  *********** /////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
function cargarRevisado2(form, pagina, param){
	form.method="POST";
	form.action=pagina;
	form.submit();
}
function cargarRevisado(form, pagina, target, param){
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		if (target=="SELF") cargarPagina(form, pagina);
		else { pagina=pagina+"?limit=0&accion=VER&registro="+codigo; cargarRevisado2(form, pagina, param); }
	}
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////
////// ************** FUNCION PARA CARGAR UNA NUEVA PAGINA APROBAR ANTEPROYECTO  *********** /////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
function cargarAprobar2(form, pagina, param){
	form.method="POST";
	form.action=pagina;
	form.submit();
}
function cargarAprobar(form, pagina, target, param){
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		if (target=="SELF") cargarPagina(form, pagina);
		else { pagina=pagina+"?limit=0&accion=VER&registro="+codigo; cargarAprobar2(form, pagina, param); }
	}
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////
function cargarGenerar2(form, pagina, param){
	form.method="POST";
	form.action=pagina;
	form.submit();
}
function cargarGenerar(form, pagina, target, param){
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		if (target=="SELF") cargarPagina(form, pagina);
		else { pagina=pagina+"?limit=0&accion=VER&registro="+codigo; cargarGenerar2(form, pagina, param); }
	}
}
...
////////////////	FUNCION PARA ELIMINAR UN REGISTRO DE PROGRAMA///////////////////
function eliminarRegistro1(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARPROG&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
////////////////	FUNCION PARA ELIMINAR UN REGISTRO DE SUB-PROGRAMA   ///////////////////
function eliminarRegistro2(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARSP&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
////////////////	FUNCION PARA ELIMINAR UN REGISTRO DE PROYECTO   ///////////////////
function eliminarRegistro3(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARPROY&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
////////////////	FUNCION PARA ELIMINAR UN REGISTRO DE ACTIVIDAD  ///////////////////
function eliminarRegistro4(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARACT&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
////////////////	FUNCION PARA ELIMINAR UN REGISTRO DE PARTIDA  ///////////////////
function eliminarRegistro5(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARPART&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
////////////////	FUNCION PARA ELIMINAR UN REGISTRO DE UNIDAD EJECUTORA  ///////////////////
function eliminarRegistro6(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARUNIDAD&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
////////////////	FUNCION PARA ELIMINAR UN REGISTRO DE PRESUPUESTO DETALLE  ///////////////////
function eliminarRegistro7(form, pagina, foraneo, modulo) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		...
		if (eliminar) {
			if (foraneo) {
				...
				ajax.open("POST", "fphp.php", true);
				ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
				ajax.send("modulo="+modulo+"&accion=ELIMINARANTEP&codigo="+codigo);
				ajax.onreadystatechange=function() {
					if (ajax.readyState==4)	{
						var error=ajax.responseText;
						if (error!=0) alert ("¡"+error+"!");
...
function esHora(hora) {
	...
	if (h<1 || h>24 || m<0 || m>59 || s<0 || s>59) esHora=false;
	return esHora;
}
...
function esDateTime(desde, hasta) {
	...
	else if ((fhmdesde[0]==fhmhasta[0]) && (fhmdesde[2]==fhmhasta[2]) && (fhmdesde[1]>fhmhasta[1])) esDateTime=false;
	else if ((fhmdesde[0]==fhmhasta[0]) && (fhmdesde[2]>fhmhasta[2])) esDateTime=false;
	return esDateTime;
}
...
//********************//	FUNCION PARA BLOQUEAR/DESBLOQUEAR  ANTEPROYECTO  //************************************//
    //*****************************************************************************************************//
	//*****************************************************************************************************//
...
function enabledNanteproyecto(form){
	if (form.chknanteproyecto.checked) form.fnanteproyecto.disabled=false; 
	else form.fnanteproyecto.disabled=true; 
}
function enabledEjercicio(form){
	if (form.chkejercicio.checked) form.fejercicio.disabled=false; 
	else form.fejercicio.disabled=true; 
}
//function enabledPreparado(form){
//	if (form.chkorganismo.checked && form.chkpreparado.checked) form.fpreparado.disabled=false; 
//	else { form.fpreparado.disabled=true; form.forganismo.value=""; }
//}
function enabledPreparado(form) {
	if (form.chkpreparado.checked) form.fpreparado.disabled=false; 
	else form.fpreparado.disabled=true; 
}
//*****************************************************************************************************//
//*****************************************************************************************************//
//*****************************************************************************************************//
...
function enabledEdoReg(form) {
	...
	else form.fedoreg.disabled=true;
}
//	FUNCION PARA BLOQUEAR/DESBLOQUEAR
...
function enabledBuscar(form) {
	...
	else { form.fbuscar.disabled=true; form.sltbuscar.disabled=true; }
}
//	FUNCION PARA BLOQUEAR/DESBLOQUEAR
function enabledTipoTra(form) {
	if (form.chktipotra.checked) form.ftipotra.disabled=false; 
	else form.ftipotra.disabled=true;
}
//	FUNCION PARA BLOQUEAR/DESBLOQUEAR
...
function enabledParentesco(form) {
	...
	else form.fparentesco.disabled=true;
}
//	FUNCION PARA BLOQUEAR/DESBLOQUEAR
...
//	FUNCION PARA SELECCIONAR UNA PERSONA DE UNA LISTA Y COLOCARLO EN OTRA VENTANA
function selListadoEvaluacion(busqueda, cargo, cod, nom, id, idvalor) {
	var registro=document.getElementById("registro").value;
	opener.document.getElementById(cod).value=registro;
	opener.document.getElementById(nom).value=busqueda;
	opener.document.getElementById(id).value=idvalor;
...
function getOptions_5(idSelectOrigen, idSelectDestino, idSelect3, idSelect4, idSelect5) {
	var selectOrigen=document.getElementById(idSelectOrigen);
	var optSelectOrigen=selectOrigen.options[selectOrigen.selectedIndex].value;
	var selectDestino=document.getElementById(idSelectDestino);
	nuevaOpcion=document.createElement("option");	nuevaOpcion.value="";	nuevaOpcion.innerHTML="";
	...
	if (optSelectOrigen=="") {
		...
		ajax.open("POST", "fphp_selects.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("accion=getOptions_5&tabla="+idSelectDestino+"&opcion="+optSelectOrigen);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==1) {
				// Mientras carga elimino la opcion "" y pongo una que dice "Cargando..."
				selectDestino.length=0;
...
function verificarAplicacion(form, accion) {
	...
	if (codigo=="" || descripcion=="") msjError(1010); 
		...
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=APLICACIONES&accion="+accion+"&codigo="+codigo+"&descripcion="+descripcion+"&periodo="+periodo+"&voucher="+voucher+"&status="+status);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
function verificarDependencia(form, accion) {
	...
	if (descripcion=="" || form.organismo.value=="") msjError(1010);
		...
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=DEPENDENCIAS&accion="+accion+"&codigo="+form.codigo.value+"&descripcion="+descripcion+"&organismo="+form.organismo.value+"&tel1="+form.tel1.value+"&tel2="+form.tel2.value+"&ext1="+form.ext1.value+"&ext2="+form.ext2.value);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
//	MAESTRO DE CARGOS
//  VERFIFICAR DATOS GENERALES DE PRESUPUESTO ///////
function verificarCargo(form, accion) {
	...
	if (form.status[0].checked) var status=form.status[0].value; else var status=form.status[1].value;
	//	VERIFICO QUE LOS CAMPOS OBLIGATORIOS NO ESTEN VACIOS
	if (descripcion=="" || serie=="" || nivelcargo=="" || ttra=="" || plantilla_competencias=="" || descripcion_generica=="") msjError(1010);
...
function verificarCargoReporta(form, cargo) {
	var cargoreporta=form.cargo.value;
	if (cargoreporta=="") msjError(1170);
	else {
		//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
		var ajax=nuevoAjax();
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=CARGOS&accion=CARGOREPORTA&cargo="+cargo+"&cargoreporta="+cargoreporta);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
//	FUNCION PARA VERIFICAR QUE SE INGRESARON LOS DATOS OBLIGATORIOS Y QUE EL REGISTRO NO EXISTA EN LA BASE DE DATOS
function verificarCargoFunciones(form, cargo) {
	var funciones=form.funciones.value;
	var status=form.status.value;
	var comentarios = new String (form.comentarios.value); comentarios=comentarios.trim(); form.comentarios.value=comentarios;
	if (funciones=="" || comentarios=="") msjError(1180);
	else {
		//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
		var ajax=nuevoAjax();
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=CARGOS&accion=CARGOFUNCION&cargo="+cargo+"&funciones="+funciones+"&status="+status+"&comentarios="+comentarios);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
				else location.href="cargos_funciones.php?registro="+cargo;
			}
		}
	}
	return false;
...
function verificarCargoExperiencia(form, cargo) {
	...
	if (area=="" || meses=="") msjError(1180);
	else {
		//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
		var ajax=nuevoAjax();
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=CARGOS&accion=CARGOEXPERIENCIA&cargo="+cargo+"&area="+area+"&meses="+meses+"&flag="+flag);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
function verificarCargoCurso(form, cargo) {
	...
	if (cursos=="" || horas=="" || anios=="") msjError(1180);
	else {
		//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
		var ajax=nuevoAjax();
		ajax.open("POST", "fphp.php", true);
...
function eliminarPartida(form, pagina) {
...
//	FUNCION PARA ELIMINAR REGISTROS DE PARTIDAS CARGADAS EN PRESUPUESTO_DETALLE
function eliminarPartidaAnte(form, pagina) {
	var secuencia = form.registro2.value;
	if (secuencia=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ELIMINAR
		var eliminar=confirm("¡Esta seguro de eliminar este registro?");
...
function filtroPDFEmpleados(form, limit) {
	...
	if (esFIngD && esFIngH) {
		if (form.chkbuscar.checked && form.sltbuscar.value=="") msjError(1130);
			...
			var pagina="pdf_empleados.php?filtro="+filtro;
			cargarPagina(form, pagina);
		}
	} else {
		form.ffingresod.value="";
...
function filtroListadoEmpleados(form, limit) {
	var edad=new String(form.fedad.value); edad=edad.trim();
	var filtro="mp.CodPersona<>**"; var ordenar="ORDER BY mp.CodPersona";
	if (form.chkedoreg.checked) filtro+=" AND mp.Estado LIKE *;"+form.fedoreg.value+";*";
	if (form.chkdependencia.checked) filtro+=" AND me.CodDependencia LIKE *;"+form.fdependencia.value+";*";
	if (form.chksittra.checked) filtro+=" AND me.Estado LIKE *;"+form.fsittra.value+";*";
	if (form.chktiponom.checked) filtro+=" AND me.CodTipoNom LIKE *;"+form.ftiponom.value+";*";
...
function verificarPersona(form, accion) {
	...
	if (form.status[0].checked) var status=form.status[0].value; else var status=form.status[1].value;
	if (cpersona=="N" && (apellido1=="" || apellido2=="" || nombres=="" || busqueda=="" || nom_completo=="" || dir=="" || ciudad2=="" || tdoc=="" || ndoc=="" || rif=="" || banco=="" || ncta=="" || tcta=="")) msjError(1010);
	else if (cpersona=="J" && (busqueda=="" || nom_completo=="" || dir=="" || ciudad2=="" || tdoc=="" || ndoc=="" || rif=="" || banco=="" || ncta=="" || tcta=="")) msjError(1010);
...
function verificarFamiliar(form, accion) {
	...
	//	VERIFICO QUE LOS CAMPOS OBLIGATORIOS NO ESTEN VACIOS
	if (parent=="" || apellidos=="" || nombres=="" || fnac=="" || tdoc=="" || ndoc=="") msjError(1010);
...
function verificarCEstudio(form, accion) {
	...
	if (descripcion=="") msjError(1010);
		...
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=CESTUDIO&accion="+accion+"&codigo="+form.codigo.value+"&descripcion="+descripcion+"&ubicacion="+ubicacion);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
function verificarEstudio(form, accion) {
	...
	if (grado=="" || codcentro=="") msjError(1010);
		...
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=ESTUDIO&accion="+accion+"&persona="+persona+"&secuencia="+secuencia+"&grado="+grado+"&nivel="+nivel+"&area="+area+"&profesion="+profesion+"&codcentro="+codcentro+"&fdesde="+fdesde+"&fhasta="+fhasta+"&colegiatura="+colegiatura+"&ncolegiatura="+ncolegiatura+"&observaciones="+observaciones);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
function verificarInstruccionCurso(form, accion) {
	...
	if (codcurso=="" || codcentro=="") msjError(1010);
		...
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=INSTRUCCION_CURSOS&accion="+accion+"&persona="+persona+"&secuencia="+secuencia+"&codcurso="+codcurso+"&codcentro="+codcentro+"&fdesde="+fdesde+"&fhasta="+fhasta+"&observaciones="+observaciones+"&horas="+horas+"&anios="+anios+"&tcurso="+tcurso+"&flag="+flag);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
function verificarMeritos(form, persona) {
	...
	var obs = new String (form.obs.value); obs=obs.trim();
	esFDoc=esFecha(fdoc);
	if (doc=="" || fdoc=="" || merito=="" || responsable=="") msjError(1010);
		...
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=MERITOS&accion=MERITOS&doc="+doc+"&fdoc="+fdoc+"&merito="+merito+"&responsable="+responsable+"&obs="+obs+"&tipo="+tipo+"&persona="+persona);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
function verificarDemeritos(form, persona) {
	...
	if (doc=="" || fdoc=="" || merito=="" || responsable=="") msjError(1010);
		...
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=MERITOS&accion=DEMERITOS&doc="+doc+"&fdoc="+fdoc+"&merito="+merito+"&responsable="+responsable+"&obs="+obs+"&tipo="+tipo+"&persona="+persona+"&fdesde="+fdesde+"&fhasta="+fhasta);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var error=ajax.responseText;
				if (error!=0) alert ("¡"+error+"!");
...
function verificarAprobarPermisos(form, accion, btAprobar) {
	...
	ajax.open("POST", "fphp.php", true);
	ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
	ajax.send("modulo=PERMISOS&accion="+accion+"&obsaprobado="+obsaprobado+"&remunerado="+remunerado+"&justificativo="+justificativo+"&codigo="+codigo+"&status="+status);
	ajax.onreadystatechange=function() {
		if (ajax.readyState==4)	{
			var error=ajax.responseText;
			if (error!=0) alert ("¡"+error+"!");
...
function anularPermiso(form) {
	...
	if (codigo=="") msjError(1000);
		...
		var anular=confirm("¡Esta seguro de anular este Anteproyecto?");
		if (anular) {
			//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
			var ajax=nuevoAjax();
			ajax.open("POST", "fphp.php", true);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////***********   ANULAR ANTEPROYECTO  *******/////////////////////////////////
function anularAnteproyecto(form) {
	var codigo=form.registro.value;
	//var filtro=form.filtro.value;   
	//var limit=form.limit.value;
	if (codigo=="") msjError(1000);
		...
		if (anular) {
			...
			ajax.open("POST", "fphp.php", true);
			ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			ajax.send("modulo=ESTADO&accion=ANULAR&codigo="+codigo);
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
					else cargarPagina(form, "listar_anteproyecto.php");
				}
			}
		}	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////***********   ANULAR ANTEPROYECTO  REVISADO *******/////////////////////////////////
function anularAnteproyectoRevisado(form) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		//	PREGUNTO SI DESEA ANULAR
		...
		if (anular) {
			...
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
					else cargarPagina(form, "anteproyecto_aprobar.php");
				}
			}
		}	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////***********   ANULAR ANTEPROYECTO  *******/////////////////////////////////
function anularRevisionAnteproyecto(form) {
	var codigo=form.registro.value;
	//var filtro=form.filtro.value;   
	//var limit=form.limit.value;
	if (codigo=="") msjError(1000);
		...
		if (anular) {
			...
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
					else cargarPagina(form, "anteproyecto_revisar.php");
				}
			}
		}	
	}
...
function revisarAnteproyecto(form) {
	var codigo=form.registro.value;
	//var filtro=form.filtro.value;   
	//var limit=form.limit.value;
	if (codigo=="") msjError(1000);
		...
		//	PREGUNTO SI DESEA ANULAR
		var anular=confirm("¡Esta seguro de asignar estado REVISADO a este Anteproyecto?");
		if (anular) {
			//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
			var ajax=nuevoAjax();
			ajax.open("POST", "fphp.php", true);
			ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			ajax.send("modulo=ESTADO&accion=REVISAR&codigo="+codigo);
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
...
function aprobarAnteproyecto(form) {
	var codigo=form.registro.value;
	var filtro=form.filtro.value;
	var limit=form.limit.value;
	if (codigo=="") msjError(1000);
		...
		//	PREGUNTO SI DESEA ANULAR
		var aprobar=confirm("¡Esta seguro de Aprobar este Anteproyecto?");
		if (aprobar) {
			//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
			var ajax=nuevoAjax();
			ajax.open("POST", "fphp.php", true);
			ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
			ajax.send("modulo=ESTADO&accion=APROBAR&codigo="+codigo);
			ajax.onreadystatechange=function() {
				if (ajax.readyState==4)	{
					var error=ajax.responseText;
					if (error!=0) alert ("¡"+error+"!");
					else cargarPagina(form, "anteproyecto_aprobar.php?filtro="+filtro+"&limit="+limit);
				}
			}
		}	
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
function abrirAnteproyecto(form) {
	var codigo=form.registro.value;
	if (codigo=="") msjError(1000);
	else {
		window.open("anteproyecto_imprimir.php?registro="+codigo, "", "toolbar=no, menubar=no, location=no, scrollbars=yes, height=800, width=800, left=200, top=200, resizable=yes");
	}
}
///////////// **************************************************************************  ///////////////////////
//	FUNCION PARA ENVIAR LOS ELEMENTOS DEL FILTRO DE PERMISOS
function filtroAnteproyecto(form, limit, pagina) {
	...
	if (form.chkorganismo.checked) filtro+=" AND pu_antepresupuesto.CodAnteproyecto LIKE *;"+form.forganismo.value+";*";
	if (form.chknanteproyecto.checked) filtro+=" AND pu_antepresupuesto.CodAnteproyecto LIKE *;"+form.fnanteproyecto.value+";*";
	if (form.chkstatus.checked) filtro+=" AND pu_antepresupuersto.Estado LIKE *"+form.fstatus.value+"*";
...
function verificarPatrimonioInmueble(form, persona) {
	...
	if (descripcion=="" || ubicacion=="" || uso=="" || valor=="") msjError(1010);	
...
function verificarPatrimonioInversion(form, persona) {
	...
	if (titular=="" || empresa=="" || certificado=="" || cant=="" || valor=="" || valorn=="") msjError(1010);
...
function verificarPatrimonioVehiculo(form, persona) {
	...
	if (marca=="" || modelo=="" || anio=="" || color=="" || placa=="" || valor=="") msjError(1010);
...
function verificarPatrimonioCuenta(form, persona) {
	...
	var fgarantia = document.getElementById("fgarantia").checked;
	if (fgarantia) var flaggarantia="S"; else var flaggarantia="N";
	if (tipo=="" || institucion=="" || cta=="" || valor=="") msjError(1010);
	else if (isNaN(valor)) msjError(1320);
	else {
		//	CREO UN OBJETO AJAX PARA VERIFICAR QUE EL NUEVO REGISTRO NO EXISTA EN LA BASE DE DATOS
		var ajax=nuevoAjax();
...
//	FUNCION PARA SELECCIONAR UNA/S DE UNA LISTA Y GUARDARLO EN 
function cargarDetalle(pagina, target) {
	var form=document.getElementById("frmentrada");
	form.action=pagina;
	form.target=target;
	form.submit();
...
//	FUNCION PARA SELECCIONAR UNA/S DE UNA LISTA Y GUARDARLO EN 
function cargarPartida(pagina, target) {
	var form=document.getElementById("frmentrada");
	form.action=pagina; //alert(pagina);
	form.target=target; //alert(target);
	form.submit();
	window.close();
}
...
// ****************          *************   VERFICACION DATOSGENERALES ******************         *****************//
// ****************          *************   VERFICACION DATOSGENERALES ******************         *****************//
function verificarDatosgenerales(form, accion){
	var filtro = new String (form.filtro.value); filtro=filtro.trim(); form.filtro.value=filtro;
	var regresar = new String (form.regresar.value); regresar=regresar.trim(); form.regresar.value=regresar;
	var codigo = new String (form.codigo.value); codigo=codigo.trim(); form.codigo.value=codigo;
	var organismo = new String (form.organismo.value); organismo=organismo.trim(); form.organismo.value=organismo;
...
function verificarVacacionesUtilizacion(form) {
	...
	if (finicio=="" || ffin=="" || utilizacion=="" || dias=="" || dias==0) msjError(1010);
	...
	else if (utilizacion=="G" && dias>vac_pendientes) alert("¡LOS DIAS DE UTILIZACION NO PUEDE SER MAYOR A LOS DIAS DE DERECHO!");
		...
		ajax.open("POST", "fphp.php", true);
		ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
		ajax.send("modulo=VACACIONES&accion=UTILIZACION&sub="+sub_accion+"&persona="+persona+"&nro_periodo="+nro_periodo+"&finicio="+finicio+"&ffin="+ffin+"&utilizacion="+utilizacion+"&fingreso="+fingreso+"&derecho="+derecho+"&mes_programado="+mes_programado+"&dias="+dias+"&vac_pendientes="+vac_pendientes);
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				var resp = ajax.responseText;
...
function verificarEvaluacionDesempenioEmpleado(form, accion) {
	...
	var desempenio = new String (form.desempenio.value); desempenio=desempenio.trim();
	var funciones = new String (form.funciones.value); funciones=funciones.trim();
	var metas = new String (form.metas.value); metas=metas.trim();
	...
	//	VERIFICO QUE LOS CAMPOS OBLIGATORIOS NO ESTEN VACIOS
	if (persona=="" || fecha_evaluacion=="") msjError(1010);
		...
		ajax.onreadystatechange=function() {
			if (ajax.readyState==4)	{
				...
				if (resp[0]!=0) alert ("¡"+resp[0]+"!");
					...
					if (accion=="GUARDAR") {
						alert("¡LOS DATOS SE ALMACENARON EXITOSAMENTE!");
						var pagina="evaluacion_desempenio_editar.php?filtro="+form.filtro.value+"&registro="+resp[1];
						cargarPagina(form, pagina);
					} else {
...
function sumarPartida(monto, id) {
	var id = id.split("|");	
	var partida = id[0];
	var generica = id[1];
    
	var monto_detalle = new Number(monto);
	var monto_generica = new Number(document.getElementById(generica).value);
    var monto_partida = new Number(document.getElementById(partida).value);
	
   	   //var total_partida = monto_partida + monto_detalle;
	   //var total_generica = monto_generica + monto_detalle;
	
	   //document.getElementById(partida).value = total_partida;
	   //document.getElementById(generica).value = total_generica;
	   //document.getElementById("total").value = total_partida;
	   
	   var valorGuardado = new Number(document.getElementById('montovoy').value)
	
	if(valorGuardado > monto_detalle ){
	  var calc = valorGuardado - monto_detalle ;
	...
	document.getElementById("total").value= total_a;
 }
///////////////////////////////////////////SUMAR PARTIDA///////////////////////////////////////////////////////
function sumarPartida2(monto, id) {
	//var id2 = id.split("|");	
	//var partida = id[0];
	//var generica = id[1];
    var generica = id;
	...
	var total_generica = monto_generica + monto_detalle;
		document.getElementById(generica).value = total_generica;
	    document.getElementById("total").value = total_generica;
}
//////////////////////////////////////////SUMAR PARTIDA////////////////////////////////////////////////////////
function sumarPartidaEditada(monto, id) {
	var id = id.split("|");	
	var partida = id[0];
	var generica = id[1];
	...
	var valorGuardado = new Number(document.getElementById('montovoy').value);
	var valorMontoautori = new Number(document.getElementById('montoautori').value); alert(valorMontoautori);
	var valorMontorestante = new Number(document.getElementById('montorestante').value);alert(valorMontorestante);
	
	if(monto_detalle > valorGuardado){
	  var calc = monto_detalle - valorGuardado; alert(calc);
	  var total_generica = monto_generica + calc;
	  var total_partida = monto_partida + calc;
	      document.getElementById(generica).value = total_generica;
		  document.getElementById(partida).value = total_partida;
		  document.getElementById("total").value = total_partida;
		  document.getElementById("montorestante").value = valorMontorestante - calc;  
	}else{
	  var calc = valorGuardado - monto_detalle;
	  var total_generica = monto_generica - calc;
	  var total_partida = monto_partida - calc;
...
////// ****** OBTENER FECHAS SIN TOMAR EN CUENTA NI SABADOS NI DOMINGOS
function capturarFecha(fecha1, fecha2){
	//OBTENGO DATOS DEL FORMULARIO
	fechaInicio = fecha1;
	fechaFin = fecha2;
    //OBTIENE DIAS,MES Y AÑO
	 var fechaI = new fecha(fechaInicio);
	 var fechaF = new fecha(fechaFin);
	
	//OBTIENE OBJETOS DATE
	 var mifechaI = new Date(fechaI.anio,fechaI.mes-1,fechaI.dia);
	 var mifechaF = new Date(fechaF.anio,fechaF.mes-1,fechaF.dia);
	 
	//RESTA FECHAS Y REDONDEA
	var diferencia = mifechaI.getTime() - mifechaF.getTime()
    var dias = Math.floor(diferencia / (1000 * 60 * 60 * 24));
    var x;
    var habil=dias;
    for(x=1;x<=dias; x++){
       dfecha = new Date( mifechaF.getFullYear(), mifechaF.getMonth(),(mifechaF.getDate()+x));
