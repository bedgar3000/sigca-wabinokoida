...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Tipos de Pago | Actualizaci&oacute;n</td>
...
<form id="frmentrada" name="frmentrada" action="tipospago.php" method="POST" onsubmit="return verificarTipoPago(this, 'ACTUALIZAR');">

<?php
include("fphp.php");
connect();
$sql="SELECT * FROM masttipopago WHERE CodTipoPago='".$_POST['registro']."'";
...
if ($rows!=0) {
	...
	<table width='700' class='tblForm'>
	  ...
	  <tr>
	    ...
	    <td><input name='descripcion' type='text' id='descripcion' size='60' maxlength='30' value='".$field['TipoPago']."' />*</td>
	  </tr>
	  <tr>
