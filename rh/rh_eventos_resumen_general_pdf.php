...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->SetXY(10, 20); $this->Cell(190, 5, utf8_decode('RESUMEN GENERAL'), 0, 1, 'C', 0);
...
while ($field = mysql_fetch_array($query)) {
	...
	$pdf->Row(array($field['DiasPeriodo'],
					($field['DiasPago'] - $field['DiasInactivos'] - $field['DiasFeriados']),
					$field['DiasInactivos'],
					$field['DiasFeriados'],
					$field['DiasTrabajados'],
					$field['DiasDescuento'],
					number_format($field['ValorDescuento'], 2, ',', '.'),
