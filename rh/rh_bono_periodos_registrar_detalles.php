...
<table width="100%" class="tblLista">
    ...
    <tr>
		...
		for($i=1;$i<=$field_dias['DiasPeriodo'];$i++) {
			list($d, $m, $a) = split("[-./]", $f);
			?><th scope="col" width="8" style="font-size:9px; padding-left:0px; padding-right:0px;"><?=$d?></th><?php
    ...
    for($i=1;$i<=$field_dias['DiasPeriodo'];$i++) {
        ...
        elseif ($field_dias[$id] == "A") $color = "color:#050;";
		elseif ($field_dias[$id] == "D") $color = "color:#900;";
		else $color = "";
		?><td align="center" style="font-size:12px; padding:2px; font-weight:bold; <?=$color?>"><?=$field_dias[$id]?></th><?php
	}
    ?>
    </tbody>
</table>
	...
	<tr>
    	<td width="40%" valign="top">
            ...
            <table width="100%" class="tblFiltro">
                ...
                <tr>
                    <td width="20" align="right" style="color:#090;">
                        X :
                    </td>
                    <td style="color:#090;">
                        ASISTENCIA
                ...
                <tr>
                    <td width="20" align="right" style="color:#050;">
                        A :
                    </td>
                    <td style="color:#050;">
                        ASISTENCIA (FERIADO)
                    </td>
                    <td align="right" style="color:#900;">
                        D :
                    </td>
                    <td style="color:#900;">
                        DESCUENTO
        ...
        <td width="60%" valign="top">
        	<?php
			$Trabajados = $field_dias['DiasPeriodo'] - ($field_dias['DiasDescuento'] + $field_dias['DiasFeriados']);
			?>
            <div class="divBorder" style="width:100%;">
            <table width="100%" class="tblFiltro">
                <tr>
                ...
                <tr>
                    <td align="right" width="20%" height="20">Total:</td>
                    <td align="right" width="20%">H&aacute;biles:</td>
                    <td align="right" width="20%">Descuento:</td>
                    <td align="right" width="20%">Feriados:</td>
                    <td align="right">Descanso:</td>
                </tr>
                <tr>
                    <td align="right" height="20">
                        <input type="text" style="width:60px; text-align:right;" class="codigo" value="<?=$field_dias['DiasPago']?>" disabled />
                    </td>
                    <td align="right">
                        <input type="text" style="width:60px; text-align:right;" class="codigo" value="<?=($field_dias['DiasPago']-$field_dias['DiasInactivos'])?>" disabled />
                    </td>
                    <td align="right">
                        <input type="text" style="width:60px; text-align:right;" class="codigo" value="<?=$field_dias['DiasDescuento']?>" disabled />
                    </td>
                    <td align="right">
                        <input type="text" style="width:60px; text-align:right;" class="codigo" value="<?=$field_dias['DiasFeriados']?>" disabled />
                    </td>
                    <td align="right">
                        <input type="text" style="width:60px; text-align:right;" class="codigo" value="<?=$field_dias['DiasInactivos']?>" disabled />
                    </td>
                </tr>
            </table>
            </div>
