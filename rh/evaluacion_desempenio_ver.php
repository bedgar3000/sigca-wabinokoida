...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Evaluaci&oacute;n de Desempe&ntilde;o | Ver</td>
...
<table width="1100" class="tblForm">
    <tr>
        ...
        <td>
			...
			<input name="empleado" type="text" id="empleado" size="10" disabled="disabled" value="<?=$field['CodEmpleado']?>" />
			<input name="nomempleado" type="text" id="nomempleado" size="50" disabled="disabled" value="<?=$field['NomCompleto']?>" />
			<input type="button" value="..." disabled="disabled" /> *
		</td>
        <td class="tagForm" width="100">Organismo:</td>
        <td colspan="3"><input name="nomorganismo" type="text" id="nomorganismo" size="63" value="<?=$field_ep['Organismo']?>" disabled="disabled" /></td>
    ...
    <tr>
        ...
        <td><input name="nomcargo" type="text" id="nomcargo" size="65" disabled="disabled" value="<?=$field['DescripCargo']?>" /></td>
        <td class="tagForm">Desde:</td>
        <td><input name="fecha_desde" type="text" id="fecha_desde" size="15" value="<?=$fecha_inicio?>" disabled="disabled" /></td>
        <td class="tagForm">Hasta:</td>
        <td><input name="fecha_hasta" type="text" id="fecha_hasta" size="15" value="<?=$fecha_fin?>" disabled="disabled" /></td>
    </tr>
    <tr>
        <td class="tagForm">Comentario:</td>
        <td><textarea name="comempleado" id="comempleado" style="width:98%; height:50px;" disabled="disabled"><?=$field['ComentarioPersona']?></textarea></td>
        <td class="tagForm">Evaluaci&oacute;n:</td>
        <td colspan="3">
        	<select name="pevaluacion" id="pevaluacion" style="width:275px;" disabled="disabled">
    ...
    <tr>
		...
		<td>
        	<?php if ($field['Estado'] == "PE") $estado = "En Evaluacion"; else $estado = "Evaluado"; ?>
        	<input type="hidden" value="<?=$field['Estado']?>" />
			<input type="text" id="status" value="<?=$estado?>" disabled="disabled" />
		</td>
        <td class="tagForm">Fecha:</td>
		<td colspan="3"><input type="text" name="fecha_evaluacion" id="fecha_evaluacion" size="15" maxlength="10" value="<?=$fecha_evaluacion?>" disabled="disabled" />* <em>(dd-mm-yyyy)</em></td>
    </tr>
    <tr>
...
<center>
<input type="button" value="Cancelar" onclick="window.close();" style="width:75px;" /> | 
</center>
</form><br />
...
<table width="1100" class="tblBotones">
    <tr>
    	<td>
        	<input type="button" value="Calificacion" onclick="selector(this.form, 'seldetalle_tab2', 'listado_calificativos.php?ficha=competencia&cod=txtcodcalificativo&nom=txtnomcalificativo&ventana=listaEvaluacionDesempeno&organismo=<?=$codorganismo?>&secuencia=<?=$field_ep['Secuencia']?>&periodo=<?=$field_ep['Periodo']?>&limit=0', 'height=300, width=400, left=200, top=200, resizable=yes');" disabled="disabled" /> | 
...
<table width="100%" class="tblLista">
    ...
    while ($field_desempeno = mysql_fetch_array($query_desempeno)) { $nrodetalles++;
        ...
        <tr class="trListaBody" onclick="mClk(this, 'seldetalle_tab2');" id="tab2_<?=$nrodetalles?>">
            ...
            <td><input type="text" name="txtpeso_tab2" id="txtpeso_tab2_<?=$nrodetalles?>" value="<?=number_format($field_desempeno['Peso'], 2, ',', '.')?>" style="width:99%; text-align:right;" onchange="setTotalesCalificacionPesoDesempeno(<?=$nrodetalles?>);" class="peso_<?=$agrupa?>_tab2" onblur="numeroBlur(this);" onfocus="numeroFocus(this);" disabled="disabled" /></td>            
...
<table width="100%" class="tblLista">
	...
	while($field_fortalezas = mysql_fetch_array($query_fortalezas)) { $nrodetalles++;
        ...
        <tr class="trListaBody" onclick="mClk(this, 'seldetalle_tab4');" id="tab4_<?=$nrodetalles?>">
            <td>
                <select name="slttipo_tab4" style="width:99%;" disabled="disabled">
                    <option value=""></option>
                    <?=getTipoFD($field_fortalezas['Tipo'], 0);?>
                </select>
            </td>
            <td><input type="text" name="txtdescripcion_tab4" value="<?=($field_fortalezas['Descripcion'])?>" maxlength="255" style="width:99%" disabled="disabled" /></td>
		</tr>
        <?php
	}
	?>
...
<table width="1100" class="tblBotones">
    <tr>
    	<td><input type="button" class="btLista" value="Calificacion" onclick="selector(this.form, 'seldetalle_tab5', 'listado_calificativos.php?ficha=objetivos&cod=txtcodcalificativo&nom=txtnomcalificativo&ventana=listaEvaluacionObjetivosMetas&organismo=<?=$codorganismo?>&secuencia=<?=$field_ep['Secuencia']?>&periodo=<?=$field_ep['Periodo']?>&limit=0', 'height=300, width=400, left=200, top=200, resizable=yes');" disabled="disabled" /></td>
        <td align="right">
        	<input type="button" class="btLista" value="Insertar" onclick="insertarLineaDetalleMetas(this.form, 'insertarEvaluacionObjetivosMetas', 'tab5');" disabled="disabled" />
            <input type="button" class="btLista" value="Borrar" onclick="quitarDetalleListaTab(document.getElementById('seldetalle_tab5').value, 'tab5');" disabled="disabled" />
        </td>
    </tr>
</table>
...
<table width="100%" class="tblLista">
	...
	while($field_metas = mysql_fetch_array($query_metas)) { $nrodetalles++;
        ...
        <tr class="trListaBody" onclick="mClk(this, 'seldetalle_tab5');" id="tab5_<?=$nrodetalles?>">
            <td>
            	<textarea name="txtdescripcion_tab5" style="width:99%; height:15px;" onBlur="this.style.height='15px'" onFocus="this.style.height='60px'" disabled="disabled" onchange="setDescripcionMeta(this.value, '<?=$nrodetalles?>');"><?=($field_metas['Descripcion'])?></textarea>
			</td>
            <td><input type="text" name="txtperiodo_tab5" value="<?=$field_metas['PeriodoMetas']?>" maxlength="7" style="width:99%; text-align:center;" disabled="disabled" /></td>
            <td>
            	<textarea name="txtcomentarios_tab5" style="width:99%; height:15px;" onBlur="this.style.height='15px'" onFocus="this.style.height='60px'" disabled="disabled"><?=($field_metas['Comentarios'])?></textarea>
			</td>
            <td><input type="text" name="txtfdesde_tab5" value="<?=formatFechaDMA($field_metas['Desde'])?>" maxlength="10" style="width:99%; text-align:center;" disabled="disabled" /></td>
            <td><input type="text" name="txtfhasta_tab5" value="<?=formatFechaDMA($field_metas['Hasta'])?>" maxlength="10" style="width:99%; text-align:center;" disabled="disabled" /></td>
            <td>
            ...
            <td><input type="text" name="txtpeso_tab5" id="txtpeso_tab5_<?=$nrodetalles?>" value="<?=number_format($field_metas['Peso'], 2, ',', '.')?>" style="width:99%; text-align:right;" onchange="setTotalesCalificacionPeso(<?=$nrodetalles?>);" onblur="numeroBlur(this);" onfocus="numeroFocus(this);" disabled="disabled" /></td>
...
<table width="1100" class="tblBotones">
    <tr>
    	<td><input type="button" class="btLista" value="Curso" onclick="selector(this.form, 'seldetalle_tab6', 'lista_cursos.php?cod=txtcodcurso&nom=txtnomcurso&ventana=listaEvaluacionNecesidad&organismo=<?=$codorganismo?>&secuencia=<?=$field_ep['Secuencia']?>&periodo=<?=$field_ep['Periodo']?>&limit=0', 'height=600, width=750, left=50, top=0, resizable=yes');" disabled="disabled" /></td>
        <td align="right">
...
<table width="100%" class="tblLista">
	...
	while($field_necesidad = mysql_fetch_array($query_necesidad)) { $nrodetalles++;
        ...
        <tr class="trListaBody" onclick="mClk(this, 'seldetalle_tab6');" id="tab6_<?=$nrodetalles?>">
            <td><input type="text" name="txtnecesidad_tab6" value="<?=($field_necesidad['Necesidad'])?>" maxlength="100" style="width:99%" disabled="disabled" /></td>
            <td>
            	<select name="slttipo_tab6" style="width:99%;" disabled="disabled">
                    <option value=""></option>
            ...
            <td><input type="text" name="txtobjetivo_tab6" value="<?=($field_necesidad['Objetivo'])?>" maxlength="100" style="width:99%" disabled="disabled" /></td>
		</tr>
        <?php
	}
	?>
...
<table width="1750" class="tblLista">
	...
	while($field_revision = mysql_fetch_array($query_revision)) { $nrodetalles++;
        ...
        <tr class="trListaBody">
            ...
            <td><input type="text" name="txtfecha1_tab7" value="<?=formatFechaDMA($field_revision['Fecha1'])?>" maxlength="10" style="width:99%; text-align:center;" disabled="disabled" /></td>
            <td><input type="text" name="txtporcentaje1_tab7" value="<?=number_format($field_revision['Porcentaje1'], 2, ',', '.')?>" style="width:99%; text-align:right;" onblur="numeroBlur(this);" onfocus="numeroFocus(this);" disabled="disabled" /></td>
            <td><textarea name="txtobservacion1_tab7" style="width:99%; height:15px;" onBlur="this.style.height='15px'" onFocus="this.style.height='60px'" disabled="disabled" onchange="setDescripcionMeta(this.value, '<?=$nrodetalles?>');"><?=($field_revision['Observacion1'])?></textarea></td>
            <td><input type="text" name="txtfecha2_tab7" value="<?=formatFechaDMA($field_revision['Fecha2'])?>" maxlength="10" style="width:99%; text-align:center;" disabled="disabled" /></td>
            <td><input type="text" name="txtporcentaje2_tab7" value="<?=number_format($field_revision['Porcentaje2'], 2, ',', '.')?>" style="width:99%; text-align:right;" onblur="numeroBlur(this);" onfocus="numeroFocus(this);" disabled="disabled" /></td>
            <td><textarea name="txtobservacion2_tab7" style="width:99%; height:15px;" onBlur="this.style.height='15px'" onFocus="this.style.height='60px'" disabled="disabled" onchange="setDescripcionMeta(this.value, '<?=$nrodetalles?>');"><?=($field_revision['Observacion2'])?></textarea></td>
            <td><input type="text" name="txtfecha3_tab7" value="<?=formatFechaDMA($field_revision['Fecha3'])?>" maxlength="10" style="width:99%; text-align:center;" disabled="disabled" /></td>
            <td><input type="text" name="txtporcentaje3_tab7" value="<?=number_format($field_revision['Porcentaje3'], 2, ',', '.')?>" style="width:99%; text-align:right;" onblur="numeroBlur(this);" onfocus="numeroFocus(this);" disabled="disabled" /></td>
            <td><textarea name="txtobservacion3_tab7" style="width:99%; height:15px;" onBlur="this.style.height='15px'" onFocus="this.style.height='60px'" disabled="disabled" onchange="setDescripcionMeta(this.value, '<?=$nrodetalles?>');"><?=($field_revision['Observacion3'])?></textarea></td>
		</tr>
        <?php
	}
	?>
