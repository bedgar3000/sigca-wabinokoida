...
<table width="1000" class="tblFiltro">
	<tr>
		...
		<td align="right" width="125">Sit. Tra.:</td>
		<td>
    ...
    <tr>
		...
		<td rowspan="2" valign="top">
            ...
            <select multiple name="fCodPerfil[]" id="fCodPerfil[]" style="width:175px; height:45px;" disabled="disabled">
                <?=loadSelect("tipoperfilnom", "CodPerfil", "Perfil", $fCodPerfil)?>
            </select>
		</td>
	</tr>
    <tr>
    ...
    <tr>
		...
		<td>
			...
			<input type="text" name="fBuscar" id="fBuscar" style="width:295px;" disabled />
		</td>
		<td align="right">&nbsp;</td>
		<td>
