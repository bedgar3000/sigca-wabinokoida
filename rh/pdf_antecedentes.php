...
$pdf->SetXY(20, 10); $pdf->Cell(190, 5, 'Alcaldía de Angostura', 0, 1, 'L');
$pdf->SetXY(20, 15); $pdf->Cell(190, 5, 'Dirección de Recursos Humanos', 0, 1, 'L');
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(190, 10, 'Reporte de Antecedentes', 0, 1, 'C');
$pdf->Ln(5);
//	---------------------------------------------------

//	Consulto datos del trabajador...
$sql = "SELECT 
			mp.NomCompleto, 
			mp.Ndocumento, 
			mp.Fnacimiento, 
...
list($a, $m, $d) = getEdadAMD($fnacimiento, date("d/m/Y")); $edad_empleado = $a;
//	---------------------------------------------------
...
$pdf->Cell(190, 8, 'DATOS DEL TRABAJADOR', 1, 1, 'L', 1);
...
$pdf->Cell(25, 5, $edad_empleado, 0, 1, 'C');
...
$pdf->Cell(35, 4, 'Sueldo Actual', 0, 1, 'C');
$pdf->SetY($y+4); 
$pdf->SetFont('Arial', '', 8);
...
$pdf->SetFillColor(235, 235, 235); 
$pdf->SetFont('Arial', 'B', 9);
$pdf->Cell(190, 8, 'TIEMPO DE SERVICIO', 1, 1, 'L', 1);
$pdf->SetFillColor(255, 255, 255);
