...
//	------------------------------------
?>
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=rh_postulantes_referencias_lista" method="POST" onsubmit="return postulantes_referencias(this, '<?=$accion?>');">
...
<table width="80%" class="tblForm">
    ...
    <tr>
		...
		<td colspan="3">
			<input type="text" id="Cargo" style="width:99%;" maxlength="255" value="<?=$field['Cargo']?>" <?=$disabled_ver?> />
		</td>
	</tr>
    <tr>
