...
<table width="1100" class="tblForm">
    ...
    <tr>
		...
		<td>
        	<?php if ($field['Estado'] == "EE") $estado = "En Evaluacion"; else $estado = "Evaluado"; ?>
...
<table width="1100" class="tblBotones" style="display:none;">
    <tr>
    	<td><input type="button" class="btLista" value="Calificacion" onclick="selector(this.form, 'seldetalle_tab3', 'listado_calificativos.php?ficha=funciones&cod=txtcodcalificativo&nom=txtnomcalificativo&ventana=lista&organismo=<?=$codorganismo?>&secuencia=<?=$field_ep['Secuencia']?>&periodo=<?=$field_ep['Periodo']?>&limit=0', 'height=300, width=400, left=200, top=200, resizable=yes');" <?=$disabled?> /></td>
        <td align="right">
        	<input type="button" class="btLista" value="Insertar" onclick="insertarLineaDetalle(this.form, 'insertarEvaluacionFunciones', 'tab3');" <?=$disabled?> />
            <input type="button" class="btLista" value="Borrar" onclick="quitarDetalleListaTab(document.getElementById('seldetalle_tab3').value, 'tab3');" <?=$disabled?> />
        </td>
    </tr>
</table>
...
<table width="100%" class="tblLista">
    ...
    <tbody id="listaDetalles_tab4"></tbody>
</table>
</div></td></tr></table>
</td></tr></table>
...
<table width="100%" class="tblLista">
    ...
    <tbody id="listaDetalles_tab6"></tbody>
</table>
</div></td></tr></table>
</td></tr></table>
