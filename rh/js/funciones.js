...
//	
function vacaciones_imprimir() {
	var registro = $('#registro').val().split(".");
	if (registro[2] == "G") var pagina = "rh_vacaciones_pdf"; else var pagina = "rh_vacaciones_interrupcion_pdf";
	abrirReporteVal('a_reporte', pagina, '', '', $('#registro'), 0, document.getElementById('frmentrada'));
}
//	------------------------------------------