...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Preguntas de Clima Laboral | Nuevo Registro</td>
...
<form id="frmentrada" name="frmentrada" action="preguntas.php" method="POST" onsubmit="return verificarPregunta(this, 'GUARDAR');">
  ...
  <tr>
    ...
    <td colspan="3">
		<select name="area" id="area">
			<option value=""></option>
			<?php getMiscelaneos("", "AREACLIMA", 0); ?>
		</select>*
	</td>
  </tr>
  <tr>
    <td class="tagForm">Valor M&iacute;nimo:</td>
    <td width="100"><input name="minimo" type="text" id="minimo" size="10" maxlength="4" />*</td>
    <td class="tagForm">Valor M&aacute;ximo:</td>
    <td><input name="maximo" type="text" id="maximo" size="10" maxlength="4" />*</td>
  </tr>
  <tr>
