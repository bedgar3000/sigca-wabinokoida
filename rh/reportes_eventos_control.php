...
//
echo "
<form name='frmentrada' id='frmentrada' method='post' action='pdf_eventos_control.php'>
...
<table width='1000' class='tblFiltro'>
	<tr>
		...
		<td width='125' align='right'>Tipo de Ausencia:</td>
		<td>
			<input type='checkbox' name='chktipo' value='1' $obj[44] onclick='enabledTipoAusencia(this.form);' />
			<select name='ftipo' id='ftipo' class='select3' $obj[45]>
				<option value=''></option>";
...
<br /><div class='divDivision'>Reporte de Control de Eventos</div><br />";
?>
...
<table width="1000" align="center">
  <tr>
		<td>
			...
			<ul>
			<!-- CSS Tabs -->
			<li><a onclick="document.getElementById('tab1').style.display='block'; document.getElementById('tab2').style.display='none';" href="#">Asistencias</a></li>
			<li><a onclick="document.getElementById('tab1').style.display='none'; document.getElementById('tab2').style.display='block';" href="#">Permisos</a></li>
			</ul>
			</div>
		</td>
	</tr>
...
<div style="width:1000px" class="divFormCaption">Control de Asistencias</div>
<center>
...
<div style="width:1000px" class="divFormCaption">Control de Permisos</div>
<center>
