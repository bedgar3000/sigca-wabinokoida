...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->SetXY(10, 20); $this->Cell(190, 5, utf8_decode('Retenciones Judiciales'), 0, 1, 'C', 0);
		$this->Ln(5);
		##
		$this->SetDrawColor(0, 0, 0);
		$this->SetWidths(array(13, 10, 45, 45, 20, 48, 25));
		$this->SetAligns(array('C', 'C', 'L', 'L', 'C', 'L', 'C'));
