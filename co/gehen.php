...
<script type="text/javascript" language="javascript">
	$(document).ready(function() {
		...
		var height = heightWindow - heightFiltro - 175;
...
<script type="text/javascript">
	$(document).ready(function(){
		$(document).keydown(function(event){
			...
			if ($('.F1').length && event.which == '112') {
				$('.F1').click();
			}
			else if ($('.F2').length && event.which == '113') {
				$('.F2').click();
			}
			else if ($('.F4').length && event.which == '115') {
				$('.F4').click();
			}
			else if ($('.F6').length && event.which == '117') {
				$('.F6').click();
			}
			else if ($('.F9').length && event.which == '120') {
				$('.F9').click();
			}
		});
	});
