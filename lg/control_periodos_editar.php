...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Control de Periodos | Modificar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="control_periodos.php?limit=0" method="POST" onsubmit="return verificarControlPeriodo(this, 'ACTUALIZAR');">
...
<table width="700px" class="tblForm">
	...
	<tr>
		...
		<td>
			...
			<input type="checkbox" id="flagtransaccion" <?=$flagtransaccion?> /> Disponible para Transacci&oacute;n
		</td>
	</tr>
	<tr>
