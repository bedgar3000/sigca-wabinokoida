...
case "CLASIFICACION-COMMODITIES":
	...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_commodityclasificacion WHERE Clasificacion = '".$codigo."' OR Descripcion = '".($descripcion)."'";
	...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_commodityclasificacion WHERE Clasificacion <> '".$codigo."' AND Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_commodityclasificacion SET Descripcion = '".($descripcion)."',
...
case "COMMODITIES":
	...
	elseif ($accion == "ACTUALIZAR-MAST") {
		$sql = "SELECT * FROM lg_commoditymast WHERE CommodityMast <> '".$codigo."' AND Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_commoditymast SET Descripcion = '".($descripcion)."',
												Clasificacion = '".$clasificacion."',
												Estado = '".$status."',
												UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												UltimaFecha = '".date("Y-m-d H:i:s")."'
											WHERE CommodityMast = '".$codigo."'";
			$query = mysql_query($sql) or die ($sql.mysql_error());
		}
		echo $error."|".$codigo;
	}
	...
	elseif ($accion == "GUARDAR-DET") {
		$sql = "SELECT * FROM lg_commoditysub WHERE CommodityMast = '".$commoditymast."' AND Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	elseif ($accion == "EDITAR-DET") {
		...
		echo "$error|:|".$field['Codigo']."|:|".($field['Descripcion'])."|:|".$field['CodUnidad']."|:|".$field['Estado']."|:|".$field['cod_partida']."|:|".$field['CodCuenta']."|:|".$field['CodClasificacion'];
	}
	//	ACTUALIZAR REGISTRO...
	elseif ($accion == "ACTUALIZAR-DET") {
		$sql = "SELECT * FROM lg_commoditysub WHERE (CommodityMast = '".$commoditymast."' AND Descripcion = '".($descripcion)."') AND Codigo <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
...
case "UNIDADES-MEDIDA":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR-MAST") {
		$sql = "SELECT * FROM mastunidades WHERE CodUnidad = '".$codigo."' OR Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR-MAST") {
		$sql = "SELECT * FROM mastunidades WHERE CodUnidad <> '".$codigo."' AND TipoMedida = '".$tipo."' AND Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE mastunidades SET Descripcion = '".($descripcion)."',
												Estado = '".$status."',
												UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												UltimaFecha = '".date("Y-m-d H:i:s")."'
											WHERE 
...
case "ALMACENES":
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_almacenmast WHERE CodAlmacen <> '".$codigo."' AND Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_almacenmast SET Descripcion = '".($descripcion)."',
...
case "CLASIFICACIONES":
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "UPDATE lg_clasificacion SET Descripcion = '".($descripcion)."',
...
case "TIPOS-DOCUMENTOS":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_tipodocumento WHERE CodDocumento = '".$codigo."' OR Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_tipodocumento WHERE Descripcion = '".($descripcion)."' AND CodDocumento <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_tipodocumento SET Descripcion = '".($descripcion)."',
...
case "TIPOS-TRANSACCIONES":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_tipotransaccion WHERE CodTransaccion = '".$codigo."' OR Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_tipotransaccion WHERE Descripcion = '".($descripcion)."' AND CodTransaccion <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_tipotransaccion SET Descripcion = '".($descripcion)."',
													TipoMovimiento = '".$tipo."',
...
case "TIPOS-ITEMS":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_tipoitem WHERE Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_tipoitem WHERE Descripcion = '".($descripcion)."' AND CodTipoItem <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_tipoitem SET Descripcion = '".($descripcion)."',
												FlagTransaccion = '".$flagtransaccion."',
												Estado = '".$estado."',
												UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												UltimaFecha = '".date("Y-m-d H:i:s")."'
...
case "LINEAS":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_claselinea WHERE Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_claselinea WHERE Descripcion = '".($descripcion)."' AND CodLinea <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_claselinea SET Descripcion = '".($descripcion)."',
												Estado = '".$estado."',
												UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												UltimaFecha = '".date("Y-m-d H:i:s")."'
											WHERE
...
case "FAMILIAS":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_clasefamilia WHERE Descripcion = '".($descripcion)."' AND CodLinea = '".$codlinea."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_clasefamilia WHERE Descripcion = '".($descripcion)."' AND CodLinea = '".$codlinea."' AND CodFamilia <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_clasefamilia SET Descripcion = '".($descripcion)."',
...
case "SUBFAMILIAS":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_clasesubfamilia WHERE Descripcion = '".($descripcion)."' AND CodLinea = '".$codlinea."' AND CodFamilia = '".$codfamilia."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_clasesubfamilia WHERE Descripcion = '".($descripcion)."' AND CodLinea = '".$codlinea."' AND CodFamilia = '".$codfamilia."' AND CodSubFamilia <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_clasesubfamilia SET Descripcion = '".($descripcion)."',
												Estado = '".$estado."',
												UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												UltimaFecha = '".date("Y-m-d H:i:s")."'
											WHERE
...
case "PROCEDENCIAS":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_procedencias WHERE Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_procedencias WHERE Descripcion = '".($descripcion)."' AND CodProcedencia <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_procedencias SET Descripcion = '".($descripcion)."',
												Estado = '".$estado."',
												UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												UltimaFecha = '".date("Y-m-d H:i:s")."'
											WHERE
...
case "MARCAS":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM lg_marcas WHERE Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM lg_marcas WHERE Descripcion = '".($descripcion)."' AND CodMarca <> '".$codigo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE lg_marcas SET Descripcion = '".($descripcion)."',
												Estado = '".$estado."',
												UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
												UltimaFecha = '".date("Y-m-d H:i:s")."'
											WHERE
...
case "REQUERIMIENTOS":
	...
	elseif ($accion == "APROBAR") {
		...
		if ($clasificacion == "STO") {
			...
			while ($field_det = mysql_fetch_array($query_det)) {
				$comprometido = $field_det['CantidadPedida'] * (-1);
				...
				if (mysql_num_rows($query_item) == 0) {
					...
					$sql = "UPDATE lg_itemalmaceninv
							SET 
								StockComprometido = (StockComprometido + $comprometido),
								UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
								UltimaFecha = '".date("Y-m-d H:i:s")."'
							WHERE
	...
	elseif ($accion == "RECHAZAR") {
		$sql = "UPDATE lg_requerimientos SET Estado = 'RE', RazonRechazo = '".($razon)."', UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha = '".date("Y-m-d H:i:s")."' WHERE CodRequerimiento = '".$codrequerimiento."' AND CodOrganismo = '".$organismo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
	...
	elseif ($accion == "ANULAR") {
		...
		$sql = "UPDATE lg_requerimientos SET Estado = '".$estado."', RazonRechazo = '".($razon)."', UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."', UltimaFecha = '".date("Y-m-d H:i:s")."' WHERE CodRequerimiento = '".$codrequerimiento."' AND CodOrganismo = '".$organismo."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
...
case "FORMAS-PAGO":
	//	INSERTAR NUEVO REGISTRO...
	if ($accion == "GUARDAR") {
		$sql = "SELECT * FROM mastformapago WHERE Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
	...
	//	MODIFICAR REGISTRO...
	elseif ($accion == "ACTUALIZAR") {
		$sql = "SELECT * FROM mastformapago WHERE CodFormaPago <> '".$codigo."' AND Descripcion = '".($descripcion)."'";
		$query = mysql_query($sql) or die ($sql.mysql_error());
		if (mysql_num_rows($query) != 0) $error = "¡REGISTRO YA INGRESADO!";
		else {
			$sql = "UPDATE mastformapago SET Descripcion = '".($descripcion)."',
...
case "ORDENES-COMPRA":
	...
	if ($accion == "INSERTAR") {
		...
		$sql = "SELECT cod_partida, CodCuenta, SUM(PrecioCantidad) AS Monto, CodCentroCosto
		...
		$sql = "SELECT *
				...
				WHERE
					...
					NroOrden = '".$nroorden."'
				ORDER BY Secuencia";
		$query_compromiso = mysql_query($sql) or die ($sql.mysql_error());	$i=0;
		while ($field_compromiso = mysql_fetch_array($query_compromiso)) {	$i++;
			$sql = "INSERT INTO distribucioncompromisos (
								CodOrganismo,
								CodProveedor,
								CodTipoDocumento,
								NroDocumento,
								...
								'".$i."',
								'1',
								'".$field_compromiso['CodCentroCosto']."',
								'".$field_compromiso['cod_partida']."',
								'".$field_compromiso['Monto']."',
								'".date("Y-m")."',
								'CO',
								'".$_SESSION['USUARIO_ACTUAL']."',
								'".date("Y-m-d H:i:s")."'
		...
		while ($field_distribucionoc = mysql_fetch_array($query_distribucionoc)) {
			$sql = "UPDATE pv_presupuestodet
					...
					WHERE
						...
						CodPresupuesto = (SELECT CodPresupuesto FROM pv_presupuesto WHERE Ejercicio = '".date("Y")."') AND
	...
	elseif ($accion == "ACTUALIZAR") {
		...
		//	elimino el compromiso
		$sql = "DELETE FROM distribucioncompromisos
				WHERE
					CodOrganismo = '".$organismo."' AND 
	...
	elseif ($accion == "ANULAR") {
		...
		$sql = "UPDATE distribucioncompromisos
				SET
					Estado = 'AN',
					UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
					UltimaFecha = '".date("Y-m-d H:i:s")."'
	...
	//	CERRAR REGISTRO...
	elseif ($accion == "CERRAR") {
		$sql = "UPDATE lg_ordencompra SET MotRechazo = '".($observaciones)."',
											Estado = 'CE',
											UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
											UltimaFecha = '".date("Y-m-d H:i:s")."'
										WHERE
...
case "ORDENES-SERVICIO":
	...
	if ($accion == "INSERTAR") {
		...
		$sql = "SELECT cod_partida, CodCuenta, SUM(CantidadPedida * PrecioUnit) AS Monto, CodCentroCosto
		...
		$sql = "SELECT cod_partida, CodCuenta, MontoIva, CodCentroCosto
	...
	elseif ($accion == "ACTUALIZAR") {
		...
		$sql = "UPDATE lg_ordenservicio SET NroInterno = '".$nrointerno."',
											...
											Descripcion = '".($descripcion)."',
											DescAdicional = '".($descripcion_adicional)."',
											Observaciones = '".($observaciones)."',
	...
	//	APROBAR REGISTRO...
	elseif ($accion == "APROBAR") {
		$sql = "UPDATE lg_ordenservicio SET Observaciones = '".($observaciones)."',
											Estado = 'AP',
											AprobadaPor = '".$_SESSION['CODPERSONA_ACTUAL']."',
											FechaAprobacion = '".date("Y-m-d H:i:s")."',
											UltimoUsuario = '".$_SESSION['USUARIO_ACTUAL']."',
