...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Ln(5);
		$this->Cell(272, 5, utf8_decode('Ordenes de Servicio x Distribución'), 0, 1, 'C', 0);
		$this->Ln(5);
		##
		$this->SetDrawColor(0, 0, 0);
...
$sql = "(SELECT
		 ...
		 FROM
			lg_ordenservicio oc
			INNER JOIN lg_distribucionos ocd ON (ocd.CodOrganismo = oc.CodOrganismo AND
...
$pdf->Cell(137, 8, 'Cantidad de Ordenes: ' . number_format($contador, 2, ',', '.'), 0, 0, 'L');
