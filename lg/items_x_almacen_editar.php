...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Items x Almacen | Modificar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="items_x_almacen.php?limit=0" method="POST" onsubmit="return verificarItemAlmacen(this, 'ACTUALIZAR');">
...
<table width="700px" class="tblForm">
	...
	<tr>
		...
		<td><input name="stockmin" type="text" id="stockmin" size="15" value="<?=number_format($field['StockMin'], 2, ',', '.')?>" style="text-align:right;" onblur="numeroBlur(this);" onfocus="numeroFocus(this);" /></td>
		<td class="tagForm" width="100">Principal:</td>
		<td><input name="ubicacion1" type="text" id="ubicacion1" size="45" value="<?=($field['Ubicacion1'])?>" /></td>
	</tr>
	<tr>
		<td class="tagForm">Stock M&aacute;ximo:</td>
		<td><input name="stockmax" type="text" id="stockmax" size="15" value="<?=number_format($field['StockMax'], 2, ',', '.')?>" style="text-align:right;" onblur="numeroBlur(this);" onfocus="numeroFocus(this);" /></td>
		<td class="tagForm">2da. Ubicaci&oacute;n:</td>
		<td><input name="ubicacion2" type="text" id="ubicacion2" size="45" value="<?=($field['Ubicacion2'])?>" /></td>
	</tr>
	<tr>
		<td class="tagForm">Punto Reorden:</td>
		<td><input name="reorden" type="text" id="reorden" size="15" value="<?=number_format($field['StockReorden'], 2, ',', '.')?>" style="text-align:right;" onblur="numeroBlur(this);" onfocus="numeroFocus(this);" /></td>
		<td class="tagForm">3ra. Ubicaci&oacute;n:</td>
		<td><input name="ubicacion3" type="text" id="ubicacion3" size="45" value="<?=($field['Ubicacion3'])?>" /></td>
	</tr>
	<tr>
		<td class="tagForm">Tiempo de Espera:</td>
		<td colspan="3"><input name="espera" type="text" id="espera" size="5" value="<?=$field['TiempoEspera']?>" style="text-align:right;" /> <i>(en dias)</i></td>
	</tr>
	<tr>
		<td class="tagForm" width="150">Estado:</td>
		<td colspan="3">
        	<?php if ($field['Estado'] == "A") $flagactivo = "checked"; ?>
