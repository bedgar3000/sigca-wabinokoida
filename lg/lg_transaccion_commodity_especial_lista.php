...
if ($fBuscar != "") {
	...
	$filtro.=" AND (oc.NroOrden LIKE '%".$fBuscar."%' OR
					...
					fp.Descripcion LIKE '%".$fBuscar."%' OR
					oc.Anio LIKE '%".$fBuscar."%')";
...
<table width="1050" class="tblBotones">
	<tr>
		<td align="right" class="gallery clearfix">
			...
			<input type="button" value="Recepcionar" style="width:75px;" onclick="cargarOpcionRecepcionCommodity(this.form);" />
            <input type="button" value="Cerrar" style="width:75px;" onclick="opcionRegistroMultipleCajaChica(this.form, 'cerrar-detalle-compras');" />
		</td>
	</tr>
</table>
<div style="overflow:scroll; width:1050px; height:200px;">
...
<table width="1050" class="tblBotones">
	<tr>
		<td align="right">
			<input type="button" value="Despachar" style="width:75px;" onclick="cargarOpcionDespachoCommodity(this.form);" /> |
			<input type="button" value="Cerrar" style="width:75px;" onclick="opcionRegistroMultipleCajaChica(this.form, 'cerrar-detalle-requerimiento');" />
		</td>
	</tr>
</table>
<div style="overflow:scroll; width:1050px; height:200px;">
