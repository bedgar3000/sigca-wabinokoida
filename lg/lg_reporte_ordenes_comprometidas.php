...
$_sufijo = "reporte_ordenes_comprometidas";
$_width = 900;
?>
...
<form name="frmentrada" id="frmentrada" action="lg_reporte_ordenes_comprometidas_distribucion_pdf.php" method="post" autocomplete="off" target="iReporte">
...
<table width="<?=$_width?>" class="tblFiltro">
	...
	<tr>
		...
		<td class="gallery clearfix">
			...
			<input type="text" name="fNomProveedor" id="fNomProveedor" style="width:210px;" class="disabled" readonly="readonly" />
    ...
    <tr>
        <td>
            ...
            <li id="li1" onclick="currentTab('tab', this);" class="current">
            	<a href="#" onclick="cargarPagina(document.getElementById('frmentrada'), 'lg_reporte_ordenes_comprometidas_distribucion_pdf.php'); mostrarTab('tab', 1, 2);">
                	Distribuci&oacute;n
                </a>
            </li>
            <li id="li2" onclick="currentTab('tab', this);">
            	<a href="#" onclick="cargarPagina(document.getElementById('frmentrada'), 'lg_reporte_ordenes_comprometidas_compromisos_pdf.php'); mostrarTab('tab', 2, 2);">
                	Compromisos
                </a>
            </li>
            </ul>
