...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Tipo de Items | Actualizar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="tipos_items.php" method="POST" onsubmit="return verificarTiposItems(this, 'ACTUALIZAR');">
...
<table width="600px" class="tblForm">
	...
	<tr>
		...
		<td>
			<?php if ($field['FlagTransaccion'] == "S") $flagtransaccion = "checked"; ?>
	...
	<tr>
		...
		<td>
			<?php if ($field['Estado'] == "A") $activo = "checked"; else $inactivo = "checked"; ?>
