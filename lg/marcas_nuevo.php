...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Marcas | Nuevo Registro</td>
...
<form name="frmentrada" id="frmentrada" action="marcas.php" method="POST" onsubmit="return verificarMarcas(this, 'GUARDAR');">
...
<table width="600px" class="tblForm">
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="10" disabled="disabled" />*</td>
	</tr>
	<tr>
