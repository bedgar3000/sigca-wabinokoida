...
if ($fCodOrganismo != "") $filtro.= " AND (a.CodOrganismo = '".$fCodOrganismo."')";
if ($fCodAlmacen != "") $filtro.= " AND (iai.CodAlmacen = '".$fCodAlmacen."')";
//---------------------------------------------------
...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Ln(5);
		$this->Cell(210, 5, utf8_decode('Inventario Actual'), 0, 1, 'C', 0);
		$this->Ln(5);
		##
		$this->SetDrawColor(0, 0, 0);
		$this->SetFillColor(200, 200, 200);
		$this->SetWidths(array(20,15,145,10,20));
...
foreach($field as $f) {	++$i;
	...
	if ($f['StockActual'] > 0) $pdf->SetTextColor(0, 0, 0);
