	...
	<tr>
		...
		<td>
            ...
            <select name="fEstado" id="fEstado" style="width:140px;" <?=$dEstado?>>
                <option value="">&nbsp;</option>
                <?=loadSelectValores("ESTADO-REQUERIMIENTO-DETALLE", $fEstado, 0)?>
            </select>
		</td>
	</tr>
    <tr>
...
<table width="1050" class="tblBotones">
	<tr>
		...
		<td align="right">
			...
			<input type="button" id="btCerrar" value="Cerrar" style="width:75px;" onclick="opcionRegistro3(this.form, $('#registro').val(), 'requerimiento', 'cerrar-detalle', 'lg_requerimiento_ajax.php');" />
		</td>
	</tr>
</table>
