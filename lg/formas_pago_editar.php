...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Formas de Pago | Modificar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="formas_pago.php" method="POST" onsubmit="return verificarFormaPago(this, 'ACTUALIZAR');">
...
<table width="500" class="tblForm">
	...
	<tr>
		<td class="tagForm">&nbsp;</td>
		<td>
			<?php if ($field['FlagCredito'] == "S") $flagcredito = "checked"; else $ddias = "disabled"; ?>
			<input name="flagcredito" type="checkbox" id="flagcredito" value="S" <?=$flagcredito?> onclick="chkFiltro(this.checked, 'dias');" /> Cr&eacute;dito
		</td>
	</tr>
	<tr>
		<td class="tagForm">Dias Vencimiento:</td>
		<td><input name="dias" type="text" id="dias" size="5" value="<?=$field['DiasVence']?>" <?=$ddias?> />*</td>
	</tr>
	<tr>
		<td class="tagForm">Estado:</td>
		<td>
			<?php if ($field['Estado'] == "A") $flagactivo = "checked"; else $flagactivo = "checked"; ?>
