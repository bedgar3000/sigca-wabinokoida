...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Tipos de Items | Nuevo Registro</td>
		<td align="right"><a class="cerrar" href="javascript:" onclick="cargarPagina(document.getElementById('frmentrada'), 'tipos_items.php');">[cerrar]</a></td>
	</tr>
</table><hr width="100%" color="#333333" />

<form name="frmentrada" id="frmentrada" action="tipos_items.php" method="POST" onsubmit="return verificarTiposItems(this, 'GUARDAR');">
...
<table width="600px" class="tblForm">
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="5" disabled="disabled" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="checkbox" name="flagtransaccion" id="flagtransaccion" value="S" /> Transacción del Sistema</td>
	</tr>
	<tr>
...
<input name="bt_cancelar" type="button" id="bt_cancelar" value="Cancelar" onClick="cargarPagina(this.form, 'tipos_items.php');" />
</center><br />
</form>
