...
connect();
//	------------------------
$sql = "SELECT * FROM lg_procedencias WHERE CodProcedencia = '".$registro."'";
$query = mysql_query($sql) or die ($sql.mysql_error());
if (mysql_num_rows($query) != 0) $field = mysql_fetch_array($query);
?>
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Maestro de Procedencias | Actualizar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="procedencias.php" method="POST" onsubmit="return verificarProcedencias(this, 'ACTUALIZAR');">
...
<table width="600px" class="tblForm">
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="6" maxlength="3" value="<?=$field['CodProcedencia']?>" disabled="disabled" /></td>
	</tr>
	<tr>
