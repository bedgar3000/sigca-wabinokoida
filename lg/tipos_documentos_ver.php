...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Tipo de Documentos | Ver Registro</td>
...
<table width="600px" class="tblForm">
	...
	<tr>
		...
		<td>
			<?php if ($field['FlagDocFiscal'] == "S") $flagdocfiscal = "checked"; ?>
			<input type="checkbox" name="flagdocfiscal" id="flagdocfiscal" value="S" <?=$flagdocfiscal?> disabled="disabled" /> Documento Fiscal
		</td>
	</tr>
	<tr>
		<td class="tagForm">&nbsp</td>
