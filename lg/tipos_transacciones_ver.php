...
<table width="600px" class="tblForm">
	...
	<tr>
		...
		<td>
			<?php if ($field['FlagVoucherConsumo'] == "S") $flagconsumo = "checked"; ?>
			<input type="checkbox" name="flagconsumo" id="flagconsumo" value="S" <?=$flagconsumo?> disabled="disabled" /> Voucher Consumo
		</td>
	</tr>
	<tr>
		<td class="tagForm">&nbsp</td>
		<td>
			<?php if ($field['FlagVoucherAjuste'] == "S") $flagajuste = "checked"; ?>
			<input type="checkbox" name="flagajuste" id="flagajuste" value="S" <?=$flagajuste?> disabled="disabled" /> Voucher Ajuste de Inventario
		</td>
	</tr>
	<tr>
		<td class="tagForm">&nbsp</td>
