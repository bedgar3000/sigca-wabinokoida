...
<form name="frmentrada" id="frmentrada" action="tipos_transacciones_commodities.php" method="POST" onsubmit="return verificarTiposTransaccionesCommodities(this, 'ACTUALIZAR');">
...
<table width="600px" class="tblForm">
	<tr>
		...
		<td><input name="codigo" type="text" id="codigo" size="5" maxlength="3" value="<?=$field['CodOperacion']?>" disabled="disabled" />*</td>
	</tr>
	<tr>
