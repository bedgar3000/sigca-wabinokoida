...
<form name="frmentrada" id="frmentrada" action="tipos_transacciones.php" method="POST" onsubmit="return verificarTiposTransacciones(this, 'GUARDAR');">
...
<table width="600px" class="tblForm">
	...
	<tr>
		...
		<td>
			<input type="checkbox" name="flagconsumo" id="flagconsumo" value="S" /> Voucher Consumo
		</td>
	</tr>
	<tr>
		<td class="tagForm">&nbsp</td>
		<td>
			<input type="checkbox" name="flagajuste" id="flagajuste" value="S" /> Voucher Ajuste de Inventario
		</td>
	</tr>
	<tr>
		<td class="tagForm">&nbsp</td>
		<td>
			<input type="checkbox" name="flagtransaccion" id="flagtransaccion" value="S" /> Transacción del Sistema
		</td>
	</tr>
	<tr>
