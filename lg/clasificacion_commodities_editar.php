...
<table width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td class="titulo">Clasificaci&oacute;n de Commodities | Actualizar Registro</td>
...
<form name="frmentrada" id="frmentrada" action="clasificacion_commodities.php" method="POST" onsubmit="return verificarClasificacionCommodities(this, 'ACTUALIZAR');">
...
<table width="500" class="tblForm">
	...
	<tr>
		<td class="tagForm">&nbsp;</td>
		<td>
			<?php if ($field['FlagTransaccion'] == "S") $flag = "checked";	?>
			<input type="checkbox" name="flagtransaccion" id="flagtransaccion" value="S" <?=$flag?> /> Transacci&oacute;n del Sistema
		</td>
	</tr>
	<tr>
