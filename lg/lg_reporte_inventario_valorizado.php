...
//	------------------------------------
$_titulo = "Inventario Valorizado";
$_sufijo = "reporte_inventario_valorizado";
$_width = 900;
?>
...
<form name="frmentrada" id="frmentrada" action="lg_reporte_inventario_valorizado_pdf.php" method="post" autocomplete="off" target="iReporte">
