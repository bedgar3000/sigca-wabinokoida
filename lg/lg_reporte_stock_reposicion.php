...
//	------------------------------------
$_titulo = "Stock por Punto de Reposici&oacute;n";
$_sufijo = "reporte_stock_reposicion";
$_width = 900;
?>
...
<form name="frmentrada" id="frmentrada" action="lg_reporte_stock_reposicion_pdf.php" method="post" autocomplete="off" target="iReporte">
...
<table width="<?=$_width?>" class="tblFiltro">
    ...
    <tr>
		<td align="right" colspan="3">Sub-Familia: </td>
		<td>
            <input type="checkbox" style="visibility:hidden" />
    ...
    <tr>
        <td>
            ...
            <li id="li1" onclick="currentTab('tab', this);" class="current">
            	<a href="#" onclick="cargarPagina(document.getElementById('frmentrada'), 'lg_reporte_stock_reposicion_pdf.php'); mostrarTab('tab', 1, 2);">
                	Por Reposici&oacute;n
                </a>
            </li>
            <li id="li2" onclick="currentTab('tab', this);">
            	<a href="#" onclick="cargarPagina(document.getElementById('frmentrada'), 'lg_reporte_stock_reposicion_maximo_pdf.php'); mostrarTab('tab', 2, 2);">
                	Stock M&aacute;ximo
                </a>
            </li>
            </ul>
