...
<table width="1050" class="tblFiltro">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="fNroInterno" id="fNroInterno" maxlength="20" style="width:100px;" value="<?=$fNroInterno?>" <?=$dCodDocumento?> />
        </td>
	</tr>
	<tr>
...
<table width="1200" class="tblLista">
	...
	$sql = "SELECT
			...
			FROM
				...
				INNER JOIN lg_tipotransaccion tt ON (t.CodTransaccion = tt.CodTransaccion)
					INNER JOIN ac_mastcentrocosto cc On cc.CodCentroCosto = t.CodCentroCosto
			WHERE 1 $filtro
			ORDER BY CodDocumento, NroInterno
	...
	while ($field = mysql_fetch_array($query)) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'registro');" id="<?=$id?>">
            ...
            <td align="center"><?=$field['CentroCosto']?></td>
