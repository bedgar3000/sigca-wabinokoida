...
<center>
<iframe name="iReporte" id="iReporte" style="border-left:solid 1px #CDCDCD; border-right:solid 1px #CDCDCD; border-bottom:solid 1px #CDCDCD; border-top:0; width:1000px; height:450px;" src="lg_transaccion_commodity_pdf.php?registro=<?=$registro?>"></iframe>
</center>