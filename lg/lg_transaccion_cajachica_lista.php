...
<table width="100%" class="tblLista">
	...
	$sql = "SELECT
			...
			WHERE
				(r.Estado = 'AP' AND r.FlagCajaChica = 'S' AND r.Clasificacion <> 'SER') AND
				(rd.Estado = 'PE') AND
	...
	while ($field = mysql_fetch_array($query)) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'registro'); appendAjax('accion=transaccion_cajachica_recepcion_detalles&registro='+$('#registro').val(), $('#lista_detalles_recepcion'));" id="<?=$field['CodRequerimiento']?>.rec">
            ...
            <td title="<?=htmlentities($TitleComentarios)?>"><?=htmlentities($Comentarios)?></td>
...
<table width="1050" class="tblBotones">
	<tr>
		<td align="right">
            ...
            <input type="button" id="btCerrar" value="Cerrar" style="width:75px;" onclick="opcionRegistroMultipleCajaChica(this.form, 'cerrar-detalle-requerimiento');" />
