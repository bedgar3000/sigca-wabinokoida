...
foreach ($detalle as $linea) {
	list($_Requerimiento, $_CodItem, $_CommoditySub, $_Descripcion, $_CodUnidad, $_CodCentroCosto, $_FlagExonerado, $_CantidadPedida, $_CodCuenta, $_CodCuentaPub20, $_cod_partida, $_Comentarios) = split(";char:td;", $linea);
	$i++;
...
<table width="1550" class="tblLista">
	<thead>
	<tr>
	...
	foreach ($detalle as $linea) {
		...
		<tr class="trListaBody" onclick="mClk(this, 'sel_detalles');" id="detalles_<?=$nrodetalles?>">
			...
			<td align="center">
            	<input type="hidden" name="FlagCompraAlmacen" value="C" />
			...
			<td align="center">
				...
				<input type="hidden" name="CodCuentaPub20" value="<?=$_CodCuentaPub20?>" />
