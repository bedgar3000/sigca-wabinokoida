...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td><input type="text" id="Descripcion" maxlength="255" style="width:90%;" value="<?=($field_commodity['Descripcion'])?>" <?=$disabled_ver?> /></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="tagForm">&nbsp;</td>
		<td>
			<input type="checkbox" name="FlagObra" id="FlagObra" value="S" <?=chkOpt($field_commodity['FlagObra'], "S")?> <?=$disabled_ver?> /> Obra
		</td>
	</tr>
	<tr>
		<td class="tagForm">Estado:</td>
		<td>
			<input type="radio" name="Estado" id="Activo" value="A" <?=chkOpt($field_commodity['Estado'], "A")?> <?=$disabled_ver?> /> Activo
			<input type="radio" name="Estado" id="Inactivo" value="I" <?=chkOpt($field_commodity['Estado'], "I")?> <?=$disabled_ver?> /> Inactivo
		</td>
	</tr>
	<tr>
...
<input type="hidden" id="eliminados_detalle" />
<center>
<div style="width:700px" class="divFormCaption">Sub-Clasificaci&oacute;n</div>
<table width="700" class="tblBotones">
    <tr>
        <td class="gallery clearfix">
            <a id="aSelPartida" href="../lib/listas/listado_clasificador_presupuestario.php?filtrar=default&cod=cod_partida&nom=NomPartida&campo3=CodCuenta&campo4=NomCuenta&campo5=CodCuentaPub20&campo6=NomCuentaPub20&ventana=selListadoLista&seldetalle=sel_detalle&iframe=true&width=950&height=525" rel="prettyPhoto[iframe1]" style="display:none;"></a>      
            <a id="aSelCuenta" href="../lib/listas/listado_plan_cuentas.php?filtrar=default&cod=CodCuenta&nom=NomCuenta&ventana=selListadoLista&seldetalle=sel_detalle&iframe=true&width=925&height=525" rel="prettyPhoto[iframe2]" style="display:none;"></a>
            
            <a id="aSelCuenta20" href="../lib/listas/listado_plan_cuentas_pub20.php?filtrar=default&cod=CodCuentaPub20&nom=NomCuentaPub20&ventana=selListadoLista&seldetalle=sel_detalle&iframe=true&width=925&height=525" rel="prettyPhoto[iframe3]" style="display:none;"></a>
            
            <a id="aSelActivo" href="../lib/listas/listado_clasificacion_activos.php?filtrar=default&cod=CodClasificacion&nom=NomClasificacion&ventana=selListadoLista&seldetalle=sel_detalle&iframe=true&width=1050&height=500" rel="prettyPhoto[iframe4]" style="display:none;"></a>
            ...
            <input type="button" class="btLista" id="btSelCuenta20" value="Cta.(Pub.20)" onclick="validarAbrirLista('sel_detalle', 'aSelCuenta20');" <?=$disabled_ver?> />
        ...
        <td align="right">
            ...
            <input type="button" class="btLista" value="Quitar" onclick="quitarLineaCommoditySub(this, 'detalle');" <?=$disabled_ver?> />
        </td>
    </tr>
</table>
...
<table width="1200" class="tblLista">
    ...
    while ($field_detalle = mysql_fetch_array($query_detalle)) {
        ...
        <tr class="trListaBody" onclick="mClk(this, 'sel_detalle');" id="detalle_<?=$nro_detalle?>">
            ...
            <td align="center">
                <input type="text" name="cod_partida" id="cod_partida_<?=$nro_detalle?>" value="<?=$field_detalle['cod_partida']?>" style="text-align:center;" maxlength="12" class="cell" onChange="getDescripcionLista2('accion=getDescripcionPartidaCuenta', this, $('#NomPartida_<?=$nro_detalle?>'), $('#CodCuenta_<?=$nro_detalle?>'), $('#NomCuenta_<?=$nro_detalle?>', $('#CodCuentaPub20_<?=$nro_detalle?>'), $('#NomCuentaPub20_<?=$nro_detalle?>'));" <?=$disabled_ver?> />
            ...
            <td align="center">
                <input type="text" name="CodCuentaPub20" id="CodCuentaPub20_<?=$nro_detalle?>" value="<?=$field_detalle['CodCuentaPub20']?>" maxlength="13" style="text-align:center;" class="cell" onChange="getDescripcionLista2('accion=getDescripcionCuenta20', this, $('#NomCuentaPub20_<?=$nro_detalle?>'));" <?=$disabled_ver?> />
                <input type="hidden" name="NomCuentaPub20" id="NomCuentaPub20_<?=$nro_detalle?>" />
            </td>
            <td align="center">
