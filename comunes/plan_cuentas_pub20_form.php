...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=plan_cuentas_pub20" method="POST" onsubmit="return plan_cuentas_pub20(this, '<?=$accion?>');">
...
<table width="900" class="tblForm">
	...
	<tr>
		...
		<td>
            <select id="TipoCuenta" style="width:205px;" <?=$disabled_ver?>>
            	<option value="">&nbsp;</option>
                <?=getMiscelaneos($field_cuenta['TipoCuenta'], "CUENTPUB20")?>
            </select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class="tagForm"></td>
		<td>
            <input type="checkbox" name="FlagReqCC" id="FlagReqCC" value="S" <?=chkFlag($field_cuenta['FlagReqCC'])?> <?=$disabled_ver?> /> Requiere Centro de Costo
		</td>
	</tr>
	<tr>
		<td class="tagForm"></td>
		<td>
            <input type="checkbox" name="FlagReqActivo" id="FlagReqActivo" value="S" <?=chkFlag($field_cuenta['FlagReqActivo'])?> <?=$disabled_ver?> /> Requiere Activo
		</td>
	</tr>
	<tr>
