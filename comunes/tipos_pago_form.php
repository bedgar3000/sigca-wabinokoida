...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=tipos_pago_lista" method="POST" onsubmit="return tipos_pago(this, '<?=$accion?>');">
...
<table width="500" class="tblForm">
	<tr>
		...
		<td>
        	<input type="text" id="CodTipoPago" value="<?=$field_form['CodTipoPago']?>" style="width:50px;" class="codigo" disabled="disabled" />
		</td>
	</tr>
	<tr>
		<td class="tagForm">* Descripci&oacute;n:</td>
		<td>
        	<input type="text" id="TipoPago" style="width:250px;" maxlength="30" value="<?=($field_form['TipoPago'])?>" <?=$disabled_ver?> />
		</td>
	</tr>
	<tr>
