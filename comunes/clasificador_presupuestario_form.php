...
<table width="900" class="tblForm">
	...
	<tr>
		<td class="tagForm" width="175">* Tipo de Cuenta:</td>
		<td>
	...
	<tr>
		...
		<td class="gallery clearfix">
			<input type="text" id="CodCuenta" style="width:75px;" value="<?=($field_partida['CodCuenta'])?>" disabled="disabled" />
	...
	<tr>
		...
		<td class="gallery clearfix">
			<input type="text" id="CodCuentaPub20" style="width:75px;" value="<?=($field_partida['CodCuentaPub20'])?>" disabled="disabled" />
	...
	<tr>
		<td class="tagForm">Cuenta Ord. Pago (Pub. 20):</td>
		<td class="gallery clearfix">
			<input type="text" id="CtaOrdPagoPub20" style="width:75px;" value="<?=($field_partida['CtaOrdPagoPub20'])?>" disabled="disabled" />
            <a href="../lib/listas/listado_plan_cuentas_pub20.php?filtrar=default&cod=CtaOrdPagoPub20&iframe=true&width=950&height=525" rel="prettyPhoto[iframe3]" style=" <?=$display_ver?>">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;" />
            </a>
		</td>
	</tr>
