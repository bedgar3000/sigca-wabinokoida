...
<form name="frmentrada" id="frmentrada" action="gehen.php?anz=usuarios_lista" method="POST" onsubmit="return usuarios(this, '<?=$accion?>');">
...
<table width="700" class="tblForm">
	<tr>
		...
		<td class="gallery clearfix">
            <input type="hidden" id="CodEmpleado" value="<?=$field_form['CodEmpleado']?>" />
            <input type="text" id="CodPersona" style="width:50px;" value="<?=$field_form['CodPersona']?>" disabled />
			<input type="text" id="NomEmpleado" style="width:300px;" value="<?=($field_form['NomEmpleado'])?>" disabled="disabled" />
            <a href="../lib/listas/gehen.php?anz=lista_personas&campo1=CodPersona&campo2=NomEmpleado&campo3=CodEmpleado&campo4=Usuario&ventana=usuarios&filtrar=default&FlagClasePersona=S&fEsEmpleado=S&fEsOtros=S&iframe=true&width=100%&height=100%" rel="prettyPhoto[iframe]" style=" <?=$display_modificar?>">
	...
	<tr>
		<td class="tagForm">* Contraseña:</td>
		<td>
        	<input type="password" id="Clave" style="width:200px;" maxlength="20" value="<?=($field_form['Clave'])?>" <?=$disabled_ver?> />
		</td>
	</tr>
	<tr>
		<td class="tagForm">* Confirmar:</td>
		<td>
        	<input type="password" id="Confirmar" style="width:200px;" maxlength="20" value="<?=($field_form['Clave'])?>" <?=$disabled_ver?> />
		</td>
	</tr>
	<tr>
		<td class="tagForm">&nbsp;</td>
