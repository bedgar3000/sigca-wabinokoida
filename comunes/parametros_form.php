...
<table width="800" class="tblForm">
	...
	<tr>
		...
		<td>
        	<input type="text" id="DescripcionParam" style="width:98%;" maxlength="100" value="<?=htmlentities($field_parametro['DescripcionParam'])?>" <?=$disabled_ver?> />
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
        	...
        	<input type="text" id="ValorTexto" style="width:200px;" value="<?=htmlentities($ValorTexto)?>" <?=$disabled_texto?> />
		</td>
	</tr>
	<tr>
