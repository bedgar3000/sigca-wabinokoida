...
<input type="hidden" name="CodCentroCosto" id="CodCentroCosto" value="<?=$field_cc['CodCentroCosto']?>" />
...
<table width="600" class="tblForm">
	...
	<tr>
		...
		<td>
        	<input type="text" id="Codigo" style="width:50px; font-weight:bold; font-size:12px;" maxlength="4" value="<?=$field_cc['Codigo']?>" <?=$disabled_ver?> />
		</td>
	</tr>
	<tr>
