...
<table class="tblBotones" style="width:100%; min-width:<?=$_width?>px;">
	<tr>
		...
		<td align="right">
			...
			<input type="button" class="btLista" id="btAutorizaciones" value="Agregar" onclick="cargarOpcion2(this.form, 'gehen.php?anz=usuarios_autorizaciones&opcion=agregar', 'SELF', '', $('#registro').val());" <?=$btAutorizaciones?> />
