...
<table width="700" class="tblForm">
	...
	<tr>
		...
		<td>
        	<input type="text" id="Organismo" style="width:300px;" maxlength="100" value="<?=htmlentities($field['Organismo'])?>" <?=$disabled_ver?> />
		</td>
	</tr>
	<tr>
		<td class="tagForm">* Desc. Completa:</td>
		<td>
        	<input type="text" id="DescripComp" style="width:300px;" maxlength="100" value="<?=htmlentities($field['DescripComp'])?>" <?=$disabled_ver?> />
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="gallery clearfix">
            ...
            <a href="../lib/listas/gehen.php?anz=lista_personas&filtrar=default&campo1=CodPersona&campo2=NomPersona&EsEmpleado=N&EsCliente=N&iframe=true&width=1000&height=425" rel="prettyPhoto[iframe1]" style=" <?=$display_ver?>">
	...
	<tr>
		...
		<td class="gallery clearfix">
            <input type="text" id="CodPersonaDesign" style="width:60px;" value="<?=$field['CodPersonaDesign']?>" disabled="disabled" />
			<input type="text" id="RepresentLegal" style="width:230px;" value="<?=htmlentities($field['RepresentLegal'])?>" disabled="disabled" />
            <a href="../lib/listas/gehen.php?anz=lista_personas&filtrar=default&ventana=Ndocumento&campo1=CodPersonaDesign&campo2=RepresentLegal&campo3=DocRepreLeg&EsEmpleado=N&EsCliente=N&iframe=true&width=1000&height=425" rel="prettyPhoto[iframe2]" style=" <?=$display_ver?>">
            	<img src="../imagenes/f_boton.png" width="20" title="Seleccionar" align="absbottom" style="cursor:pointer;" />
            </a>
		</td>
	</tr>
	<tr>
		...
		<td>
        	<input type="text" id="DocRepreLeg" style="width:100px;" maxlength="20" value="<?=($field['DocRepreLeg'])?>" disabled />
		</td>
	</tr>
	<tr>
		<td class="tagForm">Designaci&oacute;n:</td>
		<td>
        	<textarea id="Designacion" style="width:98%; height:30px;" <?=$disabled_ver?>><?=htmlentities($field['Designacion'])?></textarea>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
        	<textarea id="Direccion" style="width:98%; height:60px;" <?=$disabled_ver?>><?=htmlentities($field['Direccion'])?></textarea>
		</td>
	</tr>
	<tr>
